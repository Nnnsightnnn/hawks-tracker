// ─── Atlanta Hawks Player Data (2025-26 Season · Updated Friday May 22, 2026 — OFFSEASON · ECF G2: KNICKS 109, CAVS 93 — New York leads the East finals 2-0 behind Josh Hart's postseason-high 26 and Brunson's playoff-high 14 assists, two wins from the NBA Finals · WCF tied 1-1, Game 3 at San Antonio TONIGHT 8:30 ET · Kia All-NBA teams revealed Sun May 24 — Jalen Johnson's first All-NBA nod in play · SGA won his 2nd straight MVP May 17 · Hawks formally DENY Philadelphia permission to interview GM Onsi Saleh · Quin Snyder 'massive' extension reported 'looming' · 32 days to Draft Night Jun 23) ─
...
export const PLAYERS = [
  ...
  },
  {
    ...
    recentNotes: "FRIDAY MAY 22 (ECF G2: Knicks 109-93 over Cleveland — NY leads the East finals 2-0; WCF G3 at San Antonio tonight, series 1-1) — Series ended with the rotation slot under question after a tough R1 showing. Hollinger explicitly names Kispert (with Risacher) as the likeliest summer trade chip; cap notes show $14.6M next season then a $17.4M cap hit in 27-28. Salary-matching utility in any Jaylen Brown framework is real — the No. 8 pick plus Kispert plus Hield's $9.4M would clear the $57M Brown number per Hoops Rumors / Boston.com (May 10-11). Regular season line of 9.6/2.4/1.3 on 40.2% from three in 40 games (8 starts) was the post-trade Hawks portion.",
  ...
  },
  {
    ...
    recentNotes: "FRIDAY MAY 22 (ECF G2: Knicks 109-93 over Cleveland — NY leads the East finals 2-0; WCF G3 at San Antonio tonight, series 1-1) — Missed the entire first round of the playoffs after the Apr 1 right high-ankle sprain (Heavy/CBS, Apr 24). UFA per Bleacher Report cap notes. Offseason story is whether ATL re-signs the third center or pivots to the lottery picks (May 10) or to Hartenstein-tier FA money for help up front; the Hartenstein chase (per Soaring Down South 'top free-agency frontcourt target', May 11) directly competes with re-signing Landale.",
    playoffStats: null,
    playoffSeries: null,
    minutesTrend: null,
...
export const NEXT_GAME = {
  ...
  broadcast: "ABC / ESPN",
  seriesContext: "FRIDAY MAY 22 — LAST NIGHT: NEW YORK 109, CLEVELAND 93 — the Knicks beat the Cavaliers at Madison Square Garden to take a 2-0 lead in the Eastern Conference Finals and move within two wins of the NBA Finals. JOSH HART set a postseason career high with 26 pts; JALEN BRUNSON dished a playoff career-high 14 assists and KARL-ANTHONY TOWNS anchored the win. DONOVAN MITCHELL's 26 wasn't enough for Cleveland, which scored just 44 in the second half and was buried by an 18-0 third-quarter run (NBA.com / ESPN / Yahoo Sports May 21-22). ECF Game 3 is Saturday May 23 at Cleveland. OUT WEST: the Thunder-Spurs series is tied 1-1; WCF GAME 3 IS TONIGHT — Friday May 22, 8:30 PM ET at San Antonio (NBC/Peacock) — with the Spurs slim home favorites and OKC awaiting an MRI on JALEN WILLIAMS' hamstring (hurt in Game 2). ATL angle: the Knicks remain the team that buried Atlanta in six (the historic 140-89 Apr 30 Game 6). AWARDS: SHAI GILGEOUS-ALEXANDER won his second straight MVP on May 17 (83 of 100 first-place votes); the official Kia All-NBA teams are revealed SUNDAY MAY 24 (7 PM ET, NBC/Peacock, ahead of WCF Game 4) — the moment JALEN JOHNSON is widely projected to land his first All-NBA selection. HAWKS LEDGER: Atlanta has formally DENIED Philadelphia permission to interview GM ONSI SALEH (Yardbarker / SI onsi / RealGM May 21-22), closing the Sixers thread; a 'massive' extension for head coach QUIN SNYDER is reported 'looming,' one that could make him one of the NBA's highest-paid coaches. CAMERON JOHNSON trade thread STILL OPEN — Denver must shed salary to re-sign RFA Peyton Watson, and the latest SI Nuggets three-suitor cut names the LAKERS, WARRIORS and PACERS. JAYLEN BROWN chatter links Atlanta and the Clippers as third-team options in a Giannis-to-Boston framework. DRAFT BOARD: ESPN's Jeremy Woo's post-combine mock has 7'3 ADAY MARA to Atlanta at No. 8 to fix the size the Knicks exposed; Kingston Flemings and Mikel Brown Jr. the other live No. 8 names. KEY OFFSEASON DATES: Draft Night June 23 (32 days) · Hield $9.4M full-guarantee trigger June 25 (34 days) · Kuminga $24.3M team-option call by June 29 (38 days) · McCollum UFA market opens June 30 6 PM ET (39 days) · Free agency moratorium July 6.",
};
...
export const NEWS_DIGEST = {
  generatedAt: "2026-05-22T08:30:00Z",
  summary:
    "OFFSEASON — Friday May 22. THE KNICKS HAVE A STRANGLEHOLD ON THE EASTERN CONFERENCE FINALS: New York beat the Cleveland Cavaliers 109-93 at Madison Square Garden on Thursday night to take a 2-0 series lead and move within two wins of the NBA Finals. JOSH HART set a postseason career high with 26 points, JALEN BRUNSON dished a playoff career-high 14 assists and KARL-ANTHONY TOWNS anchored the win; DONOVAN MITCHELL's 26 points weren't enough for Cleveland, which scored just 44 in the second half and was buried by an 18-0 third-quarter run (NBA.com / ESPN / Yahoo Sports May 21-22). For Atlanta the Knicks remain the team that ended the Hawks' season in six (the historic 140-89 Apr 30 Game 6). OUT WEST the Thunder-Spurs Western Conference Finals are tied 1-1 and shift to San Antonio for GAME 3 TONIGHT (Friday May 22, 8:30 PM ET, NBC/Peacock); the Spurs are slim home favorites and Oklahoma City is awaiting an MRI on Jalen Williams' hamstring, hurt in Game 2. The leaguewide awards calendar now matters directly to the Hawks: SHAI GILGEOUS-ALEXANDER was named MVP on May 17 for the second straight year (83 of 100 first-place votes), and the official Kia All-NBA teams are revealed THIS SUNDAY May 24 — the moment JALEN JOHNSON is widely projected to earn his first All-NBA selection. ON THE HAWKS' LEDGER, Atlanta has formally DENIED Philadelphia permission to interview GM ONSI SALEH (Yardbarker / SI onsi / RealGM May 21-22), closing the Sixers thread, while a 'massive' extension for head coach QUIN SNYDER is reported 'looming' — one that could make him one of the league's highest-paid coaches at an eight-figure annual salary. CJ McCOLLUM retention (~2yr/$35-40M, slightly above the MLE) stays the offseason priority; the cap gates loom — Hield's $9.4M full-guarantee trigger June 25, Kuminga's $24.3M team-option call by June 29, Draft Night June 23, McCollum's UFA market opening June 30 — and the No. 8 pick (KINGSTON FLEMINGS, MIKEL BROWN JR. and 7'3 ADAY MARA the live names) plus JAYLEN BROWN and CAMERON JOHNSON trade chatter round out the agenda.",
  keyTopics: [
    {
      title: "LAST NIGHT — ECF GAME 2: Knicks 109, Cavaliers 93 — New York Takes a 2-0 Stranglehold",
      detail:
        "Thursday May 21 at Madison Square Garden: the New York Knicks beat the Cleveland Cavaliers 109-93 to take a 2-0 lead in the Eastern Conference Finals and move within two wins of the NBA Finals (NBA.com 'Knicks pull away from Cavs, take 2-0 lead' / ESPN box score / Yahoo Sports, May 21-22). JOSH HART set a postseason career high with 26 points, JALEN BRUNSON dished a playoff career-high 14 assists, and KARL-ANTHONY TOWNS anchored the win. DONOVAN MITCHELL scored 26 for Cleveland but it wasn't enough — the Cavaliers managed only 44 second-half points and were buried by an 18-0 third-quarter run that swung the game. ECF Game 3 is Saturday May 23 at Cleveland. ATL angle: the Knicks remain the team that ended Atlanta's season in six (the historic 140-89 Apr 30 Game 6).",
      category: "games",
    },
    {
      title: "TONIGHT (Fri May 22, 8:30 PM ET): WCF Game 3 at San Antonio — Series Tied 1-1, J-Will MRI Pending",
      detail:
        "Game 3 of the Western Conference Finals tips tonight, Friday May 22 at 8:30 PM ET at San Antonio on NBC/Peacock, with the series tied 1-1 (BetMGM / SportsLine / NBA.com playoffs hub / Yahoo Sports, May 22). The Spurs — slim 1.5-point home favorites — split the first two: a double-overtime Game 1 win behind Wembanyama, then a 122-113 Game 2 loss in which 21 turnovers undid them. The injury watch is the storyline: Thunder forward JALEN WILLIAMS suffered a hamstring injury in Game 2 and OKC is awaiting MRI results, while Spurs rookie guard Dylan Harper was ruled out of Game 2. Game 4 is Sunday May 24 at San Antonio.",
      category: "games",
    },
    {
      title: "Kia All-NBA Teams Revealed Sunday May 24 — Jalen Johnson's First All-NBA Nod in Play",
      detail:
        "The official 2025-26 Kia All-NBA teams are announced Sunday May 24 at 7 PM ET on NBC/Peacock, ahead of WCF Game 4 (NBA.com 'Kia All-NBA Teams to be announced Sunday'). It is the moment JALEN JOHNSON is widely projected to land his first All-NBA selection — ESPN's Tim Bontemps had him on the Second Team and ClutchPoints' May poll called him 'a clear selection.' Johnson's 22.5/10.3/7.9 across 72 games made him just the fifth player ever to clear 22+/10+/7+ for a full season (Oscar, Wilt, Jokic, Westbrook). The MVP is already decided: Oklahoma City's SHAI GILGEOUS-ALEXANDER won his second straight on May 17 with 83 of 100 first-place votes, ahead of Nikola Jokic and Victor Wembanyama.",
      category: "general",
    },
    {
      title: "Snyder Extension 'Looming' — Reported Deal Could Make Him One of the NBA's Highest-Paid Coaches",
      detail:
        "Reporting through May 21-22 has escalated: a 'massive' contract extension for head coach QUIN SNYDER is described as 'looming,' one expected to make him one of the highest-paid coaches in the league at an eight-figure annual salary in the ballpark of recent top-of-market deals (Yardbarker 'Hawks extension with Quin Snyder looming' / SportsTalk ATL / Peachtree Hoops / Hoops Rumors). Snyder enters the final year of his current deal in 2026-27; the 19-5 post-Trae-trade finish that bypassed the play-in is the cited tipping point. Hawks CEO Steve Koonin has publicly committed Snyder long-term, and Jake Fischer reports 'strong' front-office support — locking him up before training camp matters more with evaluator Bryson Graham gone to Chicago.",
      category: "general",
    },
    {
      title: "Saleh-to-76ers Thread Closes: Atlanta Formally Denies Philadelphia Permission to Interview Its GM",
      detail:
        "WEDNESDAY-THURSDAY May 21-22: the Sixers' pursuit of Hawks GM ONSI SALEH is officially over. Multiple reports (Yardbarker 'Atlanta Hawks deny Philadelphia 76ers Permission to Interview GM Onsi Saleh' / SI onsi / RealGM / TalkBasket / Roundtable) confirm Atlanta DENIED Philadelphia the permission needed to interview Saleh for its president-of-basketball-operations job — a non-starter after Saleh finished SECOND in 2026 Executive of the Year voting behind Brad Stevens. Saleh, who previously worked under Bob Myers in Golden State, stays in Atlanta with the No. 8 pick in hand. Philadelphia's search (overseen by Myers) pivots to other names including Nick U'Ren, Vince Rozman and Neil Olshey, with the Sixers wanting the hire done before the June 23 draft. The Hawks still operate without a President of Basketball Operations.",
      category: "general",
    },
    {
      title: "CJ McCollum Free Agency: Hawks Plan a Return at ~2yr/$35-40M — But Other Suitors Loom",
      detail:
        "Atlanta's headline UFA. The plan to bring CJ McCollum back holds (Bleacher Report 'New CJ McCollum Rumors' / HoopsHype 'Hawks plan to bring back CJ McCollum' / SI onsi / Heavy, Apr 30-May 18). Jake Fischer reports mutual interest; McCollum confirmed a 'productive conversation' with the front office after the season. John Hollinger reports most execs peg the fair range at one or two years slightly above the mid-level exception — roughly 2yr/$35-40M. McCollum, who turns 35 in September and played 25-26 on a $30.6M cap hit, 'likely will have other suitors' once the open market arrives, with cap-room teams like Chicago or Brooklyn the named risk. The UFA market opens June 30 at 6 PM ET — 39 days out.",
      category: "trades",
    },
    {
      title: "Kuminga's $24.3M Team Option — June 29 Decision, Most Analysts Expect a Return",
      detail:
        "Atlanta's biggest cap question stays Jonathan Kuminga, with a June 29 deadline on his $24.3M 2026-27 team option (Heavy / ClutchPoints 'Insider believes Kuminga will return' / Soaring Down South / ESPN offseason guide, May 1-21). Three paths: exercise the option, decline it and re-sign him to a longer multi-year deal at a lower first-year number (he is not extension-eligible, so ripping up the option is the only multi-year route), or decline and let him walk. Jake Fischer reports mutual interest in a new long-term deal, and most analysts now project the Hawks bring Kuminga back — either as a rotation piece or a tradable contract. Soaring Down South notes the draft could let Atlanta buy time on the call. Acquired in the deadline-day Porzingis trade, Kuminga averaged 14.9/5.1/2.2 across 16 Hawks regular-season games and 13.4 PPG in the Knicks series.",
      category: "trades",
    },
    {
      title: "Buddy Hield's $9.4M Decision: June 25 Full-Guarantee Trigger — Return Not Expected",
      detail:
        "Buddy Hield's $9.4M 2026-27 contract becomes fully guaranteed on June 25 — only $3M is currently protected (SI onsi cap tracker / SportsTalkATL, Apr 28-May 18). Atlanta can let the full number trigger and keep it as a movable expiring, waive him before the date to save the difference, or include him in a pre-trigger trade. Reporting suggests Hield is not expected back given how little he played after the Porzingis-deal arrival (71 games, 12 starts at 11.8/2.8/2.1 on 39.8% from three, then just 6 mpg in 2 R1 games). Hoops Rumors lists him as a likely offseason trade or salary-matching piece — 34 days to the trigger.",
      category: "trades",
    },
    {
      title: "Cam Johnson Still the Nuggets' 'Most Likely' Trade Candidate — Suitor Cut: Lakers, Warriors, Pacers",
      detail:
        "As of Friday May 22, no trade has been executed (SI Nuggets '3 Realistic Cam Johnson Trade Suitors' / Heavy 'Nuggets Most Likely Trade Candidate' / NuggLove / Yardbarker, May 18-21). Denver must shed salary to re-sign restricted free agent Peyton Watson, and CAMERON JOHNSON — a roughly $23M expiring contract who averaged 12.2/3.8/2.4 on 48/43/84 splits in his first Nuggets year — remains the most likely trade candidate. The newest SI Nuggets three-suitor cut names the LOS ANGELES LAKERS, GOLDEN STATE WARRIORS and INDIANA PACERS as the realistic landing spots; Atlanta, tied to Johnson by earlier May reporting, is now framed more as a roster-profile match (half-court shooting, 3-and-D — Atlanta's biggest R1 gap) than a named bidder.",
      category: "trades",
    },
    {
      title: "Jaylen Brown Trade Chatter: Hawks and Clippers Floated as Third Teams in a Giannis-to-Boston Deal",
      detail:
        "The Jaylen Brown thread continues into late May (Larry Brown Sports / Yardbarker 'Jaylen Brown linked to two teams' / Hoops Rumors / Boston.com / Hoopswire, May 10-21). Celtics reporter Alex Goldberg links Brown to both the Atlanta Hawks and the LA Clippers — most plausibly as a third team absorbing his contract in a larger framework that would send Giannis Antetokounmpo to Boston. Brown, a Marietta GA native, posted a career-best statistical year while Jayson Tatum recovered from an Achilles tear; Boston's first-round exit to Philadelphia has the Celtics weighing change. The hurdle is the money — Brown is owed roughly $183M over three years — and Saleh has said the Hawks are 'not one player away.'",
      category: "trades",
    },
    {
      title: "Draft Board: ESPN's Woo Mock Has 7'3 Aday Mara to Hawks at No. 8 — Size Is the Theme",
      detail:
        "Atlanta picks No. 8 after the May 10 lottery, and the post-combine mock roundup keeps the size question front and center (SI onsi 'Hawks Mock Draft: The No. 8 Pick Presents Plenty of Options' / AJC 'What players best fit their needs?' / Bleacher Report / Last Word, May 12-20). ESPN's Jeremy Woo again slots 7'3 center ADAY MARA to Atlanta at No. 8, citing his rim protection and 'unusual passing and post skill' against the lack of size the Knicks exposed. The other live names are guards to help replace Trae Young: Houston's KINGSTON FLEMINGS (16.1/5.2/4.1, 38.7% 3P) and Louisville's MIKEL BROWN JR., with Darius Acuff also in the mix. Atlanta holds Nos. 8, 23 and 57; the draft runs June 23-24 at Barclays Center.",
      category: "general",
    },
    {
      title: "Hartenstein the Named FA Frontcourt Target — But OKC's ~$29M Option Is the Gate",
      detail:
        "Isaiah Hartenstein remains the cleanest free-agency fix for Atlanta's frontcourt size and interior defense (Yardbarker / SI onsi 'The Atlanta Hawks Must Target Isaiah Hartenstein' / Soaring Down South, May 5-21). A Hartenstein-Okongwu pairing would address exactly what the Knicks exposed; Hartenstein rebounds, passes and shot 74% at the rim in 25-26. The catches are structural: Hartenstein only reaches free agency if OKC declines his roughly $29M team option, and Atlanta could afford him only by NOT re-signing both McCollum and Kuminga. Spacing is a secondary concern — Hartenstein is a non-shooter. Sacramento's Malik Monk has also surfaced as a cheaper backcourt-scoring trade target with the Kings 'open for business.'",
      category: "trades",
    },
  ],
  sources: [
