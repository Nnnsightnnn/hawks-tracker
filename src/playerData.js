...
export const ISSUE = {
  date: "2026-08-06",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 43,                                       // Issue number (offseason cadence)
  dateline: "ATLANTA · AUGUST 6, 2026",             // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 43 · AUGUST 2026 · ATL · USA",
  railLabel: "ISSUE 43 · AUG 6",
  ...
  coverImage: null,
  coverRibbon: "CLEVELAND CLIMBS BACK INTO THE KUMINGA CHASE, MAKING IT A TWO-TEAM RACE WITH THE LAKERS · L.A. SIGNS ZIAIRE WILLIAMS BUT KEEPS PUSHING · EVERY PATH STILL RUNS THROUGH ATLANTA IN A SIGN-AND-TRADE · HAWKS STILL WANT THE PICKS BEFORE ABSORBING VANDERBILT'S OPTION · 17 CONTRACTS, LIMIT 15 · NEXT GAME OCT 5 VS MEMPHIS",
  coverStatusKicker: "OFFSEASON · DAY 94",          // top-right corner of cover
  coverStatusLine: "CAVALIERS BACK IN THE KUMINGA CHASE ALONGSIDE THE LAKERS (SHAMS) · L.A. ADDS ZIAIRE WILLIAMS BUT KEEPS PUSHING · KUMINGA OPEN TO LAKERS, SEEKS NORTH OF THE $15M MLE · HAWKS STILL WANT PICKS BEFORE TAKING VANDERBILT · GUEYE OUT, CENTER NEED OPEN · 17 CONTRACTS, LIMIT 15 · NEXT: PRESEASON, OCT 5", // {DAYS:id} resolves from KEY_DATES
  backTagline: "Next issue: whether a two-team Cavaliers-Lakers race finally forces a sweetener that moves Atlanta or the Hawks keep holding out, whether the Jarrett Allen interest turns into a real center pursuit or stays due diligence, which two contracts go to get to 15, and whether the Hawks have the picks left to meet Denver's number on Watson with the Nuggets in the second apron.",
};
