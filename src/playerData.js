...
export const ISSUE = {
  date: "2026-08-07",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
