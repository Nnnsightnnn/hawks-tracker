...
export const PLAYERS = [
  // ── Starters ─────────────────────────────────────────────────────────────
  {
    ...
    recentNotes: "DAY AFTER LOTTERY (Mon May 11): Atlanta landed at No. 8 in last night's draw — most-likely outcome, missed top-4 swing — and the offseason narrative now hinges harder than ever on Johnson's continued ascent as the franchise focal point (SI onsi / CBS Sports / Peachtree Hoops May 10-11). SI onsi's 'Hawks' Most Untouchable Trade Asset' piece (May 10) was the headline frame: Johnson is the one Hawk OFF the board even with Jaylen Brown rumors resurfacing overnight via Boston-Atlanta talks per 98.5 The Sports Hub. Five-day-old peer recognition still travels: The Athletic's Anonymous NBA Player Poll (May 6) named him the league's MOST UNDERRATED, tied with Derrick White at 4%. Yahoo's May 1 media ballot has him on the All-NBA THIRD TEAM (official league vote pending late May). Final R1 line settled at 19.5/8.3/5.5 vs his 22.5/10.3/7.9 / 72 GP / 35.2 mpg regular-season baseline (5th player ever to clear 22+/10+/7+, after Oscar, Wilt, Jokic, Westbrook). On a $150M rookie extension through 2029-30 at $30M/yr per Spotrac — locked in.",
  ...
  },
  {
    ...
    recentNotes: "Eleven days past the Game 6 ejection and ten past the $25K fine — Daniels enters Combine Week (lottery landed at No. 8 yesterday) with the season-defining R1 backdrop intact: Luka-2022 bar through G1-G4 (24 pts / 35 reb / 25 ast / 10 stl, first NBA player to clear that span since 2022 per NBA.com Apr 27) and a 26-27 DPOY case rebuilding alongside Wembanyama (Wemby took 2025-26 DPOY ahead of Holmgren and Ausar Thompson). Reigning 24-25 MIP and All-Defensive 1st-team; the Pelicans scout who drafted him at No. 8, BRYSON GRAHAM, was hired by the Bulls May 4 as EVP of Basketball Ops — one week ago today (NBA.com / Bulls.com / Bleacher Nation). Six-game R1 line settled around 7.8/5.8/4.7 in 27 mpg with a Game 5 scoring breakthrough (17 on 7-of-11) before the Game 6 ejection. His five-year, $125M rookie-scale extension kicks in next season ($25M jump in 26-27 per Spotrac).",
  ...
  },
  {
    ...
    recentNotes: "MIP trophy still the through-line as Combine Week begins (lottery landed at No. 8 last night): 2025-26 Kia Most Improved Player Apr 24 with 66 of 100 first-place votes, beating finalists Deni Avdija and Jalen Duren (NBA.com / Washington Post / Yahoo Sports / Hoops Rumors). Career-best 20.8/3.4/3.7 on 39.9% from three (251 makes is a Hawks single-season record, 4th in the NBA) — back-to-back MIPs for ATL after Daniels' 24-25 win, the FIRST FRANCHISE EVER with consecutive winners. R1 scoring settled at 13.4 PPG; the only ATL perimeter player above 33% from three across the full six. NAW was also drafted by Bryson Graham in New Orleans — Graham left Atlanta for Chicago May 4 as EVP of Basketball Ops, exactly one week ago. Locked in long-term on the four-year deal he signed last summer.",
  ...
  },
  {
    ...
    recentNotes: "Headline UFA the day after Lottery Night. SI onsi 'Atlanta Is Expected to Bring Back McCollum Next Season' / Soaring Down South 'CJ McCollum Gave the Hawks a Problem Nobody Is Talking About' / Hoops Rumors / HoopsHype / Bleacher Report (Apr 28-May 10) align: Atlanta plans to bring him back on a multi-year deal, with offers expected 'slightly above the mid-level exception' — most execs pegging 2yr/$35-40M as the fair range. McCollum publicly confirmed a 'productive conversation' with the front office (Heavy, May 4). The Ringer's 'CJ McCollum Is the Trade Nobody Took Seriously — Until Now' (Apr 23) is now the canon framing of the Trae-Young-trade aftermath: Atlanta has emerged as the clear winner. Hollinger's Athletic preview still flags age (34, turning 35) as the structural risk. UFA market opens June 30, 6 PM ET. Final regular-season line: 18.7 / 3.1 / 4.1 on 45.2/38.1/82.7 across 41 Hawks games post-Jan 8 trade (25 starts), then 19.2 PPG / 49% FG / 31% 3P across the six R1 games. Hollinger expects ATL to run OVER the cap and use the non-tax MLE (~$15.1M) as the working tool.",
  ...
  // ── Rotation / Bench ─────────────────────────────────────────────────────
  {
    ...
    recentNotes: "Offseason trade-watch player No. 1 — and the No. 8 lottery slot now sharpens the question. With Dybantsa/Peterson/Boozer/Caleb Wilson projected gone by No. 5, Atlanta's No. 8 board (Tre Johnson, Nate Ament, Koa Peat, Lendeborg per SI onsi / CBS Sports post-lottery mocks May 10-11) is wing-heavy — directly stacking minutes Risacher needs. Hollinger's Athletic preview (SI onsi / Larry Brown Sports / Lindys / Hoops Wire / FanSided, May 1-7) still tags him (and Kispert) as the likeliest summer trade chip. Structural read: $13.7M next season then a $17.8M team option for 27-28 (Bleacher Report cap notes). Sophomore line: 9.6/3.8/1.1 on 44.6% FG / 37.2% 3P across 66 games — regression from his 12.6 PPG rookie year as usage dropped from 21.6% to 17.7%. R1 floor time was just 2:30 across six games — one Game 1 cameo then five straight DNP-CDs. Dallas reportedly inquired pre-lottery (Soaring Down South / FOX Sports May 1-2).",
...
export const NEWS_DIGEST = {
  generatedAt: "2026-05-11T13:00:00Z",
  summary:
    "OFFSEASON — Monday May 11, day after Lottery Night: Atlanta LANDED AT No. 8 in last night's 2026 NBA Draft Lottery in Chicago — the field's most-likely outcome (35.6% pre-draw) on the more-favorable of NOP/MIL, but a missed swing on the 40.2% top-4 odds (CBS Sports / Yahoo Sports / SI onsi / NBA.com / Peachtree Hoops, May 10-11). WASHINGTON WIZARDS won the No. 1 pick (17-65, first time on top since John Wall in 2010) and are projected to take AJ Dybantsa (BYU); top-4 board: WAS, Utah Jazz, Memphis Grizzlies, Chicago Bulls. LA Clippers (via Pacers) at 5, Brooklyn Nets at 6. Hawks now hold No. 8 (via NOP), No. 23 (via CLE/SAS) and No. 57 (via BOS). With Dybantsa, Peterson, Boozer and Caleb Wilson all projected gone by No. 5, ATL's board at No. 8 turns to wing/big depth — Tre Johnson, Nate Ament, Koa Peat, Yaxel Lendeborg headline the CBS Sports / ESPN combine watchlist. COMBINE WEEK STARTS TODAY at Wintrust Arena (main scrimmages May 11-17 after the G League combine wrapped May 8-10): 73 prospects, every front office on site. Atlanta's pre-draft workout group of Flory Bidunga (Kansas), Ugonna Onyenso (Virginia), Peter Suder (Miami OH) and Milos Uzan (Houston) is in town for No. 57 looks. PARALLEL STORYLINE THAT BROKE OVERNIGHT (98.5 The Sports Hub / Boston.com / Hoops Rumors / Yardbarker, May 10-11): the Celtics-Hawks Jaylen Brown trade conversation could resurface this summer. Boston-Atlanta had a brief discussion last summer that went nowhere because Atlanta 'was leery of Brown's contract' — but Chris Mannix is now expecting a fresh batch of Brown rumors and the Hawks fit the salary-matching profile after the No. 8 pick became their biggest tradable asset. FRONT-OFFICE SPINE UNCHANGED: operate OVER the cap with non-tax MLE (~$15.1M), BAE (~$5.1M), four trade exceptions, and Hield's $9.4M expiring; retain McCollum (HoopsHype: 'slightly above MLE,' ~2yr/$35-40M); decline Kuminga's $24.3M 26-27 option by June 29 to renegotiate longer-term; call Hield's $3M-vs-$9.4M trigger before June 25; shop Risacher or Kispert. CEO Steve Koonin (Yardbarker May): 'I think Quin is going to be part of our team for a very, very long time' — Snyder extension talks remain on the calendar. Saleh enters Combine Week short-handed after Bryson Graham left for the Bulls May 4.",
  keyTopics: [
    {
      title: "LOTTERY RESULT (Sun May 10): Hawks Land at No. 8, Most-Likely Outcome — Wizards Win No. 1",
      detail:
        "Yesterday in Chicago: Atlanta drew the No. 8 pick in the 2026 NBA Draft Lottery — exactly the most-likely outcome (35.6% pre-draw) on the more-favorable of NOP/MIL, but a swing-and-miss on the 40.2% top-4 odds (CBS Sports / Yahoo Sports / SI onsi 'Hawks Land No. 8 Pick' / NBA.com / Peachtree Hoops / ESPN 'Questions on top 14 picks', May 10-11). WASHINGTON WIZARDS jumped from the No. 3 slot to win the No. 1 pick (17-65, first time on top since drafting John Wall in 2010). FINAL TOP-6: 1. WAS, 2. UTA, 3. MEM, 4. CHI, 5. LAC (via IND), 6. BKN. Atlanta now holds three picks: No. 8 (via NOP), No. 23 (via CLE/SAS), No. 57 (via BOS). Top-4 prospect board — AJ Dybantsa (BYU), Darryn Peterson (Kansas), Cameron Boozer (Duke), Caleb Wilson (UNC) — projected gone by No. 5. SI onsi 'Atlanta Hawks Mock Draft' (May 10) frames the No. 8 board as wing/big depth: Tre Johnson, Nate Ament, Koa Peat, Yaxel Lendeborg the early names. Saleh represented Atlanta on stage (HoopsHype May 7).",
      category: "general",
    },
    {
      title: "COMBINE WEEK Starts TODAY (Mon May 11): Main Scrimmages Open at Wintrust Through Saturday",
      detail:
        "TODAY (Monday May 11): The AWS NBA Draft Combine's main scrimmage week opens TODAY at Wintrust Arena and the Marriott Marquis in Chicago — 73 invitees through Saturday May 17 for measurements, scrimmages, drills and front-office interviews (NBA.com / Yahoo Sports / ESPN combine preview / SI 'Top Performers From Day 1 of the 2026 G League NBA Draft Combine', May 9-11). The G League combine wrapped Sunday May 10 with select standouts earning bumps to the main slate later in the week. With Atlanta now locked into No. 8, the focus shifts to the post-top-4 board — CBS Sports' watchlist of players 'with the most to prove' centers on Nate Ament, Koa Peat, Yaxel Lendeborg. Hoops HQ's '12 prospects who can boost their stock' list adds the secondary names. Atlanta's confirmed pre-draft workout group of Flory Bidunga (Kansas), Ugonna Onyenso (Virginia), Peter Suder (Miami OH) and Milos Uzan (Houston) is in town for No. 57 looks.",
      category: "general",
    },
    {
