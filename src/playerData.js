...
export const ISSUE = {
  date: "2026-08-05",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 42,                                       // Issue number (offseason cadence)
  dateline: "ATLANTA · AUGUST 5, 2026",             // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 42 · AUGUST 2026 · ATL · USA",
  railLabel: "ISSUE 42 · AUG 5",
  ...
  coverImage: null,
  coverRibbon: "LAKERS' KUMINGA OFFER COMES INTO FOCUS AT ROUGHLY $45M OVER THREE YEARS, INSIDE HIS RANGE, WITH L.A. NOW WILLING TO ATTACH DRAFT CAPITAL TO VANDERBILT · HAWKS WANT THE PICKS OR THE SWAP BEFORE ABSORBING THE OPTION · WOLVES STILL LURKING · 17 CONTRACTS, LIMIT 15 · NEXT GAME OCT 5 VS MEMPHIS",
  coverStatusKicker: "OFFSEASON · DAY 93",          // top-right corner of cover
  coverStatusLine: "LAKERS OFFER REFRAMED AT $45M/3YR, INSIDE KUMINGA'S RANGE; L.A. NOW WILLING TO ATTACH DRAFT CAPITAL TO VANDERBILT · HAWKS WANT THE PICKS OR SWAP FIRST · WOLVES STILL IN · GUEYE OUT, CENTER NEED OPEN · 17 CONTRACTS, LIMIT 15 · NEXT: PRESEASON, OCT 5", // {DAYS:id} resolves from KEY_DATES
  backTagline: "Next issue: whether the reframed three-year Lakers offer and the willingness to attach picks finally moves Atlanta or the Hawks hold out for more, whether the Jarrett Allen interest turns into a real center pursuit or stays due diligence, which two contracts go to get to 15, and whether the Hawks have the picks left to meet Denver's number on Watson with the Nuggets in the second apron.",
};
