...
export const PLAYERS = [
  ...
  },
  {
    ...
    recentNotes: "FRIDAY JUNE 12 (offseason — PRESIDENT OF BASKETBALL OPS ONSI SALEH promoted + extended Wed May 27 per ESPN / Washington Post / Yahoo / SI onsi / Hoops Rumors; SPURS TOOK WCF GAME 7 111-103 Sat May 30 (Wembanyama 22-7), ousting OKC to reach the Finals; KNICKS LEAD THE FINALS 3-1 after erasing a 29-point halftime deficit Wed Jun 10 to win Game 4 107-106 on Anunoby's tip-in with 1.2 seconds left, the largest comeback in Finals history (Anunoby 33, Brunson 31); Game 5 Sat Jun 13 in San Antonio, 8:30 ET ABC) — Likeliest summer trade chip alongside Risacher, and Saleh as new POBO owns the call. Hollinger explicitly names Kispert (with Risacher) as the likeliest summer trade chip; cap notes show $14.6M next season then a $17.4M cap hit in 27-28. Salary-matching utility in any Jaylen Brown framework is real — the No. 8 pick plus Kispert plus Hield's $9.4M would clear the $57M Brown number per Hoops Rumors / Boston.com / Larry Brown Sports (May 10-22). Regular season line of 9.6/2.4/1.3 on 40.2% from three in 40 games (8 starts) was the post-trade Hawks portion.",
  ...
  },
  {
    ...
    recentNotes: "FRIDAY JUNE 12 (offseason — PRESIDENT OF BASKETBALL OPS ONSI SALEH promoted + extended Wed May 27 per ESPN / Washington Post / Yahoo / SI onsi / Hoops Rumors; SPURS TOOK WCF GAME 7 111-103 Sat May 30 (Wembanyama 22-7), ousting OKC to reach the Finals; KNICKS LEAD THE FINALS 3-1 after erasing a 29-point halftime deficit Wed Jun 10 to win Game 4 107-106 on Anunoby's tip-in with 1.2 seconds left, the largest comeback in Finals history (Anunoby 33, Brunson 31); Game 5 Sat Jun 13 in San Antonio, 8:30 ET ABC) — Missed the entire first round of the playoffs after the Apr 1 right high-ankle sprain (Heavy/CBS, Apr 24). UFA per Bleacher Report cap notes. Offseason story is whether the new POBO re-signs the third center or pivots to the lottery picks (No. 8 secured May 10) or to Hartenstein-tier FA money for help up front; the Hartenstein chase (per Soaring Down South 'top free-agency frontcourt target', May 11) directly competes with re-signing Landale.",
    playoffStats: null,
    playoffSeries: null,
    minutesTrend: null,
...
export const NEXT_GAME = {
  ...
  broadcast: "ABC / ESPN",
  seriesContext: "FRIDAY JUNE 12: GAME 5 EVE. THE KNICKS, THE TEAM THAT ENDED ATLANTA'S SEASON, ARE ONE WIN FROM THE TITLE. New York leads the Finals 3-1 after Wednesday's 107-106 Game 4 steal at MSG, the largest comeback in Finals history (down 76-47 at half; ANUNOBY's tip-in with 1.2 seconds left capped his playoff career-high 33). Game 5 is TOMORROW, Saturday June 13 at Frost Bank Center (8:30 PM ET, ABC); books list the Spurs around -5.5 at home facing elimination, and the Game 5 watch item is KAT's health after he sat most of Game 4's first half (Covers / VSiN / Odds Shark / Yahoo). A Knicks win delivers New York's first championship since 1973, completed through the bracket that ran over Atlanta in six. HAWKS BEAT, 11 DAYS TO THE DRAFT: Atlanta still 'loves' Illinois PG KEATON WAGLER and Louisville PG MIKEL BROWN JR. at No. 8 with 7'3 ADAY MARA the size dark horse, but with Wasserman projecting Acuff, Wagler AND Brown Jr. all gone by 8, fresh ClutchPoints reporting says Saleh could TRADE DOWN slightly to land Mara or Morez Johnson Jr. plus extra capital, and league sources say Atlanta is happily fielding offers for No. 23. Workout wire: Houston's KINGSTON FLEMINGS (confirmed visit), riser EBUKA OKORIE (worked out for ATL, DAL, CHI), and Peachtree Hoops' Jun 11 scouting report flags combine standout CAMERON CARR for the 23 range. Fischer: Atlanta is 'not eager to splurge' on major additions; McCOLLUM retention stays priority one (2yr/$35-40M the exec consensus; Marks floats 2yr/$43M). KEY OFFSEASON DATES: Finals Game 5 TOMORROW (SA) · Draft Night June 23 (11 days) · Hield $9.66M full-guarantee trigger June 25 (13 days) · Kuminga $24.3M team-option call by June 29 (17 days, decline-and-extend the expected path per Fischer) · McCollum UFA market opens June 30 6 PM ET (18 days) · Free agency moratorium July 6.",
};
...
export const NEWS_DIGEST = {
  generatedAt: "2026-06-12T09:20:00Z",
  summary:
    "OFFSEASON, Friday June 12. GAME 5 EVE: the Knicks, the team that ended Atlanta's season in six, are one win from their first championship since 1973. New York leads the Finals 3-1 after Wednesday's 107-106 Game 4 comeback from 29 down at half, the largest in Finals history, and Game 5 is tomorrow night at Frost Bank Center in San Antonio (8:30 PM ET, ABC) with the Spurs installed around -5.5 at home facing elimination and KAT's health the chief Game 5 watch item (Covers / VSiN / Odds Shark / Yahoo Sports). ON THE HAWKS BEAT (11 days to the draft): Atlanta still 'loves' Illinois's KEATON WAGLER and Louisville's MIKEL BROWN JR. at No. 8 with 7'3 ADAY MARA the size dark horse, but with B/R's Wasserman projecting Acuff, Wagler and Brown Jr. all off the board by 8, fresh ClutchPoints reporting says Saleh could TRADE DOWN slightly to land Mara or Morez Johnson Jr. plus extra capital, and league sources say the Hawks have told rival teams they will happily field offers for No. 23. The workout wire added riser EBUKA OKORIE (ATL, DAL and CHI visits), and Peachtree Hoops profiled combine standout CAMERON CARR on Thursday as a name to watch in the 23 range. Jake Fischer reports Atlanta is 'not eager to splurge' on major roster additions, keeping the focus on internal growth plus the McCollum re-sign (2yr/$35-43M the projected band) and the Kuminga call. CAP CALENDAR: Hield's $9.66M full-guarantee trigger June 25 (13 days), Kuminga's $24.3M team-option call by June 29 (17 days, decline-and-extend the expected path per Fischer), McCollum-led free agency opens June 30 6 PM ET (18 days). The trade board still runs through JAYLEN BROWN, Risacher and Kispert.",
  keyTopics: [
    {
      title: "Game 5 Eve: Knicks One Win From the Title; Spurs Around -5.5 at Home Saturday, KAT the Watch Item",
      detail:
        "The Finals resume tomorrow night: Game 5 is Saturday June 13 at Frost Bank Center (8:30 PM ET, ABC), with New York leading 3-1 after Wednesday's 107-106 Game 4 steal at MSG, the largest comeback in NBA Finals history (down 76-47 at half; OG ANUNOBY's tip-in with 1.2 seconds left capped a playoff career-high 33 on 7-of-9 from three, and Brunson added 31). Sportsbooks list San Antonio around -5.5 at home facing elimination with the total near 216.5, and Knicks fans are reportedly buying up Frost Bank Center seats in numbers (Covers / VSiN / Odds Shark / Yahoo Sports, Jun 11-12). The analysts' chief Game 5 storyline is Karl-Anthony Towns, who sat most of Game 4's first half before playing 18 of 24 second-half minutes on a balky frame. The Atlanta resonance stays direct: the Brunson-led team that eliminated the Hawks in six on Apr 30 is one win from New York's first championship since 1973.",
      category: "games",
    },
    {
      title: "Fresh Board Intel: Hawks 'Love' Wagler and Mikel Brown Jr. at No. 8, With One Giant Catch",
      detail:
        "The clearest read yet on Atlanta's draft room, reported Tuesday June 9 by ClutchPoints and picked up by Yahoo Sports: the Hawks 'love' two point guards at No. 8, Illinois' KEATON WAGLER and Louisville's MIKEL BROWN JR. The catch: sources say the front office is ALSO high on 7'3 Michigan center ADAY MARA, the cleanest answer to the interior-size problem the Knicks series exposed, yet conversations with league personnel keep pointing to Atlanta favoring a guard to secure the backcourt long-term. Brown Jr.'s advanced playmaking, pace control and three-level scoring remain the most popular Atlanta fit in mocks; Wagler is profiled by SI's onsi as having 'the tools to be the franchise guard.' Rival execs still expect either a point guard or Mara at 8, and a trade-down to grab Mara or Morez Johnson Jr. plus extra capital stays in play if guards fly off the board early (HoopsHype / SI onsi / ClutchPoints, Jun 7-9). The newest wrinkle: B/R's Jonathan Wasserman projects Acuff, Wagler AND Brown Jr. all gone by No. 8 in his latest mock, with Houston's Kingston Flemings (a confirmed Hawks workout visitor) still on the board, and slots Mara to Atlanta (Bleacher Report / Peachtree Hoops mock roundup, Jun 10-11). Draft Night is June 23, 11 days out.",
      category: "general",
    },
    {
...
export const ISSUE = {
  date: "2026-06-12",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 12,                                       // Issue number (offseason cadence)
  dateline: "ATLANTA · JUNE 12, 2026",              // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 12 · JUNE 2026 · ATL · USA",
  railLabel: "ISSUE 12 · JUNE 12",
  coverStarId: 1,                                   // PLAYERS[id] for the cover portrait
  coverRibbon: "EXCLUSIVE · COVER STAR · JALEN JOHNSON",
  coverStatusKicker: "OFFSEASON · DAY 42",          // top-right corner of cover
