...
export const PLAYERS = [
  ...
  },
  {
    ...
    recentNotes: "SATURDAY JUNE 13 — Daniels' offseason boss is now PRESIDENT OF BASKETBALL OPS ONSI SALEH (promoted from GM + extended long-term Wed May 27 per ESPN / Washington Post / Yahoo / SI onsi / Hoops Rumors). NBA ALL-DEFENSIVE SECOND TEAM nod (announced Fri May 22; NBA.com / AJC / Atlanta News First / Roundtable) is his second straight year on an All-Defense team after making FIRST TEAM in 24-25. He drew 9 first-place and 32 second-place votes from the 100-member global media panel (50 points, 10th in overall voting) and tied for the NBA lead in steals per game at 2.0 with OKC's Cason Wallace; Atlanta posted a top-10 defensive rating for the first time in nearly a decade with Daniels as the primary point-of-attack defender. The Second-Team finish — down from First Team a year ago — tracks a hard offensive year: his three-point shooting cratered to 18.8% (22-of-117), and Daniels has spoken candidly about getting into a 'dark place' mentally, planning an LA summer to rebuild the jumper and 'get stronger.' Victor Wembanyama was the unanimous DPOY and lone unanimous All-Defense 1st-teamer; Daniels was not a 2026 DPOY finalist after finishing runner-up in 25. AROUND THE LEAGUE: KNICKS LEAD THE FINALS 3-1 after erasing a 29-point halftime deficit Wed Jun 10 to win Game 4 107-106 on Anunoby's tip-in with 1.2 seconds left, the largest comeback in Finals history (Anunoby 33, Brunson 31); Game 5 is tonight, Sat Jun 13 in San Antonio, 8:30 ET ABC. Regular-season line of 11.9/6.8/5.9 on 2.0 stl across 80 games (76 starts) is the locked baseline; four-year, $100M rookie extension (signed Oct 2025 per ESPN / NBA.com) kicks in next season; not trade-eligible until July 1, 2026.",
  ...
  },
  {
    ...
    recentNotes: "SATURDAY JUNE 13 (offseason — PRESIDENT OF BASKETBALL OPS ONSI SALEH promoted + extended Wed May 27 per ESPN / Washington Post / Yahoo / SI onsi / Hoops Rumors; SPURS TOOK WCF GAME 7 111-103 Sat May 30 (Wembanyama 22-7), ousting OKC to reach the Finals; KNICKS LEAD THE FINALS 3-1 after erasing a 29-point halftime deficit Wed Jun 10 to win Game 4 107-106 on Anunoby's tip-in with 1.2 seconds left, the largest comeback in Finals history (Anunoby 33, Brunson 31); Game 5 is tonight, Sat Jun 13 in San Antonio, 8:30 ET ABC) — Likeliest summer trade chip alongside Risacher, and Saleh as new POBO owns the call. Hollinger explicitly names Kispert (with Risacher) as the likeliest summer trade chip; cap notes show $14.6M next season then a $17.4M cap hit in 27-28. Salary-matching utility in any Jaylen Brown framework is real — the No. 8 pick plus Kispert plus Hield's $9.4M would clear the $57M Brown number per Hoops Rumors / Boston.com / Larry Brown Sports (May 10-22). Regular season line of 9.6/2.4/1.3 on 40.2% from three in 40 games (8 starts) was the post-trade Hawks portion.",
  ...
  },
  {
    ...
    recentNotes: "SATURDAY JUNE 13 (offseason — PRESIDENT OF BASKETBALL OPS ONSI SALEH promoted + extended Wed May 27 per ESPN / Washington Post / Yahoo / SI onsi / Hoops Rumors; SPURS TOOK WCF GAME 7 111-103 Sat May 30 (Wembanyama 22-7), ousting OKC to reach the Finals; KNICKS LEAD THE FINALS 3-1 after erasing a 29-point halftime deficit Wed Jun 10 to win Game 4 107-106 on Anunoby's tip-in with 1.2 seconds left, the largest comeback in Finals history (Anunoby 33, Brunson 31); Game 5 is tonight, Sat Jun 13 in San Antonio, 8:30 ET ABC) — Missed the entire first round of the playoffs after the Apr 1 right high-ankle sprain (Heavy/CBS, Apr 24). UFA per Bleacher Report cap notes. Offseason story is whether the new POBO re-signs the third center or pivots to the lottery picks (No. 8 secured May 10) or to Hartenstein-tier FA money for help up front; the Hartenstein chase (per Soaring Down South 'top free-agency frontcourt target', May 11) directly competes with re-signing Landale.",
    playoffStats: null,
    playoffSeries: null,
    minutesTrend: null,
...
export const NEXT_GAME = {
  ...
  broadcast: "ABC / ESPN",
  seriesContext: "SATURDAY JUNE 13: GAME 5 IS TONIGHT. THE KNICKS, THE TEAM THAT ENDED ATLANTA'S SEASON, CAN CLINCH THE TITLE. New York leads the Finals 3-1 after Wednesday's 107-106 Game 4 steal at MSG, the largest comeback in Finals history (down 76-47 at half; ANUNOBY's tip-in with 1.2 seconds left capped his playoff career-high 33). Game 5 is TONIGHT at Frost Bank Center in San Antonio (8:30 PM ET, ABC); books list the Spurs around -5.5 at home facing elimination, and the watch item is KAT's health after he sat most of Game 4's first half (Yahoo Sports / NBA.com / Covers). A Knicks win delivers New York's first championship since 1973, completed through the bracket that ran over Atlanta in six. HAWKS BEAT, 10 DAYS TO THE DRAFT: Brett Siegel's latest has Atlanta 'loving' PGs KEATON WAGLER and MIKEL BROWN JR. at No. 8 with 7'3 ADAY MARA the size dark horse, while CBS Sports' newest mock sends Houston's KINGSTON FLEMINGS to the Hawks at 8 and pairs Chris Cenac Jr. at No. 23. League sources say Atlanta will happily field offers for No. 23. Trade board: Marc Stein reports the Hawks have 'legitimate interest' in hometown star JAYLEN BROWN if Boston moves him, though Saleh holds that this roster is 'not one player away.' KEY OFFSEASON DATES: Finals Game 5 TONIGHT (SA) · Draft Night June 23 (10 days) · Hield $9.66M full-guarantee trigger June 25 (12 days) · Kuminga $24.3M team-option call by June 29 (16 days, decline-and-extend the expected path per Fischer) · McCollum UFA market opens June 30 6 PM ET (17 days) · Free agency moratorium July 6.",
};
...
export const NEWS_DIGEST = {
  ...
  summary:
    "OFFSEASON, Saturday June 13. GAME 5 IS TONIGHT: the Knicks, the team that ended Atlanta's season in six, can clinch their first championship since 1973 in San Antonio (8:30 PM ET, ABC). New York leads the Finals 3-1 after Wednesday's 107-106 Game 4 comeback from 29 down at half, the largest in Finals history, and the Spurs are installed around -5.5 at home facing elimination with KAT's health still the chief watch item (Yahoo Sports / NBA.com / Covers, Jun 12-13). ON THE HAWKS BEAT (10 days to the draft): Brett Siegel's latest has Atlanta 'loving' two point guards at No. 8, Illinois's KEATON WAGLER and Louisville's MIKEL BROWN JR., with 7'3 ADAY MARA the size dark horse the front office is also high on, and a CBS Sports mock now sends Houston's KINGSTON FLEMINGS to the Hawks at 8 to solve the lead-guard hole. League sources say Atlanta has told rival teams it will happily field offers for No. 23, and Jake Fischer reports the Hawks are 'not eager to splurge' on major additions, keeping the focus on internal growth plus the McCollum re-sign (2yr/$35-43M the projected band) and the Kuminga call. The fresh trade-board headline: Marc Stein reports some around the league believe Atlanta has legitimate interest in hometown star JAYLEN BROWN if the Celtics make him available, though Saleh maintains this roster is 'not one player away.' CAP CALENDAR: Hield's $9.66M full-guarantee trigger June 25 (12 days), Kuminga's $24.3M team-option call by June 29 (16 days, decline-and-extend the expected path per Fischer), McCollum-led free agency opens June 30 6 PM ET (17 days).",
  keyTopics: [
    {
      title: "Game 5 Tonight: Knicks Can Clinch the Title in San Antonio; Spurs Around -5.5 at Home, KAT the Watch Item",
      detail:
        "It is championship night: Game 5 is tonight, Saturday June 13 at Frost Bank Center (8:30 PM ET, ABC), with New York leading 3-1 and a win delivering its first title since 1973. The Knicks took a stranglehold with Wednesday's 107-106 Game 4 steal at MSG, the largest comeback in NBA Finals history (down 76-47 at half; OG ANUNOBY's tip-in with 1.2 seconds left capped a playoff career-high 33 on 7-of-9 from three, and Brunson added 31). Sportsbooks list San Antonio around -5.5 at home facing elimination with the total near 216.5, and Knicks fans have reportedly bought up Frost Bank Center seats in numbers (Yahoo Sports / NBA.com / Covers, Jun 12-13). The analysts' chief Game 5 storyline stays Karl-Anthony Towns, who sat most of Game 4's first half before playing 18 of 24 second-half minutes on a balky frame. The Atlanta resonance is direct: the Brunson-led team that eliminated the Hawks in six on Apr 30 is one win from the ring.",
      category: "games",
    },
    {
      title: "Fresh Board Intel: Hawks 'Love' Wagler and Mikel Brown Jr. at No. 8; CBS Mock Sends Flemings to Atlanta",
      detail:
        "The clearest read on Atlanta's draft room, reaffirmed in Brett Siegel's reporting and a Last Word on Sports draft-targets piece Thursday June 12: the Hawks 'love' two point guards at No. 8, Illinois' KEATON WAGLER and Louisville's MIKEL BROWN JR. The catch: sources say the front office is ALSO high on 7'3 Michigan center ADAY MARA, the cleanest answer to the interior-size problem the Knicks series exposed, yet conversations with league personnel keep pointing to Atlanta favoring a guard to secure the backcourt long-term. Brown Jr.'s advanced playmaking, pace control and three-level scoring remain the most popular Atlanta fit in mocks; Wagler shot 44/39/79 with crafty creation that has him in the No. 5-9 range. CBS Sports' newest mock instead sends Houston's KINGSTON FLEMINGS (a confirmed Hawks workout visitor) to Atlanta at 8 to solve the lead-guard hole, then pairs 6'10 Houston big Chris Cenac Jr. with the Hawks at No. 23. NBA.com's post-combine consensus still most often slots Brown Jr. to Atlanta, with Mara the size-need dark horse a trade-down could also target if the guard run starts early (Last Word on Sports / CBS Sports / NBA.com / HoopsHQ, Jun 10-13). Draft Night is June 23, 10 days out.",
      category: "general",
    },
    {
    ...
    {
      title: "CJ McCollum Free Agency: New 2yr/$43M Projection Framed as a 'Steep Discount' Atlanta Should Take",
      detail:
        "Atlanta's headline unrestricted free agent: reporting this month projects McCollum at a two-year, $43M total — a figure framed as a 'steep discount' for a player who averaged 18.7/3.1/4.1 in 41 Hawks games and 19.2 PPG in the playoffs (Bleacher Report / Yahoo Sports / Roundtable, Jun 2-7). That sits just above John Hollinger's executive-consensus range of one or two years slightly over the mid-level exception (~2yr/$35-40M), and one prediction has Atlanta structuring it as 2yr/$40M with a team option starting at $20M. The Hawks' intent is unchanged — they 'want to re-sign' him, likely on a one-to-two-year deal, and McCollum confirmed a 'productive conversation' with the front office the day after the season ended — but he turns 35 in September and 'likely will have other suitors,' with cap-room teams like Chicago or Brooklyn the named risk. The UFA market opens June 30 at 6 PM ET, now 17 days out.",
      category: "trades",
    },
    {
      title: "Kuminga's $24.3M Team Option — June 29 Decision, Decline-and-Extend the Expected Path",
      detail:
        "Atlanta's biggest cap question stays Jonathan Kuminga, with a June 29 deadline on his $24.3M 2026-27 team option, 16 days out (Heavy / Soaring Down South / Yahoo Sports / Fadeaway World / ESPN, May 1-Jun 8). Jake Fischer reports mutual interest in declining the option to negotiate a longer multi-year deal at a lower first-year number — giving Kuminga security and the Hawks a more flexible cap hit, the path most analysts endorse since the 23-year-old is not extension-eligible. Soaring Down South notes the June 23 draft could let Atlanta buy time on the call. The alternatives are exercising the one-year option as a tradable expiring or declining and letting him walk. Kuminga averaged 14.9/5.1/2.2 across 16 Hawks regular-season games and 13.4 PPG in the Knicks series.",
      category: "trades",
    },
    {
      title: "Buddy Hield's $9.66M Decision: June 25 Full-Guarantee Trigger — Return Not Expected",
      detail:
        "Buddy Hield's $9,658,536 ($9.66M) 2026-27 contract becomes fully guaranteed on June 25 — only $3M is currently protected, so Atlanta could save roughly $6M by waiving him before the date (SI onsi cap tracker / Hoops Rumors / SportsTalk ATL, Apr 28-May 29). The trigger is 12 days out. Atlanta can let the full number trigger and keep it as a movable expiring, waive him before the date to save the difference, or include him in a pre-trigger trade. Reporting suggests Hield is not expected back given how little he played after arriving in the Porzingis deal — 71 games, 12 starts at 11.8/2.8/2.1 on 39.8% from three, then just 6 mpg in two first-round games.",
      category: "trades",
    },
    {
      title: "Jaylen Brown Trade Chatter Heats Up: Stein Says Atlanta Has 'Legitimate Interest' if Boston Moves Him",
      detail:
        "The freshest trade-board headline: Marc Stein reports some people around the NBA believe the Hawks have legitimate interest in JAYLEN BROWN if the Celtics make him available, and Jake Fischer notes Atlanta, Brown's hometown, is a spot the Marietta, GA native would have interest in landing (The Stein Line / Hoops Rumors / SI onsi / Fadeaway World, Jun 7-12). Mock packages have floated Jonathan Kuminga, Zaccharie Risacher and future first-round capital as the framework, with Houston and Portland also named as suitors. Two real hurdles remain: the money, as Brown is owed roughly $53.1M next season after a career-best All-NBA Second Team year, and the front office's own posture, with POBO Onsi Saleh maintaining this roster is 'not one player away' and reporting that the Hawks are patient and not eager to splurge. Atlanta has the assets to do it if Boston decides to move him, but nothing is reported as imminent.",
      category: "trades",
    },
    {
...
export const ISSUE = {
  date: "2026-06-13",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 12,                                       // Issue number (offseason cadence)
  dateline: "ATLANTA · JUNE 13, 2026",              // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 12 · JUNE 2026 · ATL · USA",
  railLabel: "ISSUE 12 · JUNE 13",
  coverStarId: 1,                                   // PLAYERS[id] for the cover portrait
  coverRibbon: "EXCLUSIVE · COVER STAR · JALEN JOHNSON",
  coverStatusKicker: "OFFSEASON · DAY 43",          // top-right corner of cover
