...
export const NEWS_DIGEST = {
  ...
  keyTopics: [
    ...
    {
      title: "Roster Crunch: SI Now Names Hield, Kispert and Risacher as the Likeliest to Move Before the End of July",
      detail:
        "The 15-man regular-season limit has not moved, and neither has Atlanta's roster. After signing all three rookies to standard deals, the Hawks stand at 16 standard contracts, one over the limit, and would need to move two players if Jonathan Kuminga returns (SI onsi / Hoops Rumors, Jul 6-14). This week SI framed it as three names to watch between now and the end of July: Buddy Hield, Corey Kispert and Zaccharie Risacher. Teams can carry 20 through the summer, so there is no hard deadline until camp, but a trade rather than a waiver remains the likeliest trim because Atlanta would prefer to convert the surplus into value. Hield's single expiring year at $9.66M is the easiest salary to move; Kispert has three years left, which makes him the harder sell despite the shooting; Risacher is the upside swing the front office keeps signaling it does not want to give away.",
      category: "trades",
    },
    {
