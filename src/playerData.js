...
export const PLAYERS = [
  ...
  },
  {
    ...
    recentNotes: "SUNDAY MAY 31 (offseason — PRESIDENT OF BASKETBALL OPS ONSI SALEH promoted + extended Wed May 27 per ESPN / Washington Post / Yahoo / SI onsi / Hoops Rumors; SPURS TOOK WCF GAME 7 111-103 Sat May 30 (Wembanyama 22-7), ousting OKC to reach the Finals; KNICKS TOOK GAME 1 105-95 Wed Jun 3, Brunson 30 — G2 Fri Jun 5) — Likeliest summer trade chip alongside Risacher, and Saleh as new POBO owns the call. Hollinger explicitly names Kispert (with Risacher) as the likeliest summer trade chip; cap notes show $14.6M next season then a $17.4M cap hit in 27-28. Salary-matching utility in any Jaylen Brown framework is real — the No. 8 pick plus Kispert plus Hield's $9.4M would clear the $57M Brown number per Hoops Rumors / Boston.com / Larry Brown Sports (May 10-22). Regular season line of 9.6/2.4/1.3 on 40.2% from three in 40 games (8 starts) was the post-trade Hawks portion.",
  ...
  },
  {
    ...
    recentNotes: "SUNDAY MAY 31 (offseason — PRESIDENT OF BASKETBALL OPS ONSI SALEH promoted + extended Wed May 27 per ESPN / Washington Post / Yahoo / SI onsi / Hoops Rumors; SPURS TOOK WCF GAME 7 111-103 Sat May 30 (Wembanyama 22-7), ousting OKC to reach the Finals; KNICKS TOOK GAME 1 105-95 Wed Jun 3, Brunson 30 — G2 Fri Jun 5) — Missed the entire first round of the playoffs after the Apr 1 right high-ankle sprain (Heavy/CBS, Apr 24). UFA per Bleacher Report cap notes. Offseason story is whether the new POBO re-signs the third center or pivots to the lottery picks (No. 8 secured May 10) or to Hartenstein-tier FA money for help up front; the Hartenstein chase (per Soaring Down South 'top free-agency frontcourt target', May 11) directly competes with re-signing Landale.",
    playoffStats: null,
    playoffSeries: null,
    minutesTrend: null,
...
export const NEXT_GAME = {
  ...
  broadcast: "ABC / ESPN",
  seriesContext: "FRIDAY JUNE 5 — FINALS GAME 2 IS TONIGHT, AND THE HAWKS' DRAFT MACHINE IS HUMMING. The Spurs host the Knicks at 8:30 PM ET on ABC at Frost Bank Center, down 0-1 after New York's 105-95 Game 1 win Wednesday behind JALEN BRUNSON's 30 (13 in the fourth); the biggest Game 2 storyline is VICTOR WEMBANYAMA's response to a career-worst 6-of-21, 2-of-9 shooting night with six turnovers — San Antonio is a -5.5 home favorite, and NBA.com says the Spurs must get Wemby touches closer to the rim instead of behind the arc (NBA.com / NBC Sports / FanDuel / CBS New York, Jun 4-5). The ATL angle persists: this is the Brunson-led Knicks team that eliminated Atlanta in six on Apr 30. HAWKS FRESH THREAD: the team's PRE-DRAFT WORKOUT MACHINE is now visible — SI's onsi reports Atlanta brought in four prospects: Kansas big FLORY BIDUNGA, Virginia shot-blocker UGONNA ONYENSO, Miami (OH) wing PETER SUDER and Houston guard MILOS UZAN, the first reported visits of the Hawks' draft cycle with the No. 8, No. 23 and No. 57 picks 18 days out. A QUIN SNYDER EXTENSION REMAINS 'INEVITABLE' per The Stein Line — eight figures annually, negotiated by POBO Onsi Saleh, expected before the June 23 draft. DRAFT BOARD: consensus still tilts Louisville PG MIKEL BROWN JR. at 8 with 7'3 ADAY MARA the dark horse; KEATON WAGLER, KINGSTON FLEMINGS and SEC POY DARIUS ACUFF JR. fill the guard lane, trade-back in play. McCOLLUM retention stays priority one — new reporting frames 2yr/$43M as a 'steep discount' Atlanta would happily take (~2yr/$35-40M the exec consensus). KEY OFFSEASON DATES: Finals Game 2 TONIGHT 8:30 ET · Draft Night June 23 (18 days) · Hield $9.66M full-guarantee trigger June 25 (20 days) · Kuminga $24.3M team-option call by June 29 (24 days, decline-and-extend the expected path per Fischer) · McCollum UFA market opens June 30 6 PM ET (25 days) · Free agency moratorium July 6.",
};
...
export const NEWS_DIGEST = {
  generatedAt: "2026-06-05T08:20:00Z",
  summary:
    "OFFSEASON — Friday June 5. THE FRESH NEWS: FINALS GAME 2 IS TONIGHT (8:30 PM ET, ABC, Frost Bank Center) with the Spurs down 0-1 and the storyline running through VICTOR WEMBANYAMA's bounce-back from a career-worst 6-of-21, 2-of-9 shooting night with six turnovers in Wednesday's 105-95 Game 1 loss to Brunson's Knicks — San Antonio is a -5.5 home favorite, and NBA.com's keys are cleaner ball security and Wemby touches closer to the basket (NBA.com / NBC Sports / FanDuel / CBS New York, Jun 4-5). MEANWHILE THE HAWKS' DRAFT MACHINE IS NOW VISIBLE: SI's onsi reports Atlanta hosted its first four reported pre-draft workouts — Kansas big FLORY BIDUNGA, Virginia shot-blocker UGONNA ONYENSO, Miami (OH) wing PETER SUDER and Houston guard MILOS UZAN — with the No. 8, No. 23 and No. 57 picks 18 days out. A QUIN SNYDER EXTENSION is still being called 'inevitable' by The Stein Line — a 'massive,' eight-figure deal negotiated by POBO Onsi Saleh, expected before the June 23 draft. DRAFT BOARD: consensus still lands most often on Louisville PG MIKEL BROWN JR. at 8, with 7'3 Michigan center ADAY MARA the dark horse, KEATON WAGLER, KINGSTON FLEMINGS and DARIUS ACUFF JR. in the guard lane, and a trade-back possible if guards go at 6 and 7. CAP CALENDAR: Hield's $9.66M full-guarantee trigger June 25 (20 days), Kuminga's $24.3M team-option call by June 29 (24 days) — decline-and-extend the expected path per Jake Fischer — and the McCollum-led free-agency market opening June 30 6 PM ET (25 days). New reporting frames a 2yr/$43M McCollum deal as a 'steep discount' Atlanta would gladly take; the trade board still runs through JAYLEN BROWN, Cameron Johnson, Risacher and Kispert.",
  keyTopics: [
    {
      title: "Finals Game 2 Tonight: Wembanyama's Bounce-Back vs. the Knicks Team That Ended Atlanta's Season",
      detail:
        "Game 2 of the NBA Finals tips TONIGHT, Friday June 5 at 8:30 PM ET on ABC at Frost Bank Center, with San Antonio down 0-1 and installed as a -5.5 home favorite (NBC Sports / FanDuel / BetMGM / Covers, Jun 4-5). The dominant storyline is VICTOR WEMBANYAMA's response to the worst shooting night of his career — 6-of-21 from the field, 2-of-9 from three, six turnovers — in Wednesday's 105-95 Game 1 loss; NBA.com's three keys for the Spurs are cleaner ball security and set designs that get Wembanyama high-post and pick-and-pop touches instead of catches well behind the arc. JALEN BRUNSON scored 30 in Game 1, 13 in the fourth quarter, as New York erased a 14-point second-half deficit on the Spurs' floor. The ATL angle is unavoidable — this is the same Brunson-led Knicks team that eliminated the Hawks in six on Apr 30 (including the historic 140-89 Game 6), now three wins from New York's first title since 1973. The series shifts to Madison Square Garden on Monday June 8.",
      category: "games",
    },
    {
      title: "Hawks Host First Reported Pre-Draft Workouts: Bidunga, Onyenso, Suder, Uzan Through the Building",
      detail:
        "The draft machine is now visible. SI's onsi reports the Hawks brought in four prospects for pre-draft workouts — Kansas big FLORY BIDUNGA, Virginia shot-blocker UGONNA ONYENSO, Miami (OH) wing PETER SUDER and Houston guard MILOS UZAN — the first reported visits of Atlanta's draft cycle (SI onsi / Yahoo Sports draft workout tracker, early Jun). The group skews toward second-unit size and depth, profiling as targets for No. 23 or No. 57 rather than the No. 8 pick — Bidunga and Onyenso both fit the rim-protection need the Knicks series exposed, and Uzan adds to the point-guard survey the front office is running at the top of the board. With the draft 18 days out (June 23-24, Barclays Center), expect the workout cadence to accelerate; more visits are expected to surface in the coming days.",
      category: "general",
    },
    {
    ...
    {
      title: "Draft Board: NBA.com Consensus Now Lands on Mikel Brown Jr. at No. 8; Mara the Dark Horse, Trade-Back in Play",
      detail:
        "With the No. 8 pick 18 days out, NBA.com's post-Combine consensus mock most often slots Louisville PG MIKEL BROWN JR. to Atlanta, with 7'3 Michigan center ADAY MARA the alternative appearing in four mocks (NBA.com consensus / HoopsHype / ClutchPoints / SI onsi / Bleacher Report / Peachtree Hoops, May 23-Jun 1). HoopsHype's Michael Scotto reports rival execs expect Atlanta to target either a point guard or Mara, and Brett Siegel's ClutchPoints mock sends Mara to the Hawks — addressing the size and interior defense the Knicks exposed; an anonymous scout, however, told NBA.com that Brown Jr. would be a poor fit for Atlanta's needs. The guard lane stays crowded: Louisville's MIKEL BROWN JR., Houston defender KINGSTON FLEMINGS, SEC Player of the Year DARIUS ACUFF JR. (23.5 PPG as a freshman) and newly-surfaced Illinois guard KEATON WAGLER are all in the mix, while defensive-anchor big JAYDEN QUAINTANCE (6'9 / 253, 7'5+ wingspan, knee-injury risk) remains on the board. Atlanta could also trade back: the front office is expected to field calls on the pick if guards fly off the board at 6 and 7. The Hawks hold Nos. 8, 23 and 57; the draft runs June 23-24 at Barclays Center.",
      category: "general",
    },
    {
...
export const ISSUE = {
  date: "2026-06-05",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
