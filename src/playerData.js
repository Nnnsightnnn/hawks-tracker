...
export const ISSUE = {
  date: "2026-07-22",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 32,                                       // Issue number (offseason cadence)
  dateline: "ATLANTA · JULY 22, 2026",              // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 32 · JULY 2026 · ATL · USA",
  railLabel: "ISSUE 32 · JULY 22",
  ...
  coverImage: null,
  coverRibbon: "LAKERS AND HAWKS FAR APART ON KUMINGA · ATLANTA'S OWN PATH BACK NOW THE MID-LEVEL · DENVER WANTS THE KESSLER PACKAGE FOR PEYTON WATSON · 17 CONTRACTS, $196.2M, $4M UNDER THE TAX · NEXT GAME OCT 5 VS MEMPHIS",
  coverStatusKicker: "OFFSEASON · DAY 79",          // top-right corner of cover
  coverStatusLine: "KUMINGA TALKS FAR APART · WATSON PRICE SET AT THE KESSLER PACKAGE · 17 CONTRACTS, LIMIT 15 · NEXT: PRESEASON, OCT 5", // {DAYS:id} resolves from KEY_DATES
