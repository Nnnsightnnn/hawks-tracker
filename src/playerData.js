...
export const ISSUE = {
  date: "2026-07-30",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 36,                                       // Issue number (offseason cadence)
  dateline: "ATLANTA · JULY 30, 2026",              // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 36 · JULY 2026 · ATL · USA",
  railLabel: "ISSUE 36 · JULY 30",
  ...
  coverImage: null,
  coverRibbon: "HAWKS SIGN CHRISTIAN KOLOKO ON AN EXHIBIT 9 · KUMINGA STANDOFF HOLDS, ATLANTA STILL CHOOSY · WATSON PATH NARROWS AS DENVER HITS THE SECOND APRON · 17 CONTRACTS, LIMIT 15 · NEXT GAME OCT 5 VS MEMPHIS",
  coverStatusKicker: "OFFSEASON · DAY 87",          // top-right corner of cover
  coverStatusLine: "KOLOKO ADDED ON A CAMP DEAL AS GUEYE STAYS OUT · KUMINGA-FOR-VANDERBILT STILL STUCK ON THE 2027-28 OPTION · DENVER'S SPENCER JONES MATCH COMPLICATES WATSON · 17 CONTRACTS, LIMIT 15 · NEXT: PRESEASON, OCT 5", // {DAYS:id} resolves from KEY_DATES
  backTagline: "Next issue: whether Atlanta and the Lakers close the Kuminga-for-Vanderbilt sign-and-trade or the Hawks hold out over the 2027-28 option, which two contracts go to get to 15, whether the Koloko camp deal signals a bigger center move, and whether Atlanta has the picks left to meet Denver's number on Watson now that the Nuggets are in the second apron.",
};
