...
export const NEXT_GAME = {
  ...
  broadcast: "ABC / ESPN",
  seriesContext: "THURSDAY JUNE 18, 5 DAYS TO THE DRAFT. THE LIVE THREAD IS THE GIANNIS MARKET AND ATLANTA'S PLACE IN IT, and the overnight read cooled the 'done before the draft' certainty: the Bucks remain UNCONVINCED by Miami's improved package (now reported to include the No. 13 pick plus Tyler Herro and young prospects) and are seeking clarity from a wider field, Boston, Minnesota and Orlando among the suitors, before committing, while Chris Haynes cautioned the resolution could slip past June 23 into free agency (Total Pro Sports / Bleacher Report / SI, Jun 17). Atlanta's stake holds: if Boston wins the race, JAYLEN BROWN almost certainly moves, and Marc Stein reports a Brown deal is 'nearing clarity' with the Hawks, Rockets and Trail Blazers circling as the third team that could facilitate. The hurdle is Brown's three years and roughly $183M, and POBO Onsi Saleh holds this roster is 'not one player away.' CAP CALENDAR (HoopsHype, Jun 17): the Hawks 'hope to re-sign CJ McCollum' near $20M per year, and John Hollinger predicts Atlanta DECLINES Kuminga's $24.3M option (BORD$ value near $9.4M). THE BACKDROP: the New York Knicks are NBA champions, the team that ended Atlanta's season, closing San Antonio 94-90 in Game 5 to take the Finals 4-1, JALEN BRUNSON 45 and Finals MVP (ESPN / NBA.com / FOX Sports). DRAFT BOARD: a fresh CBS Sports mock keeps Louisville PG MIKEL BROWN JR. at Atlanta No. 8, while ESPN's Jeremy Woo lists 7'3 ADAY MARA as the size-need answer; league sources say the Hawks will happily field offers for No. 23. KEY OFFSEASON DATES: Draft Night June 23 (5 days) · Hield $9.66M full-guarantee trigger June 25 (7 days) · Kuminga $24.3M team-option call by June 29 (11 days, decline expected per Hollinger) · McCollum UFA market opens June 30 6 PM ET (12 days) · Free agency moratorium July 6.",
};
...
export const NEWS_DIGEST = {
  ...
  summary:
    "OFFSEASON, Thursday June 18, five days to the draft. THE LIVE THREAD is still the Giannis Antetokounmpo market, but the overnight read cooled the 'done before the draft' certainty. Multiple outlets report the Bucks remain UNCONVINCED by Miami's improved package (which has grown to include the No. 13 pick alongside Tyler Herro and young prospects) and are canvassing other suitors, Boston, Minnesota and Orlando among them, for clarity before committing, while betting markets put Giannis staying in Milwaukee at roughly 10 percent (Total Pro Sports / Bleacher Report / SI, Jun 17). Chris Haynes cautioned that the resolution could slip past June 23 into free agency, so Atlanta's wait may run longer than this week. The Hawks' stake is unchanged: if BOSTON wins the race, JAYLEN BROWN almost certainly moves, and Marc Stein reports a Brown deal is 'nearing clarity' with the Hawks, Rockets and Trail Blazers circling as the third team that could facilitate. Atlanta's hook is its asset base (it owns Milwaukee's unprotected 2027 first) plus the hometown angle, since Brown grew up in the Atlanta area; the hurdle is his three years and roughly $183M, and POBO ONSI SALEH still insists this roster is 'not one player away.' CAP CALENDAR (HoopsHype, Jun 17): the Hawks 'hope to re-sign CJ McCollum,' projecting him near $20M per year, John Hollinger predicts Atlanta DECLINES Jonathan Kuminga's $24.3M team option (BORD$ values him near $9.4M), and Buddy Hield's $9.66M full-guarantee trigger hits June 25. ON THE BOARD: a fresh CBS Sports mock keeps Louisville PG MIKEL BROWN JR. at No. 8 while ESPN's Jeremy Woo lists 7'3 ADAY MARA as the size-need answer the Knicks series demanded; Atlanta will field offers for No. 23. THE BACKDROP: the New York Knicks are NBA champions (Brunson 45, Finals MVP, closed San Antonio 4-1), the same team that bounced the Hawks in Round 1. KEY DATES: Hield June 25 (7 days), Kuminga June 29 (11 days), McCollum-led free agency June 30 6 PM ET (12 days).",
  keyTopics: [
    {
      title: "Jaylen Brown Watch: Bucks 'Unconvinced' by Miami's Offer; Giannis Call May Slip Past the Draft, Brown Still the Hawks' Path In",
      detail:
        "Atlanta's hottest trade thread is the closest thing the offseason has to live action, and the overnight read pumped the brakes on the 'done before the draft' assumption. Multiple outlets now report the MILWAUKEE BUCKS remain UNCONVINCED by Miami's current package even after the Heat improved it, with the offer reported to include the No. 13 overall pick alongside Tyler Herro and multiple young prospects, and the Bucks are seeking clarity from a wider field, Boston, Minnesota and Orlando among the suitors, before they commit (Total Pro Sports / Yardbarker / Bleacher Report / SI, Jun 17). Betting markets place Giannis staying in Milwaukee at roughly 10 percent, but NBA insider Chris Haynes cautioned the resolution 'can drag into free agency and July,' so the call may not land before the Hawks are on the clock June 23. Atlanta's stake is the Boston lane: if the Celtics win the race, JAYLEN BROWN almost certainly moves, and Marc Stein reports a Brown deal is 'nearing clarity' with the Hawks, Rockets and Trail Blazers circling as the third team that could facilitate, with the Clippers also now listed among teams in pursuit (The Stein Line / Yahoo Sports / SI onsi, Jun 12-17). The Atlanta case is real: the Hawks own Milwaukee's unprotected 2027 first plus young filler and two firsts this year (Nos. 8 and 23), and Brown grew up in the Atlanta area, so a homecoming as the No. 1 option fits sentimentally and on the floor. The hurdles are just as real: Brown, who turns 30 in October, is owed three years and roughly $183M ($53-57M next season), the salary math forces Atlanta to package picks plus filler (the No. 8 pick, Hield, Kispert all surface in mocks), and POBO Onsi Saleh keeps insisting this roster is 'not one player away.' Nothing is signed, and the timeline just got murkier.",
      category: "trades",
    },
    {
      title: "Board Swing: Fresh CBS Sports Mock Sends Mikel Brown Jr. Back to Atlanta at No. 8 as the Guard Run Stays Fluid",
      detail:
        "The pre-draft board keeps moving on Atlanta's most-mocked target. A new CBS Sports mock (Jun 16) projects Louisville PG MIKEL BROWN JR. to the Hawks at No. 8, a reversal from this week's ClutchPoints Big Board 4.0 read that called Brown Jr. a 'long shot' to last that long, underscoring how fluid the guard run at 5-7 is six days out. ESPN's Jeremy Woo adds that the Hawks 'have done work on all the guards in this range' and lists 7'3 Michigan center ADAY MARA as a live option, the cleanest answer to the interior-size problem the Knicks series exposed. The squeeze from above is unchanged: Bleacher Report reports the Sacramento Kings, one spot ahead at No. 7, view Arkansas guard DARIUS ACUFF JR. as their draft 'floor,' so one of the guards Atlanta covets could be gone before the Hawks pick, with Houston lead guard KINGSTON FLEMINGS and Illinois' KEATON WAGLER also in the range. HoopsHype's Michael Scotto reports rival execs still expect Atlanta to land either a point guard or Mara, and league sources say the front office is open to moving up or down and will happily field offers for No. 23. The Hawks hold Nos. 8, 23 and 57; the draft runs June 23-24 at Barclays Center, 5 days out.",
      category: "general",
    },
    {
    ...
    {
      title: "CJ McCollum Free Agency: HoopsHype Says Hawks 'Hope to Re-Sign' Him, Projects Roughly $20M Per Year",
      detail:
        "Atlanta's headline unrestricted free agent got fresh intel Wednesday: HoopsHype's report (Jun 17) states plainly that the Hawks 'hope to re-sign CJ McCollum' and projects him to return on a deal averaging around $20M per year. That lines up with the prior two-year, $43M projection framed as a 'steep discount' and with John Hollinger's executive-consensus range of one or two years slightly over the mid-level exception, with one structure floated as 2yr/$40M including a team option starting at $20M. McCollum averaged 18.7/3.1/4.1 in 41 Hawks games and 19.2 PPG across the six first-round games, and confirmed a 'productive conversation' with the front office the day after the season ended. The catch HoopsHype flags: Atlanta still wants a younger downhill ballhandler to pair with Jalen Johnson long term, so a draft guard could share the backcourt plan. He turns 35 in September and 'likely will have other suitors,' with cap-room teams like Chicago or Brooklyn the named risk. The UFA market opens June 30 at 6 PM ET, now 12 days out.",
      category: "trades",
    },
    {
      title: "Kuminga's $24.3M Team Option: Hollinger Now Predicts Atlanta DECLINES; June 29 Deadline, 11 Days Out",
      detail:
        "Atlanta's biggest cap question stays Jonathan Kuminga, and the latest read points one direction: John Hollinger of The Athletic now predicts the Hawks DECLINE the $24.3M 2026-27 team option, noting Atlanta's BORD$ model values the 23-year-old near $9.4M, well short of the option number (NBC Sports Bay Area / Warriors Central, Jun 16-17). The deadline is June 29, 11 days out. Jake Fischer's reported mutual interest in declining to negotiate a longer multi-year deal at a lower first-year number remains the favored path, since Kuminga is not extension-eligible, though HoopsHype sources still call a return 'a real possibility' and note Atlanta has canvassed his trade market. The alternatives are exercising the one-year option as a tradable expiring or declining and letting him walk for nothing. Soaring Down South notes the June 23 draft could let Atlanta see the board before locking the call. Kuminga averaged 14.9/5.1/2.2 across 16 Hawks regular-season games and 13.4 PPG in the Knicks series.",
      category: "trades",
    },
    {
      title: "Buddy Hield's $9.66M Decision: June 25 Full-Guarantee Trigger — Return Not Expected",
      detail:
        "Buddy Hield's $9,658,536 ($9.66M) 2026-27 contract becomes fully guaranteed on June 25, only $3M is currently protected, so Atlanta could save roughly $6M by waiving him before the date (SI onsi cap tracker / Hoops Rumors / SportsTalk ATL, Apr 28-May 29). The trigger is 7 days out. Atlanta can let the full number trigger and keep it as a movable expiring, waive him before the date to save the difference, or include him in a pre-trigger trade. Reporting suggests Hield is not expected back given how little he played after arriving in the Porzingis deal — 71 games, 12 starts at 11.8/2.8/2.1 on 39.8% from three, then just 6 mpg in two first-round games.",
      category: "trades",
    },
    {
