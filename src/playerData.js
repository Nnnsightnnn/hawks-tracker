...
export const NEWS_DIGEST = {
  generatedAt: "2026-07-28T13:20:00Z",
  summary:
    "AS OF TUESDAY, JULY 28, THE KUMINGA MARKET STILL POINTS AT LOS ANGELES, WITH NO NEW MOVEMENT REPORTED OVERNIGHT. The framework insiders described over the weekend holds: the Lakers are the clear frontrunner for a JONATHAN KUMINGA sign-and-trade, Atlanta appears willing to send him out for JARRED VANDERBILT and possibly a second piece, and the lone sticking point remains the Hawks' resistance to absorbing Vanderbilt's $13.29M player option for 2027-28 (Brett Siegel / Jake Fischer via ClutchPoints / Heavy / SI onsi, Jul 24-26). Kuminga's camp is still targeting roughly $20M to $23M annually against a two-year Lakers offer that started near $20M, and the trade restrictions on Devin Carter (Aug 30) and Ryan Nembhard (Sept 19) continue to shape any multi-piece construction. HOW WE GOT HERE: CLEVELAND BLINKED, AND THE MARKET SNAPPED BACK. The Cavaliers signed forward MARIO HEZONJA to a one-year, $2.8M deal Sunday (Jul 26), a low-cost move that does not formally close their interest in JONATHAN KUMINGA but sharply cuts the urgency to spend $15M-plus on another forward, and multiple insiders now read the Lakers as the clear frontrunner to land Kuminga in a sign-and-trade with Atlanta (Brett Siegel / ClutchPoints / Heavy / SI onsi, Jul 26). Siegel reported the Hawks appear ready to send Kuminga to Los Angeles while taking back JARRED VANDERBILT and possibly a second piece, but the sticking point is unchanged: Atlanta has been resistant to absorbing Vanderbilt's $13.29M player option for 2027-28, and Kuminga's camp is still targeting roughly $20M to $23M annually against a two-year Lakers offer that started near $20M. The backdrop is Thursday's LeBron James decision, a two-year deal worth about $8M with Philadelphia (Shams Charania, Jul 24), which shut Cleveland out at the top of the market and set this chain in motion. ELSEWHERE: the Hawks added forward JALEN WILSON on a two-way contract, the secondary wing chase for PEYTON WATSON remains stuck on Denver's Walker-Kessler-sized ask while the Nuggets say they are confident they will keep him, the roster still sits at 17 standard contracts against a 15-man limit with BUDDY HIELD's fully guaranteed $9.66M expiring deal the likeliest trim, and MOUHAMED GUEYE remains three to four months from re-evaluation after left-foot surgery. PRIOR EDITION: THE FIRST NO. 1 PICK ATLANTA EVER DRAFTED IS GONE, AND AN ALL-DEFENSIVE WING IS HERE. The Hawks acquired LUGUENTZ DORT and RYAN NEMBHARD from Oklahoma City on Sunday in a three-team trade that sent ZACCHARIE RISACHER to Dallas and three second-round picks to the Thunder (Chicago's 2027 via Dallas, plus Atlanta's most favorable 2031 and 2032). Onsi Saleh swapped a 21-year-old former No. 1 pick who had fallen out of the playoff rotation for a 27-year-old champion and All-Defensive First Team wing on an expiring $17.7M deal, giving Quin Snyder a perimeter of Dort, DYSON DANIELS and NICKEIL ALEXANDER-WALKER that may be the most disruptive in the league. The cost is offense: Dort shot 38.5% from the field and 34.4% from three last season, both career lows, and most projections have him coming off the bench with heavy minutes rather than starting. Atlanta is now at 17 standard contracts against a 15-man limit, which means two more moves are coming. What Atlanta gains in exchange is flexibility: more than $50M in expiring salary between Dort, CJ McCOLLUM and JOCK LANDALE to trade with in-season, about $4M of room under the tax now, and north of $40M in cap space next summer. From here the calendar is empty until the Oct 5 preseason opener against Memphis at State Farm Arena, with the front office's summer math unfinished on three fronts: trimming to 15, resolving Kuminga one way or the other, and deciding whether to keep pressing on TREY MURPHY III or pivot to the center board.",
  keyTopics: [
    {
      title: "Kuminga Watch, Tuesday Jul 28: Market Still Points to the Lakers, No New Movement Overnight",
      detail:
        "As of Tuesday, July 28, the picture is unchanged from the weekend and quiet: the Lakers remain the clear frontrunner for a Jonathan Kuminga sign-and-trade, Atlanta appears willing to move him for Jarred Vanderbilt and possibly a second piece, and the holdup is still the Hawks' resistance to Vanderbilt's $13.29M player option for 2027-28 (Brett Siegel / Jake Fischer via ClutchPoints / Heavy / SI onsi, Jul 24-26). No fresh reporting broke overnight. HOW WE GOT HERE: Cleveland made the move that reshaped Atlanta's July: the Cavaliers signed forward Mario Hezonja to a one-year, $2.8M deal Sunday (Cavaliers Nation / Fadeaway World / Hoops Rumors, Jul 26). It does not formally end their interest in Jonathan Kuminga, but it substantially reduces the urgency to invest $15M to $20M in another forward, and multiple insiders now read the Lakers as the clear frontrunner to land Kuminga in a sign-and-trade with the Hawks (Brett Siegel via ClutchPoints / Yahoo Sports / Heavy, Jul 26). Siegel reported that Atlanta appears ready to send Kuminga to Los Angeles while taking back Jarred Vanderbilt and perhaps a second player, which would finally resolve the two-month standoff over Atlanta's most valuable expiring asset. Kuminga became an unrestricted free agent when Atlanta declined his $24.3M option Jun 29 and is reportedly seeking a salary in the $20M to $23M range, near what the picked-up option would have paid; the Lakers previously offered a two-year deal worth around $20M that he declined. The precursor was Thursday's LeBron James decision to sign with Philadelphia (Shams Charania, Jul 24), which shut Cleveland out at the top of the market. With the Cavs now adding Hezonja instead, Los Angeles is the lone motivated sign-and-trade partner left standing.",
      category: "trades",
    },
    {
    ...
    {
      title: "Denver Names Its Watson Price: The Walker Kessler Package, and a Plan to Match Anyway",
      detail:
        "The other wing Atlanta has chased all July now has a number attached. Reporting this week has the Nuggets seeking compensation comparable to what Utah received in the Walker Kessler sign-and-trade with the Lakers, unprotected first-round picks in 2031 and 2033 plus swaps in 2028 and 2030, while Denver simultaneously plans to match any offer sheet Peyton Watson signs as a restricted free agent (Yahoo Sports / SI onsi / Heavy / Pro Football Network, Jul 17-20). Watson is reportedly seeking $25M to $30M annually, and Milwaukee joined the Clippers and Hawks among teams working the sign-and-trade angle. The latest from mid-July has Denver confident it will retain him and treating the negotiation as a long game (HoopsHype, Jul 17). Atlanta's problem is the same one the Kuminga talks exposed: after sending three seconds to Oklahoma City on Sunday, the picks it would need to clear Denver's ask are the picks it has been spending. Interest is real, a deal is not close.",
      category: "trades",
    },
    {
