...
export const NEWS_DIGEST = {
  generatedAt: "2026-06-15T13:30:00Z",
  summary:
    "OFFSEASON, Monday June 15, eight days to the draft. THE LIVE THREAD is the Giannis Antetokounmpo market and Atlanta's place in it: with the Bucks expected to move Antetokounmpo before the June 23 draft and Boston reportedly willing to part with JAYLEN BROWN to land him, Marc Stein reports a Brown deal is 'nearing clarity' and names the Hawks, Rockets and Trail Blazers as the suitors circling if Brown shakes loose (Yahoo Sports / The Stein Line / SI onsi, Jun 12-14). Evan Sidery's three-team framework (Jun 11) routes Brown and Sam Hauser to Atlanta while Boston acquires Giannis; the hurdle is Brown's three years and roughly $183M, and POBO ONSI SALEH still insists this roster is 'not one player away.' THE BACKDROP: the New York Knicks are NBA champions, the team that bounced the Hawks in the first round closing San Antonio 94-90 in Game 5 Saturday to take the Finals 4-1, New York's first ring since 1973, Jalen Brunson 45 and Finals MVP (ESPN / NBA.com / FOX Sports). ON THE DRAFT BOARD: Brett Siegel has Atlanta 'loving' point guards KEATON WAGLER and MIKEL BROWN JR. at No. 8 with 7'3 ADAY MARA the size dark horse, a CBS Sports mock sends Houston's KINGSTON FLEMINGS to the Hawks, and league sources say Atlanta will happily field offers for No. 23. CAP CALENDAR: Hield's $9.66M full-guarantee trigger June 25 (10 days), Kuminga's $24.3M team-option call by June 29 (14 days, decline-and-extend the expected path per Fischer), McCollum-led free agency opens June 30 6 PM ET (15 days).",
  keyTopics: [
    {
      title: "Jaylen Brown Watch: Stein Says a Brown Deal Is 'Nearing Clarity' as the Giannis Dominoes Head Toward a Pre-Draft Resolution",
      detail:
        "Atlanta's hottest trade thread is now the closest thing the offseason has to live action. With the Giannis Antetokounmpo market expected to resolve before the June 23 draft and Boston reportedly willing to part with JAYLEN BROWN to land him, Marc Stein reports a Brown deal is 'nearing clarity' and names the Hawks, Rockets and Trail Blazers as the suitors circling if Brown comes available (The Stein Line / Yahoo Sports / SI onsi, Jun 12-14). Kevin O'Connor had the Celtics willing to move anyone but Jayson Tatum to acquire Giannis, and Evan Sidery's June 11 three-team framework routes Brown and Sam Hauser to Atlanta while Boston lands Giannis. The hurdles are real: Brown, who turns 30 in October, is owed three years and roughly $183M ($53-57M next season) after a career-best All-NBA campaign (28.7/6.9/5.1), the salary math forces Atlanta to package picks plus filler (the No. 8 pick, Hield, Kispert all surface in mocks), and POBO Onsi Saleh keeps insisting this roster is 'not one player away' and is 'not eager to splurge.' Nothing is imminent, but the Giannis call is expected before the Hawks are on the clock.",
      category: "trades",
    },
    {
      title: "Fresh Board Intel: Hawks 'Love' Wagler and Mikel Brown Jr. at No. 8; CBS Mock Sends Flemings to Atlanta",
      detail:
        "The clearest read on Atlanta's draft room, reaffirmed in Brett Siegel's reporting and a Last Word on Sports draft-targets piece Thursday June 12: the Hawks 'love' two point guards at No. 8, Illinois' KEATON WAGLER and Louisville's MIKEL BROWN JR. The catch: sources say the front office is ALSO high on 7'3 Michigan center ADAY MARA, the cleanest answer to the interior-size problem the Knicks series exposed, yet conversations with league personnel keep pointing to Atlanta favoring a guard to secure the backcourt long-term. Brown Jr.'s advanced playmaking, pace control and three-level scoring remain the most popular Atlanta fit in mocks; Wagler shot 44/39/79 with crafty creation that has him in the No. 5-9 range. CBS Sports' newest mock instead sends Houston's KINGSTON FLEMINGS (a confirmed Hawks workout visitor) to Atlanta at 8 to solve the lead-guard hole, then pairs 6'10 Houston big Chris Cenac Jr. with the Hawks at No. 23. NBA.com's post-combine consensus still most often slots Brown Jr. to Atlanta, with Mara the size-need dark horse a trade-down could also target if the guard run starts early (Last Word on Sports / CBS Sports / NBA.com / HoopsHQ, Jun 10-13). Draft Night is June 23, 8 days out.",
      category: "general",
    },
    {
