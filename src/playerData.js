...
export const ISSUE = {
  date: "2026-08-03",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 40,                                       // Issue number (offseason cadence)
  dateline: "ATLANTA · AUGUST 3, 2026",             // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 40 · AUGUST 2026 · ATL · USA",
  railLabel: "ISSUE 40 · AUG 3",
  ...
  coverImage: null,
  coverRibbon: "QUIET WEEKEND: LAKERS STILL THE KUMINGA FRONTRUNNER WITH CLEVELAND OUT, BUT THE VANDERBILT OPTION KEEPS BLOCKING A DEAL · PREVIEWS SPLIT: PERKINS RANKS ATLANTA 3RD IN THE EAST, BETMGM SETS 43.5 WINS · WATSON WEIGHS HIS QUALIFYING OFFER · 17 CONTRACTS, LIMIT 15 · NEXT GAME OCT 5 VS MEMPHIS",
  coverStatusKicker: "OFFSEASON · DAY 91",          // top-right corner of cover
  coverStatusLine: "KUMINGA-FOR-VANDERBILT STILL STUCK ON THE 2027-28 OPTION, LAKERS THE LONE MOTIVATED PARTNER · GUEYE STAYS OUT, CENTER NEED OPEN · PREVIEWS DISAGREE ON ATLANTA · 17 CONTRACTS, LIMIT 15 · NEXT: PRESEASON, OCT 5", // {DAYS:id} resolves from KEY_DATES
  backTagline: "Next issue: whether Atlanta and the Lakers close the Kuminga-for-Vanderbilt sign-and-trade or the Hawks hold out over the 2027-28 option, which two contracts go to get to 15, where Atlanta turns for center depth now that Koloko looks New Orleans-bound, and whether the Hawks have the picks left to meet Denver's number on Watson with the Nuggets in the second apron.",
};
