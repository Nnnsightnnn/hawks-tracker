...
export const NEXT_GAME = {
  ...
  broadcast: "ABC / ESPN",
  seriesContext: "SUNDAY JUNE 14: THE KNICKS ARE NBA CHAMPIONS. THE TEAM THAT ENDED ATLANTA'S SEASON WON IT ALL. New York closed out San Antonio 94-90 in Game 5 last night in San Antonio to take the Finals 4-1, its first title since 1973, with JALEN BRUNSON pouring in 45 (including 13 straight in the fourth) and taking Finals MVP. New York rallied from a double-digit hole in all four wins, down 16 on Saturday (ESPN / NBA.com / FOX Sports). The championship was completed through the same bracket that ran over the Hawks in the first round. HAWKS BEAT, 9 DAYS TO THE DRAFT: Brett Siegel's latest has Atlanta 'loving' PGs KEATON WAGLER and MIKEL BROWN JR. at No. 8 with 7'3 ADAY MARA the size dark horse, while CBS Sports' newest mock sends Houston's KINGSTON FLEMINGS to the Hawks at 8 and pairs Chris Cenac Jr. at No. 23. League sources say Atlanta will happily field offers for No. 23. Trade board, now hotter: with Bucks-Celtics Giannis talks escalating, Evan Sidery floated a three-team framework that would land Atlanta JAYLEN BROWN (and Sam Hauser) while Boston gets Giannis, and Marc Stein reports the Hawks have 'legitimate interest' in the Marietta native if Boston moves him, though Saleh holds this roster is 'not one player away.' KEY OFFSEASON DATES: Draft Night June 23 (9 days) · Hield $9.66M full-guarantee trigger June 25 (11 days) · Kuminga $24.3M team-option call by June 29 (15 days, decline-and-extend the expected path per Fischer) · McCollum UFA market opens June 30 6 PM ET (16 days) · Free agency moratorium July 6.",
};
...
export const NEWS_DIGEST = {
  generatedAt: "2026-06-14T09:16:00Z",
  summary:
    "OFFSEASON, Sunday June 14. THE KNICKS ARE NBA CHAMPIONS: the team that ended Atlanta's season in the first round won it all, closing out San Antonio 94-90 in Game 5 last night to take the Finals 4-1, New York's first title since 1973. Jalen Brunson scored 45 (13 straight in the fourth) and was named Finals MVP as the Knicks rallied from a double-digit deficit in all four wins, down 16 on Saturday night (ESPN / NBA.com / FOX Sports, Jun 13-14). The ring was completed through the same bracket that beat the Hawks in six, a pointed bookend to Atlanta's season. ON THE HAWKS BEAT (9 days to the draft): Brett Siegel's latest has Atlanta 'loving' two point guards at No. 8, Illinois's KEATON WAGLER and Louisville's MIKEL BROWN JR., with 7'3 ADAY MARA the size dark horse the front office is also high on, and a CBS Sports mock sends Houston's KINGSTON FLEMINGS to the Hawks at 8 to solve the lead-guard hole. League sources say Atlanta will happily field offers for No. 23, and Jake Fischer reports the Hawks are 'not eager to splurge,' keeping the focus on internal growth plus the McCollum re-sign (2yr/$35-43M the projected band) and the Kuminga call. The hottest trade thread is bigger now: with Bucks-Celtics Giannis talks escalating and Boston reportedly willing to move JAYLEN BROWN to land him, Evan Sidery floated a three-team framework (Jun 11) that would route Brown and Sam Hauser to Atlanta while Boston acquires Giannis, and Marc Stein reports the Hawks have legitimate interest in the Marietta, GA native if he comes available. Saleh still maintains this roster is 'not one player away.' CAP CALENDAR: Hield's $9.66M full-guarantee trigger June 25 (11 days), Kuminga's $24.3M team-option call by June 29 (15 days, decline-and-extend the expected path per Fischer), McCollum-led free agency opens June 30 6 PM ET (16 days).",
  keyTopics: [
    {
      title: "Knicks Win the 2026 NBA Title: Brunson 45 and Finals MVP as New York Closes Spurs 94-90 in Game 5",
      detail:
        "It is done: the New York Knicks are champions for the first time since 1973, closing out San Antonio 94-90 in Game 5 on Saturday night, June 13, in San Antonio to take the Finals 4-1. JALEN BRUNSON scored 45, including 13 straight in the fourth quarter, and was named Finals MVP after New York rallied from a double-digit hole in all four of its wins (down 16 on Saturday). The series capped a postseason in which the Knicks ran the gauntlet, and the Atlanta resonance is direct and pointed: the same Brunson-led team that eliminated the Hawks in six in the first round on Apr 30 finished the job all the way to the ring (ESPN / NBA.com / FOX Sports, Jun 13-14). With the season officially over leaguewide, Atlanta's calendar now belongs entirely to the draft (June 23) and the Hield, Kuminga and McCollum decisions that follow.",
      category: "games",
    },
    {
      title: "Fresh Board Intel: Hawks 'Love' Wagler and Mikel Brown Jr. at No. 8; CBS Mock Sends Flemings to Atlanta",
      detail:
        "The clearest read on Atlanta's draft room, reaffirmed in Brett Siegel's reporting and a Last Word on Sports draft-targets piece Thursday June 12: the Hawks 'love' two point guards at No. 8, Illinois' KEATON WAGLER and Louisville's MIKEL BROWN JR. The catch: sources say the front office is ALSO high on 7'3 Michigan center ADAY MARA, the cleanest answer to the interior-size problem the Knicks series exposed, yet conversations with league personnel keep pointing to Atlanta favoring a guard to secure the backcourt long-term. Brown Jr.'s advanced playmaking, pace control and three-level scoring remain the most popular Atlanta fit in mocks; Wagler shot 44/39/79 with crafty creation that has him in the No. 5-9 range. CBS Sports' newest mock instead sends Houston's KINGSTON FLEMINGS (a confirmed Hawks workout visitor) to Atlanta at 8 to solve the lead-guard hole, then pairs 6'10 Houston big Chris Cenac Jr. with the Hawks at No. 23. NBA.com's post-combine consensus still most often slots Brown Jr. to Atlanta, with Mara the size-need dark horse a trade-down could also target if the guard run starts early (Last Word on Sports / CBS Sports / NBA.com / HoopsHQ, Jun 10-13). Draft Night is June 23, 9 days out.",
      category: "general",
    },
    {
    ...
    },
    {
      ...
      detail:
        "Atlanta's biggest cap question stays Jonathan Kuminga, with a June 29 deadline on his $24.3M 2026-27 team option, 15 days out (Heavy / Soaring Down South / Yahoo Sports / Fadeaway World / ESPN, May 1-Jun 8). Jake Fischer reports mutual interest in declining the option to negotiate a longer multi-year deal at a lower first-year number — giving Kuminga security and the Hawks a more flexible cap hit, the path most analysts endorse since the 23-year-old is not extension-eligible. Soaring Down South notes the June 23 draft could let Atlanta buy time on the call. The alternatives are exercising the one-year option as a tradable expiring or declining and letting him walk. Kuminga averaged 14.9/5.1/2.2 across 16 Hawks regular-season games and 13.4 PPG in the Knicks series.",
      category: "trades",
    },
    {
      title: "Buddy Hield's $9.66M Decision: June 25 Full-Guarantee Trigger — Return Not Expected",
      detail:
        "Buddy Hield's $9,658,536 ($9.66M) 2026-27 contract becomes fully guaranteed on June 25 — only $3M is currently protected, so Atlanta could save roughly $6M by waiving him before the date (SI onsi cap tracker / Hoops Rumors / SportsTalk ATL, Apr 28-May 29). The trigger is 11 days out. Atlanta can let the full number trigger and keep it as a movable expiring, waive him before the date to save the difference, or include him in a pre-trigger trade. Reporting suggests Hield is not expected back given how little he played after arriving in the Porzingis deal — 71 games, 12 starts at 11.8/2.8/2.1 on 39.8% from three, then just 6 mpg in two first-round games.",
      category: "trades",
    },
    {
      title: "Jaylen Brown Watch Escalates: Giannis-to-Boston Talks Heat Up, Sidery's Three-Team Framework Routes Brown to Atlanta",
      detail:
        "Atlanta's hottest trade thread got bigger this week as the Giannis Antetokounmpo market accelerated. Reporting now has the Bucks expected to move Antetokounmpo before the June 23 draft, with Boston and Miami the two likeliest landing spots, and Kevin O'Connor reporting the Celtics would 'without a doubt' trade JAYLEN BROWN to land Giannis, open to moving anyone but Jayson Tatum (Yahoo Sports / NBC Sports / NESN / Heavy, Jun 10-12). That is where the Hawks enter: on June 11, Evan Sidery floated a three-team framework in which Boston acquires Giannis and Myles Turner while Atlanta lands Brown and Sam Hauser, and Marc Stein has reported the Hawks hold legitimate interest in the Marietta, GA native if he comes available. Hurdles remain real: Brown is owed roughly $53-57M next season after a career-best All-NBA year (28.7/6.9/5.1), Houston and Portland are competing suitors, and POBO Onsi Saleh maintains this roster is 'not one player away' and is not eager to splurge. Nothing is imminent, but a decision on the Giannis dominoes is expected before the June 23 draft.",
      category: "trades",
    },
    {
