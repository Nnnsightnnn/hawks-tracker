...
export const NEWS_DIGEST = {
  ...
  keyTopics: [
    ...
    {
      title: "Denver Blinks on Watson: Asking Price Drops to One First and a High-Level Player, and Watson Weighs His Qualifying Offer",
      detail:
        "The wing Atlanta has chased all July got materially cheaper Tuesday. Shams Charania reports the Nuggets have lowered their sign-and-trade asking price for restricted free agent Peyton Watson from a Walker-Kessler-sized haul down to 'just one first-round pick and a high-level player,' a real softening from the multiple firsts and swaps Denver was demanding a week ago (Shams Charania / The Athletic / Hoops Rumors, Jul 28). Two complications persist. First, Denver still says it will match any offer sheet Watson signs, so the sign-and-trade is the only clean path for a rival to land him. Second, Watson himself is now reportedly weighing whether to take his one-year qualifying offer, bet on himself, and reach unrestricted free agency in 2027, which would take a trade off the table entirely. Watson, 23, is seeking $25M to $30M annually, and Atlanta remains in the mix alongside Milwaukee and the Clippers. The Hawks' problem is unchanged even at the lower price: after sending three seconds to Oklahoma City on Jul 19, the draft capital Denver wants is the same capital the front office has been spending. Interest is real, a deal is not close.",
      category: "trades",
    },
    {
...
export const ISSUE = {
  date: "2026-07-27",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 35,                                       // Issue number (offseason cadence)
  dateline: "ATLANTA · JULY 27, 2026",              // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 35 · JULY 2026 · ATL · USA",
  railLabel: "ISSUE 35 · JULY 27",
  ...
  coverImage: null,
  coverRibbon: "CAVS SIGN HEZONJA, LAKERS BACK AS CLEAR KUMINGA FRONTRUNNER · VANDERBILT SIGN-AND-TRADE THE HOLDUP · JALEN WILSON ADDED ON A TWO-WAY · 17 CONTRACTS, LIMIT 15 · NEXT GAME OCT 5 VS MEMPHIS",
  coverStatusKicker: "OFFSEASON · DAY 84",          // top-right corner of cover
  coverStatusLine: "HEZONJA TO CLEVELAND FLIPS THE KUMINGA MARKET BACK TO LOS ANGELES · VANDERBILT'S 2027-28 OPTION THE STICKING POINT · 17 CONTRACTS, LIMIT 15 · NEXT: PRESEASON, OCT 5", // {DAYS:id} resolves from KEY_DATES
  backTagline: "Next issue: whether Atlanta and the Lakers close the Kuminga-for-Vanderbilt sign-and-trade or the Hawks hold out over the 2027-28 option, which two contracts go to get to 15, and whether Atlanta has the picks left to meet Denver's number on Watson.",
};
