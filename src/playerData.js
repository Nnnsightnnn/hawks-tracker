...
export const NEXT_GAME = {
  ...
  broadcast: "ABC / ESPN",
  seriesContext: "FRIDAY JUNE 19, 4 DAYS TO THE DRAFT. THE LIVE THREAD IS THE GIANNIS MARKET AND ATLANTA'S PLACE IN IT, and Friday's read re-tilted the momentum toward a deal: Kevin O'Connor (Yahoo Sports) reports the Giannis trade 'could happen on or before' the June 23 draft, with MIAMI back out front as the frontrunner and Bill Simmons saying BOSTON 'made an offer in the past week' to claim a clear No. 2 (Yahoo / NBC Sports / The Ringer, Jun 18-19). Portland's interest has cooled (Blazers reportedly unlikely to offer a big package) and the Nets, who almost landed Giannis last season, were scared off by the logistics. Atlanta's stake holds: if Boston wins the race it would likely move JAYLEN BROWN (plus picks and a role player or two such as Hauser or Pritchard), and Marc Stein lists the Hawks, Rockets and Trail Blazers as Brown suitors. The hurdle is Brown's three years and roughly $183M, and POBO Onsi Saleh holds this roster is 'not one player away.' CAP CALENDAR: the Hawks 'hope to re-sign CJ McCollum' near $20M per year, and Atlanta is weighing Jonathan Kuminga's $24.3M option, with Hawks and Kuminga reportedly both open to a longer multi-year deal at a lower first-year number. THE BACKDROP: the New York Knicks are NBA champions, the team that ended Atlanta's season, closing San Antonio 94-90 in Game 5 to take the Finals 4-1, JALEN BRUNSON 45 and Finals MVP. DRAFT BOARD: mocks split between Louisville PG MIKEL BROWN JR. and Houston PG KINGSTON FLEMINGS at No. 8, with 7'3 ADAY MARA the size-need answer if Atlanta trades down; league sources say the Hawks will happily field offers for No. 23. KEY OFFSEASON DATES: Draft Night June 23 (4 days) · Hield $9.66M full-guarantee trigger June 25 (6 days) · Kuminga $24.3M team-option call by June 29 (10 days) · McCollum UFA market opens June 30 6 PM ET (11 days) · Free agency moratorium July 6.",
};
...
export const NEWS_DIGEST = {
  ...
  summary:
    "OFFSEASON, Friday June 19, four days to the draft. THE LIVE THREAD is still the Giannis Antetokounmpo market, and Friday's read re-tilted the momentum back toward a deal landing soon. Kevin O'Connor of Yahoo Sports reports the trade 'could happen on or before' the June 23 draft, with MIAMI restored as the frontrunner and Bill Simmons saying BOSTON 'made an offer in the past week' that pushed the Celtics into a clear No. 2 (Yahoo Sports / NBC Sports / The Ringer, Jun 18-19). Two suitors faded: Portland is reportedly unlikely to put forward a big package, and the Nets, who nearly landed Giannis a year ago, were scared off by the logistics. The Bucks still want final offers from the likes of Boston, Minnesota and Orlando before committing, and co-owner Jimmy Haslam has said he wants resolution before the draft. The Hawks' stake is unchanged: if BOSTON wins the race, a Celtics package would likely be built around JAYLEN BROWN plus picks and a role player or two (Sam Hauser or Payton Pritchard), and Marc Stein still lists the Hawks, Rockets and Trail Blazers as Brown's suitors. Atlanta's hook is its asset base plus the hometown angle, since Brown grew up in the Atlanta area; the hurdle is his three years and roughly $183M, and POBO ONSI SALEH still insists this roster is 'not one player away.' CAP CALENDAR: the Hawks 'hope to re-sign CJ McCollum,' projecting him near $20M per year (HoopsHype), and reporting now points to mutual interest between Atlanta and Jonathan Kuminga in a longer multi-year deal at a lower first-year number rather than a straight pickup of his $24.3M option. ON THE BOARD: mocks split between Louisville PG MIKEL BROWN JR. and Houston PG KINGSTON FLEMINGS at No. 8, with 7'3 ADAY MARA the size-need answer if Atlanta trades down; the front office will field offers for No. 23. THE BACKDROP: the New York Knicks are NBA champions (Brunson 45, Finals MVP, closed San Antonio 4-1), the same team that bounced the Hawks in Round 1. KEY DATES: Hield June 25 (6 days), Kuminga June 29 (10 days), McCollum-led free agency June 30 6 PM ET (11 days).",
  keyTopics: [
    {
      title: "Jaylen Brown Watch: Giannis Momentum Re-Tilts Toward a Deal 'On or Before' the Draft, Miami Back Out Front, Boston the Brown Trigger",
      detail:
        "Atlanta's hottest trade thread is the closest thing the offseason has to live action, and Friday's read re-tilted the momentum back toward a near-term resolution. Kevin O'Connor of Yahoo Sports reports the Giannis trade 'could happen on or before' the June 23 draft, and league belief is hardening that the call lands before the Hawks are on the clock, even as the Bucks keep canvassing final offers from Boston, Minnesota and Orlando (Yahoo Sports / NBC Sports / Heavy, Jun 18-19). MIAMI is restored as the frontrunner, its package built around Tyler Herro, young big Kel'el Ware and wing Jaime Jaquez Jr. with the No. 13 pick attached, and Giannis is reported to still prefer the Heat. Two suitors faded this week: Portland is unlikely to put forward a big package, and the Nets, who nearly had a framework a year ago, were scared off by the logistics. Atlanta's stake is the Boston lane: Bill Simmons says the Celtics 'made an offer in the past week' that pushed them into a clear No. 2, and a Boston package for Giannis would likely require JAYLEN BROWN plus draft capital and a role player or two (Sam Hauser or Payton Pritchard), which is the domino that frees Brown. Marc Stein lists the Hawks, Rockets and Trail Blazers as Brown's suitors. The Atlanta case is real: the Hawks hold a deep asset base and two firsts this year (Nos. 8 and 23), and Brown grew up in the Atlanta area, so a homecoming as the No. 1 option fits sentimentally and on the floor. The hurdles are just as real: Brown, who turns 30 in October, is owed three years and roughly $183M, the salary math forces Atlanta to package picks plus filler, and POBO Onsi Saleh keeps insisting this roster is 'not one player away.' Nothing is signed.",
      category: "trades",
    },
    {
      title: "Board Swing: Fresh CBS Sports Mock Sends Mikel Brown Jr. Back to Atlanta at No. 8 as the Guard Run Stays Fluid",
      detail:
        "The pre-draft board keeps moving on Atlanta's most-mocked target. A new CBS Sports mock (Jun 16) projects Louisville PG MIKEL BROWN JR. to the Hawks at No. 8, a reversal from this week's ClutchPoints Big Board 4.0 read that called Brown Jr. a 'long shot' to last that long, underscoring how fluid the guard run at 5-7 is four days out. ESPN's Jeremy Woo adds that the Hawks 'have done work on all the guards in this range' and lists 7'3 Michigan center ADAY MARA as a live option, the cleanest answer to the interior-size problem the Knicks series exposed. The squeeze from above is unchanged: Bleacher Report reports the Sacramento Kings, one spot ahead at No. 7, view Arkansas guard DARIUS ACUFF JR. as their draft 'floor,' so one of the guards Atlanta covets could be gone before the Hawks pick, with Houston lead guard KINGSTON FLEMINGS and Illinois' KEATON WAGLER also in the range. HoopsHype's Michael Scotto reports rival execs still expect Atlanta to land either a point guard or Mara, and league sources say the front office is open to moving up or down and will happily field offers for No. 23. The Hawks hold Nos. 8, 23 and 57; the draft runs June 23-24 at Barclays Center, 4 days out.",
      category: "general",
    },
    {
    ...
    {
      title: "Kuminga's $24.3M Team Option: Reporting Now Points to a Mutual Long-Term Deal Over a Straight Pickup; June 29 Deadline, 10 Days Out",
      detail:
        "Atlanta's biggest cap question stays Jonathan Kuminga, and the Friday read leans toward a negotiated outcome rather than a simple yes or no. ClutchPoints and HoopsHype report that the Hawks and Kuminga are BOTH interested in working out a new long-term deal this summer, the path Jake Fischer has favored: decline the $24.3M 2026-27 team option, then re-sign him to a multi-year contract at a lower first-year number (Kuminga is not extension-eligible). John Hollinger of The Athletic still predicts Atlanta declines the option outright, valuing the 23-year-old near $9.4M in the BORD$ model, well short of $24.3M. The team-option deadline is June 29, 10 days out. Atlanta has also done its due diligence and gauged Kuminga's value on the trade market ahead of the draft, but the prevailing read is that he returns. The alternatives remain exercising the one-year option as a tradable expiring or letting him walk for nothing. Kuminga averaged 14.9/5.1/2.2 across 16 Hawks regular-season games and 13.4 PPG in the Knicks series.",
      category: "trades",
    },
    {
      title: "Buddy Hield's $9.66M Decision: June 25 Full-Guarantee Trigger — Return Not Expected",
      detail:
        "Buddy Hield's $9,658,536 ($9.66M) 2026-27 contract becomes fully guaranteed on June 25, only $3M is currently protected, so Atlanta could save roughly $6M by waiving him before the date (SI onsi cap tracker / Hoops Rumors / SportsTalk ATL, Apr 28-May 29). The trigger is 6 days out. Atlanta can let the full number trigger and keep it as a movable expiring, waive him before the date to save the difference, or include him in a pre-trigger trade. Reporting suggests Hield is not expected back given how little he played after arriving in the Porzingis deal — 71 games, 12 starts at 11.8/2.8/2.1 on 39.8% from three, then just 6 mpg in two first-round games.",
      category: "trades",
    },
    {
...
export const ISSUE = {
  date: "2026-06-19",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
