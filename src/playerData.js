...
export const NEWS_DIGEST = {
  generatedAt: "2026-07-26T13:10:00Z",
  summary:
    "THE DOMINO THAT HAD FROZEN THE KUMINGA MARKET FINALLY FELL: LEBRON JAMES IS A 76ER. Late Thursday, James agreed to a two-year, roughly $8M deal with a player option in Philadelphia (Shams Charania, Jul 24), spurning the Cavaliers, who had been the perceived favorite and had held much of the league's business in a holding pattern while they waited on his call. The direct Atlanta consequence: Cleveland, now shut out on James, becomes the most motivated suitor for JONATHAN KUMINGA, and because the Cavaliers can only acquire him through a sign-and-trade, the Hawks hold real leverage. Jake Fischer and Marc Stein report Kuminga would need Atlanta's help on a sign-and-trade to approach last season's $22.5M, and that Onsi Saleh's front office is likely to be choosy about the shapes it accepts. The name to watch coming back is MAX STRUS, an expiring contract and, when healthy, an elite shooter, in a framework where Atlanta sends out Kuminga plus multiple smaller contracts to add a rotation piece rather than dead salary (though Devin Carter cannot be traded until Aug 30 and Ryan Nembhard until Sept 19, which constrains the shapes). The Lakers, the other suitor, now look out: reporting Friday and into the weekend (Heavy, Jul 24-25) has Los Angeles no longer expecting to acquire Kuminga via sign-and-trade at all, having agreed with Matisse Thybulle as a hedge and never closing the gap between its roughly $10M offer and the near-$25M Kuminga's camp has sought. That leaves Cleveland as the only live sign-and-trade path and hands Atlanta more leverage over the shape of any deal. Absent a sign-and-trade, Kuminga's open-market number falls far below his ask, and a short-term Atlanta return stays on the table if the market stays cold. THE SECONDARY WING TARGET is unchanged: PEYTON WATSON, on whom Denver has set a Walker-Kessler-sized ask (unprotected 2031 and 2033 firsts plus 2028 and 2030 swaps) while planning to match any offer sheet anyway; Watson wants $25M to $30M, and Milwaukee and the Clippers are also in. THE ARITHMETIC UNDERNEATH IT ALL is unchanged and getting louder: 17 contracts against a 15-man limit, $196.2M committed, roughly $4M of room under the luxury tax, and BUDDY HIELD's fully guaranteed $9.66M expiring deal still the likeliest thing to move. ELSEWHERE: KINGSTON FLEMINGS landed ninth in ESPN's post-Summer League rookie rankings, and MOUHAMED GUEYE remains three to four months from re-evaluation after left-foot surgery. PRIOR EDITION: THE FIRST NO. 1 PICK ATLANTA EVER DRAFTED IS GONE, AND AN ALL-DEFENSIVE WING IS HERE. The Hawks acquired LUGUENTZ DORT and RYAN NEMBHARD from Oklahoma City on Sunday in a three-team trade that sent ZACCHARIE RISACHER to Dallas and three second-round picks to the Thunder (Chicago's 2027 via Dallas, plus Atlanta's most favorable 2031 and 2032). Onsi Saleh swapped a 21-year-old former No. 1 pick who had fallen out of the playoff rotation for a 27-year-old champion and All-Defensive First Team wing on an expiring $17.7M deal, giving Quin Snyder a perimeter of Dort, DYSON DANIELS and NICKEIL ALEXANDER-WALKER that may be the most disruptive in the league. The cost is offense: Dort shot 38.5% from the field and 34.4% from three last season, both career lows, and most projections have him coming off the bench with heavy minutes rather than starting. Atlanta is now at 17 standard contracts against a 15-man limit, which means two more moves are coming. What Atlanta gains in exchange is flexibility: more than $50M in expiring salary between Dort, CJ McCOLLUM and JOCK LANDALE to trade with in-season, about $4M of room under the tax now, and north of $40M in cap space next summer. From here the calendar is empty until the Oct 5 preseason opener against Memphis at State Farm Arena, with the front office's summer math unfinished on three fronts: trimming to 15, resolving Kuminga one way or the other, and deciding whether to keep pressing on TREY MURPHY III or pivot to the center board.",
  keyTopics: [
    {
      title: "LeBron Picks the 76ers, and the Decision That Froze the Kuminga Market Is Finally Out",
      detail:
        "The single biggest offseason domino fell late Thursday: LeBron James agreed to a two-year, roughly $8M deal with a player option in Philadelphia (Shams Charania, Jul 24), leaving the Cavaliers, who had been the perceived favorite and whose pursuit had held much of the league's business in a holding pattern. For Atlanta the fallout is direct. Cleveland, now shut out on James, becomes the most motivated remaining suitor for Jonathan Kuminga, and because the Cavaliers can only add him through a sign-and-trade, the Hawks hold real leverage: Atlanta does not have to agree to any framework unless it benefits them. Jake Fischer and Marc Stein reported that Kuminga would need Atlanta's help on a sign-and-trade to come near last season's $22.5M and that Onsi Saleh's front office is likely to be choosy about the shapes it accepts (Marc Stein / Jake Fischer via SI onsi, Jul 24). The cleanest return floated is Max Strus, an expiring deal and an elite shooter when healthy, with Atlanta sending out Kuminga plus multiple smaller contracts. The mechanics are tricky: Devin Carter cannot be traded until Aug 30 and Ryan Nembhard until Sept 19, so the shapes are limited before camp. Cleveland currently sits at 12 players plus a likely James Harden re-signing, which leaves it two open roster spots. If the Cavs pass, Kuminga could still return to Atlanta.",
      category: "trades",
    },
    {
      title: "Lakers Now Reported Out on a Kuminga Sign-and-Trade, Leaving Cleveland the Only Live Path",
      detail:
        "The Lakers, the other suitor Atlanta spent July talking to, now look out of the Kuminga chase entirely: reporting Friday and into the weekend has Los Angeles no longer expecting to acquire him via sign-and-trade (Heavy / Yahoo Sports / NBC Sports, Jul 24-25). LA agreed with defensive wing Matisse Thybulle as a hedge that lowered its urgency, improved its Kuminga offer to roughly $10M annually but never approached the near-$25M his camp targeted, and was unwilling to attach the draft capital Atlanta wanted. Sunday's Dort trade is the backdrop: at 17 standard contracts Atlanta no longer wants LA's back-end money, the mechanism by which the Lakers planned to pay Kuminga. With the Lakers stepping back, Cleveland, shut out on LeBron James, becomes the lone motivated sign-and-trade partner, which tilts leverage further toward the Hawks. Atlanta's own route to retaining him outright still sits near the mid-level, roughly $6M against his $25M ask, after the front office declined his $24.3M option Jun 29 and kept only Non-Bird rights. Milwaukee and the Clippers were also listed earlier in July. Two months of Atlanta's summer have produced no resolution on its most valuable expiring asset, but LeBron's decision and the Lakers' exit should force the pace.",
      category: "trades",
    },
    {
      title: "Denver Names Its Watson Price: The Walker Kessler Package, and a Plan to Match Anyway",
      detail:
        "The other wing Atlanta has chased all July now has a number attached. Reporting this week has the Nuggets seeking compensation comparable to what Utah received in the Walker Kessler sign-and-trade with the Lakers, unprotected first-round picks in 2031 and 2033 plus swaps in 2028 and 2030, while Denver simultaneously plans to match any offer sheet Peyton Watson signs as a restricted free agent (Yahoo Sports / SI onsi / Heavy / Pro Football Network, Jul 17-20). Watson is reportedly seeking $25M to $30M annually, and Milwaukee joined the Clippers and Hawks among teams working the sign-and-trade angle. Atlanta's problem is the same one the Kuminga talks exposed: after sending three seconds to Oklahoma City on Sunday, the picks it would need to clear Denver's ask are the picks it has been spending. Interest is real, a deal is not close.",
      category: "trades",
    },
    {
...
export const ISSUE = {
  date: "2026-07-25",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 34,                                       // Issue number (offseason cadence)
  dateline: "ATLANTA · JULY 25, 2026",              // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 34 · JULY 2026 · ATL · USA",
  railLabel: "ISSUE 34 · JULY 25",
  ...
  coverImage: null,
  coverRibbon: "LEBRON PICKS THE 76ERS, UNFREEZING THE KUMINGA MARKET · CAVS PIVOT MAKES ATLANTA A SIGN-AND-TRADE PARTNER, STRUS THE LIKELY RETURN · LAKERS' PURSUIT COOLS · 17 CONTRACTS, $196.2M, $4M UNDER THE TAX · NEXT GAME OCT 5 VS MEMPHIS",
  coverStatusKicker: "OFFSEASON · DAY 82",          // top-right corner of cover
  coverStatusLine: "LEBRON TO PHILADELPHIA UNFREEZES THE KUMINGA MARKET · CAVS NOW A LIVE S&T PARTNER, STRUS THE RETURN · 17 CONTRACTS, LIMIT 15 · NEXT: PRESEASON, OCT 5", // {DAYS:id} resolves from KEY_DATES
  backTagline: "Next issue: whether Cleveland and Atlanta build a Kuminga-for-Strus sign-and-trade now that LeBron is off the board, which two contracts go to get to 15, and whether Atlanta has the picks left to meet Denver's number on Watson.",
};
