...
export const NEXT_GAME = {
  ...
  broadcast: "—",
  seriesContext: "FRIDAY JUNE 26. THE HIELD GATE MOVED, NOT CLOSED: rather than waive Buddy Hield before his $9.66M salary fully guaranteed, Atlanta and Hield AGREED TO PUSH BACK THE GUARANTEE DEADLINE so both sides have more time to flush out options, Chris Haynes reported Thursday Jun 25. Only $3M is fully guaranteed; the Hawks can still keep him as a movable expiring or waive him later, but the immediate roster-spot save is on hold. THE ROOKIES ARRIVED: Kingston Flemings (No. 8), Zuby Ejiofor (No. 23) and Henri Veesaar (No. 52) were introduced in Atlanta Thursday at their first press conference, GM Onsi Saleh alongside (AJC / SI / 247Sports, Jun 25). DRAFT CLASS IN THE BOOKS: Atlanta traded up from No. 57 to No. 52 in Round 2 to grab UNC stretch-five Veesaar (17.0 PPG, 8.7 RPG, 43% 3P as a senior; scouts flag thin strength and 61.5% FT). NEXT GATES: Jonathan Kuminga's $24.3M team option must be called by June 29 (decline-and-re-sign the reported lean, 3 days out), the FA market opens June 30 at 6 PM ET (4 days out), and the moratorium ends July 6. ATLANTA'S DONE WORK still stands: wing AARON WIGGINS from OKC for two seconds, CJ McCOLLUM re-signed (1yr, ~$21M, 7.5% trade kicker), and Quin Snyder extended Jun 8.",
};
...
export const NEWS_DIGEST = {
  generatedAt: "2026-06-26T08:20:00Z",
  summary:
    "OFFSEASON, Friday June 26. The Buddy Hield gate moved instead of closing: rather than waive him before his $9.66M salary fully guaranteed Thursday, Atlanta and Hield AGREED TO PUSH BACK THE GUARANTEE DEADLINE so both sides have more time to flush out options, Chris Haynes reported June 25. Only $3M is fully guaranteed, so the Hawks keep their flexibility (movable expiring now, waive-and-save later) but the immediate roughly $6M and roster-spot save is on hold. Atlanta also welcomed its draft class: Kingston Flemings (No. 8), Zuby Ejiofor (No. 23) and Henri Veesaar (No. 52) were introduced at their first Hawks press conference Thursday alongside GM Onsi Saleh. The draft is fully in the books after the Round 2 trade-up from No. 57 to No. 52 for UNC stretch-five Veesaar (17.0 points, 8.7 rebounds, 43% from three as a senior, with thin strength and 61.5% free-throw shooting as the questions). THE NEXT GATES line up fast: Jonathan Kuminga's $24.3M team option must be called by June 29 with a decline-and-re-sign the reported lean (3 days out), the FA market opens June 30 at 6 PM ET (4 days out), and the moratorium ends July 6. Atlanta's done work holds: AARON WIGGINS acquired from OKC for two seconds, CJ McCOLLUM re-signed at one year and roughly $21M, and Quin Snyder extended on June 8.",
  keyTopics: [
    {
      title: "FRESH: Hawks and Buddy Hield Push Back His Guarantee Deadline, Keeping Options Open Instead of Waiving Him",
      detail:
    ...
    {
      title: "FRESH: Hawks Introduce 2026 Draft Class, Flemings, Ejiofor and Veesaar Meet the Media in Atlanta",
      detail:
