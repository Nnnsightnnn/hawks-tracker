...
export const ISSUE = {
  date: "2026-06-08",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 9,                                        // Issue number (offseason cadence)
  dateline: "ATLANTA · JUNE 8, 2026",               // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 09 · JUNE 2026 · ATL · USA",
  railLabel: "ISSUE 09 · JUNE 8",
  coverStarId: 1,                                   // PLAYERS[id] for the cover portrait
  coverRibbon: "EXCLUSIVE · COVER STAR · JALEN JOHNSON",
  coverStatusKicker: "OFFSEASON · DAY 38",          // top-right corner of cover
