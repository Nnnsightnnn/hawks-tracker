...
export const ISSUE = {
  date: "2026-08-10",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
