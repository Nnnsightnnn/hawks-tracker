...
export const ISSUE = {
  date: "2026-08-04",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 41,                                       // Issue number (offseason cadence)
  dateline: "ATLANTA · AUGUST 4, 2026",             // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 41 · AUGUST 2026 · ATL · USA",
  railLabel: "ISSUE 41 · AUG 4",
  ...
  coverImage: null,
  coverRibbon: "MINNESOTA JOINS THE KUMINGA CHASE AFTER MISSING ON LEBRON, BUT EVERY PATH STILL RUNS THROUGH ATLANTA AND STILL STALLS ON THE VANDERBILT OPTION · LAKERS FRONTRUNNER NEAR $45M/2YR · HAWKS MAKE JARRETT ALLEN INTEREST KNOWN, CAVS NOT ENTERTAINING · 17 CONTRACTS, LIMIT 15 · NEXT GAME OCT 5 VS MEMPHIS",
  coverStatusKicker: "OFFSEASON · DAY 92",          // top-right corner of cover
  coverStatusLine: "KUMINGA MARKET WIDENS: WOLVES JOIN LAKERS AS SUITORS, VANDERBILT OPTION STILL THE BLOCK · HAWKS EYE JARRETT ALLEN, CLEVELAND WON'T MOVE HIM · GUEYE OUT, CENTER NEED OPEN · 17 CONTRACTS, LIMIT 15 · NEXT: PRESEASON, OCT 5", // {DAYS:id} resolves from KEY_DATES
  backTagline: "Next issue: whether the widening Kuminga market forces Atlanta to move or hold out over the 2027-28 Vanderbilt option, whether the Jarrett Allen interest turns into a real center pursuit or stays due diligence, which two contracts go to get to 15, and whether the Hawks have the picks left to meet Denver's number on Watson with the Nuggets in the second apron.",
};
