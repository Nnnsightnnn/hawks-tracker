...
export const NEXT_GAME = {
  ...
  broadcast: "ABC / ESPN",
  seriesContext: "WEDNESDAY JUNE 17, 6 DAYS TO THE DRAFT. THE LIVE THREAD IS THE GIANNIS MARKET AND ATLANTA'S PLACE IN IT: the Bucks are expected to resolve Giannis Antetokounmpo before the June 23 draft, and the field has tightened to a two-team race between MIAMI (still the frontrunner) and BOSTON, which insiders now call a legitimate threat after a late push, with the Celtics reported 'open to trading anybody' but Jayson Tatum (NBC Sports / NBC Sports Boston / Yahoo Sports, Jun 16). That escalation is exactly what lifts Atlanta's stake: if Boston wins the race, JAYLEN BROWN almost certainly moves, and Marc Stein reports a Brown deal is 'nearing clarity' with the Hawks, Rockets and Trail Blazers circling as the third team that could facilitate. The hurdle is Brown's three years and roughly $183M, and POBO Onsi Saleh holds this roster is 'not one player away.' THE BACKDROP: the New York Knicks are NBA champions, the team that ended Atlanta's season, closing San Antonio 94-90 in Game 5 to take the Finals 4-1, New York's first title since 1973, JALEN BRUNSON 45 and Finals MVP (ESPN / NBA.com / FOX Sports). DRAFT BOARD: a fresh CBS Sports mock now sends Louisville PG MIKEL BROWN JR. back to Atlanta at No. 8, while ESPN's Jeremy Woo lists 7'3 ADAY MARA as an option and Brett Siegel keeps Atlanta 'loving' PGs KEATON WAGLER and Brown Jr.; league sources say the Hawks will happily field offers for No. 23. KEY OFFSEASON DATES: Draft Night June 23 (6 days) · Hield $9.66M full-guarantee trigger June 25 (8 days) · Kuminga $24.3M team-option call by June 29 (12 days, decline-and-extend the expected path per Fischer) · McCollum UFA market opens June 30 6 PM ET (13 days) · Free agency moratorium July 6.",
};
...
export const NEWS_DIGEST = {
  ...
  summary:
    "OFFSEASON, Wednesday June 17, six days to the draft. THE LIVE THREAD is the Giannis Antetokounmpo market, and overnight it tightened into a genuine two-team race. Reporting now frames it as Miami (still the frontrunner, with a package built around Tyler Herro, Kel'el Ware, Jaime Jaquez Jr., the No. 13 pick and two future firsts) versus a fast-rising Boston, which insiders call a legitimate threat after a late push; NBC Sports Boston reports the Celtics are 'in on' Giannis and 'open to trading anybody' but Jayson Tatum, and a deal is increasingly expected to land before the June 23 draft (NBC Sports / NBC Sports Boston / Yahoo Sports, Jun 16). That escalation is exactly what raises Atlanta's stake: if BOSTON wins the race, JAYLEN BROWN almost certainly moves, and Marc Stein reports a Brown deal is 'nearing clarity' with the Hawks, Rockets and Trail Blazers circling as the third team that could facilitate. Atlanta's hook is its asset base (it owns Milwaukee's unprotected 2027 first) plus the hometown angle, since Brown grew up in the Atlanta area; the hurdle is his three years and roughly $183M, and POBO ONSI SALEH still insists this roster is 'not one player away.' THE BACKDROP: the New York Knicks are NBA champions, the team that bounced the Hawks in the first round, closing San Antonio 94-90 in Game 5 to take the Finals 4-1, New York's first ring since 1973, Jalen Brunson 45 and Finals MVP. ON THE DRAFT BOARD: a fresh CBS Sports mock swings Louisville PG MIKEL BROWN JR. back to Atlanta at No. 8, while ESPN's Jeremy Woo lists 7'3 ADAY MARA as a live option and notes the Hawks have done work on every guard in the range; league sources say Atlanta will happily field offers for No. 23. CAP CALENDAR: Hield's $9.66M full-guarantee trigger June 25 (8 days), Kuminga's $24.3M team-option call by June 29 (12 days, decline-and-extend the expected path per Fischer), McCollum-led free agency opens June 30 6 PM ET (13 days).",
  keyTopics: [
    {
      title: "Jaylen Brown Watch: Giannis Market Narrows to a Miami-Boston Two-Team Race; Brown the Hawks' Path In",
      detail:
        "Atlanta's hottest trade thread is the closest thing the offseason has to live action, and it tightened overnight into a genuine two-team race. The Giannis Antetokounmpo market is now widely expected to resolve before the June 23 draft, with the field narrowed to MIAMI (still the frontrunner, Giannis reportedly wants the Heat, whose package centers on Tyler Herro, Kel'el Ware, Jaime Jaquez Jr., the No. 13 pick and two future firsts) and a fast-rising BOSTON, which insiders now call a legitimate threat. NBC Sports Boston reports the Celtics are 'in on' Giannis and 'open to trading anybody' on the roster but Jayson Tatum, and Yahoo Sports and NBC Sports both note an increasing belief leaguewide that the trade falls before the Hawks are on the clock (NBC Sports / NBC Sports Boston / Yahoo Sports, Jun 16). Atlanta's stake is the Boston lane: if the Celtics win the race, JAYLEN BROWN almost certainly moves, and Marc Stein reports a Brown deal is 'nearing clarity' with the Hawks, Rockets and Trail Blazers circling as the third team that could facilitate (The Stein Line / Yahoo Sports / SI onsi, Jun 12-16). The Atlanta case is real: SportsTalk ATL notes the Hawks own Milwaukee's unprotected 2027 first plus young filler, and Brown grew up in the Atlanta area, so a homecoming as the No. 1 option fits sentimentally and on the floor. The hurdles are just as real: Brown, who turns 30 in October, is owed three years and roughly $183M ($53-57M next season) after a career-best All-NBA campaign (28.7/6.9/5.1), the salary math forces Atlanta to package picks plus filler (the No. 8 pick, Hield, Kispert all surface in mocks), and POBO Onsi Saleh keeps insisting this roster is 'not one player away.' Nothing is signed, but the Giannis call is expected within days.",
      category: "trades",
    },
    {
      title: "Board Swing: Fresh CBS Sports Mock Sends Mikel Brown Jr. Back to Atlanta at No. 8 as the Guard Run Stays Fluid",
      detail:
        "The pre-draft board keeps moving on Atlanta's most-mocked target. A new CBS Sports mock (Jun 16) projects Louisville PG MIKEL BROWN JR. to the Hawks at No. 8, a reversal from this week's ClutchPoints Big Board 4.0 read that called Brown Jr. a 'long shot' to last that long, underscoring how fluid the guard run at 5-7 is six days out. ESPN's Jeremy Woo adds that the Hawks 'have done work on all the guards in this range' and lists 7'3 Michigan center ADAY MARA as a live option, the cleanest answer to the interior-size problem the Knicks series exposed. The squeeze from above is unchanged: Bleacher Report reports the Sacramento Kings, one spot ahead at No. 7, view Arkansas guard DARIUS ACUFF JR. as their draft 'floor,' so one of the guards Atlanta covets could be gone before the Hawks pick, with Houston lead guard KINGSTON FLEMINGS and Illinois' KEATON WAGLER also in the range. HoopsHype's Michael Scotto reports rival execs still expect Atlanta to land either a point guard or Mara, and league sources say the front office is open to moving up or down and will happily field offers for No. 23. The Hawks hold Nos. 8, 23 and 57; the draft runs June 23-24 at Barclays Center, 6 days out.",
      category: "general",
    },
    {
