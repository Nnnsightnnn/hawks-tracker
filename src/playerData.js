...
export const PLAYERS = [
  ...
  },
  {
    ...
    recentNotes: "SATURDAY MAY 30 — Daniels' offseason boss is now PRESIDENT OF BASKETBALL OPS ONSI SALEH (promoted from GM + extended long-term Wed May 27 per ESPN / Washington Post / Yahoo / SI onsi / Hoops Rumors). NBA ALL-DEFENSIVE SECOND TEAM nod (announced Fri May 22; NBA.com / AJC / Atlanta News First / Roundtable) is his second straight year on an All-Defense team after making FIRST TEAM in 24-25. He drew 9 first-place and 32 second-place votes from the 100-member global media panel (50 points, 10th in overall voting) and tied for the NBA lead in steals per game at 2.0 with OKC's Cason Wallace; Atlanta posted a top-10 defensive rating for the first time in nearly a decade with Daniels as the primary point-of-attack defender. The Second-Team finish — down from First Team a year ago — tracks a hard offensive year: his three-point shooting cratered to 18.8% (22-of-117), and Daniels has spoken candidly about getting into a 'dark place' mentally, planning an LA summer to rebuild the jumper and 'get stronger.' Victor Wembanyama was the unanimous DPOY and lone unanimous All-Defense 1st-teamer; Daniels was not a 2026 DPOY finalist after finishing runner-up in 25. AROUND THE LEAGUE: KNICKS LEAD THE FINALS 2-0 after a 105-104 Game 2 win Fri Jun 5 (Wembanyama late giveaway, Brunson go-ahead FT); Game 3 at MSG Mon Jun 8. Regular-season line of 11.9/6.8/5.9 on 2.0 stl across 80 games (76 starts) is the locked baseline; five-year, $125M rookie extension kicks in next season — not trade-eligible until July 1, 2026.",
  ...
  },
  {
    ...
    recentNotes: "SUNDAY MAY 31 (offseason — PRESIDENT OF BASKETBALL OPS ONSI SALEH promoted + extended Wed May 27 per ESPN / Washington Post / Yahoo / SI onsi / Hoops Rumors; SPURS TOOK WCF GAME 7 111-103 Sat May 30 (Wembanyama 22-7), ousting OKC to reach the Finals; KNICKS LEAD THE FINALS 2-0 after a 105-104 Game 2 win Fri Jun 5, Wembanyama late turnover — G3 at MSG Mon Jun 8) — Likeliest summer trade chip alongside Risacher, and Saleh as new POBO owns the call. Hollinger explicitly names Kispert (with Risacher) as the likeliest summer trade chip; cap notes show $14.6M next season then a $17.4M cap hit in 27-28. Salary-matching utility in any Jaylen Brown framework is real — the No. 8 pick plus Kispert plus Hield's $9.4M would clear the $57M Brown number per Hoops Rumors / Boston.com / Larry Brown Sports (May 10-22). Regular season line of 9.6/2.4/1.3 on 40.2% from three in 40 games (8 starts) was the post-trade Hawks portion.",
  ...
  },
  {
    ...
    recentNotes: "SUNDAY MAY 31 (offseason — PRESIDENT OF BASKETBALL OPS ONSI SALEH promoted + extended Wed May 27 per ESPN / Washington Post / Yahoo / SI onsi / Hoops Rumors; SPURS TOOK WCF GAME 7 111-103 Sat May 30 (Wembanyama 22-7), ousting OKC to reach the Finals; KNICKS LEAD THE FINALS 2-0 after a 105-104 Game 2 win Fri Jun 5, Wembanyama late turnover — G3 at MSG Mon Jun 8) — Missed the entire first round of the playoffs after the Apr 1 right high-ankle sprain (Heavy/CBS, Apr 24). UFA per Bleacher Report cap notes. Offseason story is whether the new POBO re-signs the third center or pivots to the lottery picks (No. 8 secured May 10) or to Hartenstein-tier FA money for help up front; the Hartenstein chase (per Soaring Down South 'top free-agency frontcourt target', May 11) directly competes with re-signing Landale.",
    playoffStats: null,
    playoffSeries: null,
    minutesTrend: null,
...
export const NEXT_GAME = {
  ...
  broadcast: "ABC / ESPN",
  seriesContext: "SUNDAY JUNE 7 — FINALS GAME 3 TOMORROW AT MSG; THE HAWKS' DRAFT MACHINE HUMS. The 2026 Finals return to Madison Square Garden for the first time in 27 years Monday June 8 (8:30 PM ET, ABC), with NEW YORK up 2-0 and three wins from its first title since 1973; SAN ANTONIO is a 2-point home-dog and trying to avoid the 0-3 cliff no Finals team has ever climbed back from (ESPN / NBA.com / Covers / Yardbarker, Jun 6-7). New York stole Game 2 105-104 Friday on Victor Wembanyama's late turnover-and-foul (Brunson FT, 9.5 left; Wemby miss at the buzzer). The ATL angle persists: this is the Brunson-led Knicks team that eliminated Atlanta in six on Apr 30. HAWKS FRESH THREAD: the DRAFT BOARD — B/R reports the Kings (No. 7) are 'enamored' with Arkansas SEC-POY DARIUS ACUFF JR. (29.3 PPG in the NCAA Tourney), so he may be gone one pick before Atlanta at No. 8; NBA.com consensus still tilts Louisville PG MIKEL BROWN JR. there, with 7'3 ADAY MARA the size-need dark horse. Pre-draft workouts (Bidunga, Onyenso, Suder, Uzan) are underway. A QUIN SNYDER EXTENSION REMAINS 'INEVITABLE' per The Stein Line — eight figures annually, negotiated by POBO Onsi Saleh, expected before the June 23 draft. McCOLLUM retention stays priority one (~$29M room; 2yr/$43M framed as a 'steep discount'). KEY OFFSEASON DATES: Finals Game 3 Mon June 8 (MSG) · Draft Night June 23 (16 days) · Hield $9.66M full-guarantee trigger June 25 (18 days) · Kuminga $24.3M team-option call by June 29 (22 days, decline-and-extend the expected path per Fischer) · McCollum UFA market opens June 30 6 PM ET (23 days) · Free agency moratorium July 6.",
};
...
export const NEWS_DIGEST = {
  ...
  summary:
    "OFFSEASON — Sunday June 7. THE FRESH NEWS: THE NBA FINALS RETURN TO MADISON SQUARE GARDEN TOMORROW for the first time in 27 years — Game 3 tips Monday June 8 (8:30 PM ET, ABC) with the KNICKS up 2-0 and three wins from New York's first title since 1973, and SAN ANTONIO a 2-point home-dog staring down the 0-3 cliff no Finals team has ever survived (ESPN / NBA.com / Covers / Yardbarker, Jun 6-7). The Knicks stole Game 2 105-104 in San Antonio Friday on VICTOR WEMBANYAMA's late turnover-and-foul — tied 104, he threw an outlet into Stephon Castle's back, then fouled JALEN BRUNSON, who hit the go-ahead free throw with 9.5 left before Wemby's buzzer jumper rimmed out; KARL-ANTHONY TOWNS (21-13-4) and Dylan Harper's fourth-quarter spark were the swing pieces. The ATL angle is unavoidable — this is the same Brunson-led Knicks team that bounced the Hawks in six on Apr 30, and the Garden will be loud with President Trump expected courtside Monday under heightened security. ON THE HAWKS BEAT (16 days to the draft): the DRAFT BOARD wrinkle holds — Bleacher Report reports the Sacramento Kings (No. 7) are 'enamored' with Arkansas SEC-POY DARIUS ACUFF JR. (29.3 PPG in the NCAA Tournament), so the explosive guard could be gone one pick before Atlanta is on the clock at No. 8; the NBA.com consensus still most often lands Louisville PG MIKEL BROWN JR. there, with 7'3 ADAY MARA the size-need dark horse. Pre-draft workouts (Bidunga, Onyenso, Suder, Uzan) are underway. A QUIN SNYDER EXTENSION remains 'inevitable' per The Stein Line — eight figures annually, negotiated by POBO Onsi Saleh, expected before the June 23 draft. CAP CALENDAR: Hield's $9.66M full-guarantee trigger June 25 (18 days), Kuminga's $24.3M team-option call by June 29 (22 days, decline-and-extend the expected path per Jake Fischer), McCollum-led free agency opens June 30 6 PM ET (23 days); McCollum re-sign stays priority one with ~$29M in projected room. The trade board still runs through JAYLEN BROWN, Cameron Johnson, Risacher and Kispert.",
  keyTopics: [
    {
      title: "Finals Return to MSG Tomorrow: Knicks Host Game 3 Up 2-0 Over the Team That Ended Atlanta's Season; Spurs at the 0-3 Cliff",
      detail:
        "The 2026 NBA Finals come back to Madison Square Garden for the first time in 27 years Monday June 8 (8:30 PM ET, ABC), with NEW YORK holding a 2-0 lead and three wins from its first championship since 1973 (ESPN / NBA.com / Covers / Yardbarker / ABC7, Jun 6-7). SAN ANTONIO opened as a 2-point road underdog and is trying to avoid a 0-3 hole no Finals team has ever climbed out of; the Spurs' fourth-quarter spark in both games has been rookie DYLAN HARPER, while MIKAL BRIDGES' mid-range stroke (8-of-13 in Game 2's second half) has been New York's steadiest answer. The Knicks reached this point by stealing Game 2 105-104 in San Antonio Friday — tied 104, VICTOR WEMBANYAMA pulled a rebound, fired the outlet into teammate Stephon Castle's back, then fouled JALEN BRUNSON, who hit the go-ahead free throw with 9.5 left before Wemby's buzzer jumper rimmed out; KARL-ANTHONY TOWNS led with 21-13-4 and Brunson scored 20 on an ugly 7-of-25. The ATL angle is unavoidable — this is the same Brunson-led Knicks team that eliminated the Hawks in six on Apr 30 (including the historic 140-89 Game 6). The Garden is bracing for a heightened-security night with President Trump expected courtside; fans are being urged to arrive two hours early and travel light.",
      category: "games",
    },
    {
      title: "Hawks Host First Reported Pre-Draft Workouts: Bidunga, Onyenso, Suder, Uzan Through the Building",
      detail:
        "The draft machine is now visible. SI's onsi reports the Hawks brought in four prospects for pre-draft workouts — Kansas big FLORY BIDUNGA, Virginia shot-blocker UGONNA ONYENSO, Miami (OH) wing PETER SUDER and Houston guard MILOS UZAN — the first reported visits of Atlanta's draft cycle (SI onsi / Yahoo Sports draft workout tracker, early Jun). The group skews toward second-unit size and depth, profiling as targets for No. 23 or No. 57 rather than the No. 8 pick — Bidunga and Onyenso both fit the rim-protection need the Knicks series exposed, and Uzan adds to the point-guard survey the front office is running at the top of the board. With the draft 16 days out (June 23-24, Barclays Center), expect the workout cadence to accelerate; more visits are expected to surface in the coming days.",
      category: "general",
    },
    {
      title: "Snyder Extension Now Called 'Inevitable' by The Stein Line — Eight-Figure Deal Expected Before the Draft",
      detail:
        "The freshest Hawks thread: a contract extension for head coach QUIN SNYDER is now regarded as 'inevitable' around the league, sources told Marc Stein and Jake Fischer of The Stein Line, with talks expected to move quickly once the season ended (Stein Line / SI onsi / Yardbarker / RealGM / Peachtree Hoops, late May). The deal is expected to make Snyder one of the NBA's highest-paid coaches at a 'massive,' eight-figure annual salary; Fischer has reported 'strong' front-office support, and Hawks CEO Steve Koonin told 680 The Fan, 'I think Quin is going to be part of our team for a very, very long time.' Snyder has improved Atlanta's win total in each of his three seasons — culminating in 46 wins and the No. 6 seed — and enters the final year of his current deal in 2026-27. The May 27 promotion of Onsi Saleh to President of Basketball Operations is widely read as clearing the runway: Saleh is the executive negotiating the extension, and a new Snyder deal is expected to be finalized between now and the June 23 draft.",
      category: "general",
    },
    {
    ...
    },
    {
      ...
      detail:
        "Atlanta's headline unrestricted free agent, with fresh contract math this week: new reporting projects McCollum at a two-year, $43M total — a figure framed as a 'steep discount' for a player who averaged 18.7/3.1/4.1 in 41 Hawks games and 19.2 PPG in the playoffs (Yahoo Sports / Bleacher Report / Roundtable, Jun 2-4). That sits just above John Hollinger's executive-consensus range of one or two years slightly over the mid-level exception (~2yr/$35-40M), and one prediction has Atlanta structuring it as 2yr/$40M with a team option starting at $20M. The Hawks' intent is unchanged — HoopsHype reported May 23 they want to re-sign him, and McCollum confirmed a 'productive conversation' with the front office the day after the season ended — but he turns 35 in September and 'likely will have other suitors,' with cap-room teams like Chicago or Brooklyn the named risk. The UFA market opens June 30 at 6 PM ET — 23 days out.",
      category: "trades",
    },
    {
      title: "Kuminga's $24.3M Team Option — June 29 Decision, Decline-and-Extend the Expected Path",
      detail:
        "Atlanta's biggest cap question stays Jonathan Kuminga, with a June 29 deadline on his $24.3M 2026-27 team option — 22 days out (Heavy / Soaring Down South / Yahoo Sports / Fadeaway World, May 1-24). Jake Fischer reports mutual interest in declining the option to negotiate a longer multi-year deal at a lower first-year number — giving Kuminga security and the Hawks a more flexible cap hit, the path most analysts endorse since the 23-year-old is not extension-eligible. Soaring Down South notes the June 23 draft could let Atlanta buy time on the call. The alternatives are exercising the one-year option as a tradable expiring or declining and letting him walk. Kuminga averaged 14.9/5.1/2.2 across 16 Hawks regular-season games and 13.4 PPG in the Knicks series.",
      category: "trades",
    },
    {
      title: "Buddy Hield's $9.66M Decision: June 25 Full-Guarantee Trigger — Return Not Expected",
      detail:
        "Buddy Hield's $9,658,536 ($9.66M) 2026-27 contract becomes fully guaranteed on June 25 — only $3M is currently protected, so Atlanta could save roughly $6M by waiving him before the date (SI onsi cap tracker / Hoops Rumors / SportsTalk ATL, Apr 28-May 29). The trigger is 18 days out. Atlanta can let the full number trigger and keep it as a movable expiring, waive him before the date to save the difference, or include him in a pre-trigger trade. Reporting suggests Hield is not expected back given how little he played after arriving in the Porzingis deal — 71 games, 12 starts at 11.8/2.8/2.1 on 39.8% from three, then just 6 mpg in two first-round games.",
      category: "trades",
    },
    {
...
export const ISSUE = {
  date: "2026-06-07",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 9,                                        // Issue number (offseason cadence)
  dateline: "ATLANTA · JUNE 7, 2026",               // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 09 · JUNE 2026 · ATL · USA",
  railLabel: "ISSUE 09 · JUNE 7",
  coverStarId: 1,                                   // PLAYERS[id] for the cover portrait
  coverRibbon: "EXCLUSIVE · COVER STAR · JALEN JOHNSON",
  coverStatusKicker: "OFFSEASON · DAY 37",          // top-right corner of cover
...
export const KEY_DATES = [
  ...
  { id: "draft",       date: "2026-06-23",
    ...
    hawksAngle: "Hawks hold #8 (via NOP), #23, #57. PG-or-Aday-Mara the latest read (Scotto); trade-back in play." },
