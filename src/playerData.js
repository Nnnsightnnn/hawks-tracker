...
export const NEWS_DIGEST = {
  generatedAt: "2026-07-24T08:15:56Z",
  summary:
    "THE KUMINGA STANDOFF IS TILTING TOWARD LOS ANGELES, JUST NOT AS A TRADE. Five days after the Lu Dort deal reshaped the market, the sign-and-trade Atlanta spent July trying to engineer now looks likelier to end with JONATHAN KUMINGA simply signing with the Lakers outright than being dealt there, though a second wrinkle surfaced Thursday: a competing three-team variant that would route Bronny James, Jarred Vanderbilt, Dalton Knecht and Jake LaRavia to Cleveland, send Kuminga to Los Angeles, and land MAX STRUS in Atlanta, a rare framework that would actually add a rotation shooter to the Hawks rather than dead salary. Reporting through Thursday still has Kuminga himself open to a short-term Atlanta return if the market stays cold, while Onsi Saleh's front office is described as choosy about which sign-and-trade shapes it will accept. The other live framework, floated by Michael Scotto on Wednesday, headlines with Lakers guard BRONNY JAMES: Los Angeles lands Kuminga, Atlanta takes back Vanderbilt plus 2032 and 2033 seconds, and Cleveland absorbs Bronny, though the reporting cast it as a hypothetical that has produced little movement and is partly gated on a LeBron James decision. The Lakers' agreement earlier in the week with defensive wing Matisse Thybulle is read as a hedge that cools their urgency, they have offered Kuminga only about two years and $20M below the mid-level, and with the Hawks sitting at 17 standard contracts they no longer have the roster room or the appetite to absorb the back-end money that made a sign-and-trade work in the first place. Reporting through Wednesday still had Los Angeles and Atlanta far apart on draft compensation, and the Hawks' own path back to Kuminga now runs through the mid-level, near $6M against the roughly $25M his camp has sought, after the front office declined his $24.3M option Jun 29 and kept only Non-Bird rights. The other name is PEYTON WATSON, and Denver has set a price rather than a refusal: reporting puts the Nuggets' ask in the neighborhood of what Utah got for Walker Kessler, unprotected 2031 and 2033 first-round picks plus 2028 and 2030 swaps, while Denver simultaneously plans to match any offer sheet Watson signs. Watson is seeking $25M to $30M annually, and Milwaukee and the Clippers are in on him too. THE ARITHMETIC UNDERNEATH IT ALL is unchanged and getting louder: 17 contracts against a 15-man limit, $196.2M committed, roughly $4M of room under the luxury tax, and BUDDY HIELD's fully guaranteed $9.66M expiring deal still the likeliest thing to move. ELSEWHERE: KINGSTON FLEMINGS landed ninth in ESPN's post-Summer League rookie rankings, and MOUHAMED GUEYE remains three to four months from re-evaluation after left-foot surgery. PRIOR EDITION: THE FIRST NO. 1 PICK ATLANTA EVER DRAFTED IS GONE, AND AN ALL-DEFENSIVE WING IS HERE. The Hawks acquired LUGUENTZ DORT and RYAN NEMBHARD from Oklahoma City on Sunday in a three-team trade that sent ZACCHARIE RISACHER to Dallas and three second-round picks to the Thunder (Chicago's 2027 via Dallas, plus Atlanta's most favorable 2031 and 2032). Onsi Saleh swapped a 21-year-old former No. 1 pick who had fallen out of the playoff rotation for a 27-year-old champion and All-Defensive First Team wing on an expiring $17.7M deal, giving Quin Snyder a perimeter of Dort, DYSON DANIELS and NICKEIL ALEXANDER-WALKER that may be the most disruptive in the league. The cost is offense: Dort shot 38.5% from the field and 34.4% from three last season, both career lows, and most projections have him coming off the bench with heavy minutes rather than starting. The trade also reshapes the rest of the summer. Atlanta is now at 17 standard contracts against a 15-man limit, which means two more moves are coming, and the added salary is widely read as having closed the door on the JONATHAN KUMINGA sign-and-trade with the Lakers. What Atlanta gains in exchange is flexibility: more than $50M in expiring salary between Dort, CJ McCOLLUM and JOCK LANDALE to trade with in-season, about $4M of room under the tax now, and north of $40M in cap space next summer. Everything else from the weekend is background: the Summer League ended Saturday at 5-2 with a 91-83 loss to Washington, and MOUHAMED GUEYE remains three to four months from re-evaluation after left-foot surgery. TWO EDITIONS BACK: THE SUMMER IS OVER, AND IT ENDED QUIETLY. Washington beat Atlanta 91-83 at the Pavilion on Saturday night, closing the Hawks' Summer League at 5-2 overall and 3-2 in Las Vegas. The Wizards led from a 24-15 first quarter and pulled away with a 22-17 run over the last seven minutes; Atlanta shot 42% from the field, 16% from three, and lost the assist battle 22-18 with KINGSTON FLEMINGS and ASA NEWELL both held out. DEVON HIGGS led the Hawks with 22 points and seven rebounds, GABE MADSEN scored 13, and KOBE JOHNSON closed his two-way audition with 13. John Camden's 22 and Chris Livingston's 20 carried Washington. Memphis and Golden State play for the Vegas title Sunday night, without Atlanta. From here the calendar is empty until the Oct 5 preseason opener against Memphis at State Farm Arena, and the front office's summer math is unfinished on three fronts: the roster still sits at 16 standard contracts with BUDDY HIELD the likeliest trim, the JONATHAN KUMINGA sign-and-trade with the Lakers is stuck between contradictory reports on Jarred Vanderbilt's $12.4M and losing momentum, and New Orleans still says it must be blown away on TREY MURPHY III. MOUHAMED GUEYE remains three to four months from re-evaluation after left-foot surgery.",
  keyTopics: [
    {
      title: "A Second Kuminga Framework Surfaces Thursday, This One Landing Max Strus in Atlanta, But the Standoff Still Tilts Toward the Lakers Signing Him Outright",
      detail:
        "The saga added a second concrete shape Thursday. On top of Wednesday's Michael Scotto framework, a competing three-team variant circulated in which Cleveland absorbs Bronny James, Jarred Vanderbilt, Dalton Knecht and Jake LaRavia plus a 2027 second, Los Angeles signs-and-trades for Jonathan Kuminga, and Atlanta comes away with Max Strus (Sportskeeda / Heavy / Yahoo Sports / SI onsi, Jul 22-23). That last piece is the notable part: unlike the Vanderbilt-return shape, a Strus return would actually add a rotation shooter rather than dead salary, though it too reads as a hypothetical with no reported momentum. Wednesday's version headlined with Bronny James sending Kuminga to Los Angeles, Vanderbilt plus 2032 and 2033 seconds to Atlanta, and Bronny to Cleveland, partly gated on a LeBron James decision. Absent either, the likelier ending is simpler: Los Angeles keeping its picks and signing Kuminga as a free agent, with Marc Stein reporting Kuminga would still need Atlanta's help on a sign-and-trade to approach last season's $22.5M and the Hawks described as choosy about which shapes they will accept. Reporting through Thursday holds Kuminga himself open to a short-term Atlanta return if the market stays cold. The Lakers' agreement earlier in the week with Matisse Thybulle is read as a hedge that lowers their urgency, and they have floated only about two years and $20M below the mid-level. Sunday's Dort trade is what narrowed everything: at 17 standard contracts Atlanta no longer wants Los Angeles' back-end money, the mechanism by which LA planned to pay Kuminga. Atlanta's remaining route to retaining him outright sits near the mid-level, roughly $6M annually against the $25M his camp targeted, after the front office declined his $24.3M option Jun 29 and kept only Non-Bird rights. Cleveland, the Clippers and Milwaukee round out the listed suitors. Two months of Atlanta's summer have produced no resolution on its most valuable expiring asset.",
      category: "trades",
    },
    {
...
export const ISSUE = {
  date: "2026-07-24",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 33,                                       // Issue number (offseason cadence)
  dateline: "ATLANTA · JULY 24, 2026",              // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 33 · JULY 2026 · ATL · USA",
  railLabel: "ISSUE 33 · JULY 24",
  ...
  coverImage: null,
  coverRibbon: "SECOND KUMINGA FRAMEWORK SURFACES, THIS ONE LANDING MAX STRUS IN ATLANTA · KUMINGA STILL OPEN TO A SHORT-TERM RETURN · DENVER WANTS THE KESSLER PACKAGE FOR PEYTON WATSON · 17 CONTRACTS, $196.2M, $4M UNDER THE TAX · NEXT GAME OCT 5 VS MEMPHIS",
  coverStatusKicker: "OFFSEASON · DAY 81",          // top-right corner of cover
  coverStatusLine: "SECOND KUMINGA FRAMEWORK WOULD LAND MAX STRUS · KUMINGA OPEN TO SHORT-TERM RETURN · 17 CONTRACTS, LIMIT 15 · NEXT: PRESEASON, OCT 5", // {DAYS:id} resolves from KEY_DATES
  backTagline: "Next issue: which two contracts go to get to 15, whether Kuminga takes the mid-level or leaves for nothing, and whether Atlanta has the picks left to meet Denver's number on Watson.",
};
