...
export const PLAYERS = [
  ...
  },
  {
    ...
    recentNotes: "SUNDAY MAY 31 (offseason — PRESIDENT OF BASKETBALL OPS ONSI SALEH promoted + extended Wed May 27 per ESPN / Washington Post / Yahoo / SI onsi / Hoops Rumors; SPURS TOOK WCF GAME 7 111-103 Sat May 30 (Wembanyama 22-7), ousting OKC to reach the Finals vs the Knicks; Finals open Wed Jun 3) — Likeliest summer trade chip alongside Risacher, and Saleh as new POBO owns the call. Hollinger explicitly names Kispert (with Risacher) as the likeliest summer trade chip; cap notes show $14.6M next season then a $17.4M cap hit in 27-28. Salary-matching utility in any Jaylen Brown framework is real — the No. 8 pick plus Kispert plus Hield's $9.4M would clear the $57M Brown number per Hoops Rumors / Boston.com / Larry Brown Sports (May 10-22). Regular season line of 9.6/2.4/1.3 on 40.2% from three in 40 games (8 starts) was the post-trade Hawks portion.",
  ...
  },
  {
    ...
    recentNotes: "SUNDAY MAY 31 (offseason — PRESIDENT OF BASKETBALL OPS ONSI SALEH promoted + extended Wed May 27 per ESPN / Washington Post / Yahoo / SI onsi / Hoops Rumors; SPURS TOOK WCF GAME 7 111-103 Sat May 30 (Wembanyama 22-7), ousting OKC to reach the Finals vs the Knicks; Finals open Wed Jun 3) — Missed the entire first round of the playoffs after the Apr 1 right high-ankle sprain (Heavy/CBS, Apr 24). UFA per Bleacher Report cap notes. Offseason story is whether the new POBO re-signs the third center or pivots to the lottery picks (No. 8 secured May 10) or to Hartenstein-tier FA money for help up front; the Hartenstein chase (per Soaring Down South 'top free-agency frontcourt target', May 11) directly competes with re-signing Landale.",
    playoffStats: null,
    playoffSeries: null,
    minutesTrend: null,
...
export const NEXT_GAME = {
  ...
  broadcast: "ABC / ESPN",
  seriesContext: "WEDNESDAY JUNE 3 — A QUIN SNYDER EXTENSION IS STILL BEING CALLED 'INEVITABLE.' Marc Stein and Jake Fischer (The Stein Line) report a new deal for the Hawks head coach is regarded as inevitable around the league — expected to land 'in the same ballpark' as other proven NBA head coaches — with talks moving quickly now that the season is over and Onsi Saleh — the man negotiating it — locked in as President of Basketball Operations (Stein Line / SI onsi / Yardbarker / RealGM / Peachtree Hoops, late May). Snyder, who has improved Atlanta's win total in each of his three seasons (culminating in 46 wins and the No. 6 seed), enters the final year of his deal in 2026-27; a 'massive,' eight-figure agreement is expected to land between now and the June 23 draft. FINALS GAME 1 TONIGHT: the San Antonio Spurs (62-20, home-court) host the New York Knicks (53-29) in Game 1 of the NBA Finals TONIGHT, WED JUNE 3, 8:30 PM ET on ABC at Frost Bank Center — a 1999 rematch, and the same Knicks team that ended Atlanta's season in six on Apr 30 (historic 140-89 Game 6). San Antonio reached its first Finals since 2014 by winning Game 7 of the WCF 111-103 at OKC on May 30. DRAFT BOARD: with the No. 8 pick 20 days out, NBA.com's post-Combine consensus mock still lands most often on Louisville PG MIKEL BROWN JR., with 7'3 Michigan center ADAY MARA the dark-horse alternative in four mocks; HoopsHype's Michael Scotto says rival execs expect Atlanta to target a point guard or Mara, KINGSTON FLEMINGS and SEC POY DARIUS ACUFF JR. round out the guard lane, and a trade-back is in play if guards fly off the board at 6 and 7. ATL CAP ANGLE: ISAIAH HARTENSTEIN's ~$28.5M option still likely stays in OKC (longshot for Atlanta). FRONT OFFICE: ONSI SALEH promoted GM→President of Basketball Operations on a long-term extension Wed May 27. AWARDS: JALEN JOHNSON All-NBA Third Team, NAW Most Improved, DANIELS All-Def 2nd. CJ McCOLLUM retention is the free-agency priority (~2yr/$35-40M consensus, though he 'likely will have other suitors'). JAYLEN BROWN and CAMERON JOHNSON trade threads remain open; RISACHER and KISPERT the likeliest summer trade chips per Hollinger. KEY OFFSEASON DATES: NBA Finals Game 1 TONIGHT June 3 · Draft Night June 23 (20 days) · Hield $9.66M full-guarantee trigger June 25 (22 days) · Kuminga $24.3M team-option call by June 29 (26 days, decline-and-extend the expected path per Fischer) · McCollum UFA market opens June 30 6 PM ET (27 days) · Free agency moratorium July 6.",
};
...
export const NEWS_DIGEST = {
  generatedAt: "2026-06-03T12:30:00Z",
  summary:
    "OFFSEASON — Wednesday June 3. THE FRESH NEWS: A QUIN SNYDER EXTENSION IS STILL BEING CALLED 'INEVITABLE.' Marc Stein and Jake Fischer (The Stein Line) report a new contract for the Hawks head coach is regarded as inevitable around the league, expected to be 'in the same ballpark' as other proven NBA head coaches, with talks moving quickly now that the season is over and Onsi Saleh — promoted to President of Basketball Operations on a long-term extension May 27 — locked in as the executive negotiating it (Stein Line / SI onsi / Yardbarker / RealGM / Peachtree Hoops, late May). Snyder, who has lifted Atlanta's win total in all three of his seasons (46 wins, No. 6 seed this year), enters the final year of his deal in 2026-27; a 'massive,' eight-figure agreement is expected to land between now and the June 23 draft. ON THE COURT TONIGHT: the NBA Finals tip — the San Antonio Spurs (62-20, home-court) host the New York Knicks (53-29) in Game 1 TONIGHT, Wednesday June 3, 8:30 PM ET on ABC at Frost Bank Center, a 1999 rematch and the same Knicks team that eliminated Atlanta in six. DRAFT: with the No. 8 pick 20 days out, NBA.com's post-Combine consensus mock still lands most often on Louisville PG MIKEL BROWN JR., with 7'3 Michigan center ADAY MARA the dark-horse alternative in four mocks; HoopsHype's Michael Scotto says rival execs expect Atlanta to target a point guard or Mara, and Houston wing KINGSTON FLEMINGS and SEC POY DARIUS ACUFF JR. round out the guard lane — with a trade-back possible if guards go at 6 and 7. CAP CALENDAR: Finals Game 1 TONIGHT June 3, Draft Night June 23 (20 days), Hield's $9.66M full-guarantee trigger June 25 (22 days), Kuminga's $24.3M team-option call by June 29 (26 days) — with mutual interest in a decline-and-extend per Jake Fischer — and the McCollum-led free-agency market opening June 30 6 PM ET (27 days). McCollum retention stays the priority (~2yr/$35-40M the consensus range); the trade board still runs through JAYLEN BROWN, Cameron Johnson, Risacher and Kispert. AWARDS SWEEP: Jalen Johnson All-NBA Third Team, Nickeil Alexander-Walker Most Improved, Dyson Daniels All-Defensive Second Team.",
  keyTopics: [
    {
    ...
    {
      title: "Spurs Win the West: San Antonio Topples Thunder 111-103 in Game 7, Reaches First Finals Since 2014",
      detail:
        "It came down to one game, and San Antonio won it. The SPURS defeated the defending-champion Oklahoma City Thunder 111-103 in Game 7 of the Western Conference Finals on Saturday May 30 at OKC's Paycom Center, advancing to the NBA Finals for the first time since 2014 (NBA.com / ESPN / CBS Sports / NBC Sports / KSAT, May 30-31). VICTOR WEMBANYAMA closed with 22 points and 7 rebounds; Julian Champagnie poured in 20 on six made threes, Stephon Castle had 16, De'Aaron Fox 15 and Dylan Harper 12. OKC, which had forced the decider with a 118-91 Game 6 rout, could not solve San Antonio at home and was dethroned a year after winning the title. The Spurs travel to open the 2026 NBA Finals ON THE ROAD against the New York Knicks on Wednesday June 3 — the same Knicks team that eliminated Atlanta in six in the first round.",
      category: "games",
    },
    {
      title: "Knicks Sweep Cavaliers 4-0, Reach First NBA Finals Since 1999 — Brunson Named ECF MVP",
      detail:
        "Monday May 25 at Cleveland's Rocket Arena: the NEW YORK KNICKS completed a four-game sweep of the top-seeded Cavaliers with a 130-93 rout, advancing to the NBA Finals for the first time since 1999 (NBA.com / ESPN / Olympics.com / Yahoo Sports / CBS Sports, May 25). JALEN BRUNSON was voted Eastern Conference Finals MVP; the Game 4 box was led by KARL-ANTHONY TOWNS (19-14), OG ANUNOBY 17, LANDRY SHAMET 16 off the bench, with Mikal Bridges and Brunson contributing 15 apiece. The Knicks open the 2026 NBA Finals ON THE ROAD on WEDNESDAY JUNE 3 against the San Antonio Spurs, with home games at Madison Square Garden beginning Monday June 8. ATL angle is direct — this is the same Knicks team that ended Atlanta's season in six on Apr 30, including the historic 140-89 Game 6.",
      category: "games",
    },
    {
...
export const ISSUE = {
  date: "2026-06-02",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 8,                                        // Issue number (offseason cadence)
  dateline: "ATLANTA · JUNE 2, 2026",               // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 08 · JUNE 2026 · ATL · USA",
  railLabel: "ISSUE 08 · JUNE 2",
  coverStarId: 1,                                   // PLAYERS[id] for the cover portrait
  coverRibbon: "EXCLUSIVE · COVER STAR · JALEN JOHNSON",
  coverStatusKicker: "OFFSEASON · DAY 32",          // top-right corner of cover
