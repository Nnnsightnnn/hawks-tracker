...
export const ISSUE = {
  date: "2026-08-02",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 39,                                       // Issue number (offseason cadence)
  dateline: "ATLANTA · AUGUST 2, 2026",             // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 39 · AUGUST 2026 · ATL · USA",
  railLabel: "ISSUE 39 · AUG 2",
  ...
  coverImage: null,
  coverRibbon: "LAKERS NOW THE CLEAR KUMINGA FRONTRUNNER WITH CLEVELAND OUT, BUT THE VANDERBILT OPTION STILL BLOCKS A DEAL · PREVIEWS SPLIT: PERKINS RANKS ATLANTA 3RD IN THE EAST, BETMGM SETS 43.5 WINS · WATSON PATH STILL NARROW · 17 CONTRACTS, LIMIT 15 · NEXT GAME OCT 5 VS MEMPHIS",
  coverStatusKicker: "OFFSEASON · DAY 90",          // top-right corner of cover
