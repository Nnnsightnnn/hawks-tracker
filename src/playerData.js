// ─── Atlanta Hawks Player Data (2025-26 Season · Updated Saturday May 16, 2026 — OFFSEASON · COMBINE DAY 6 (testing/interviews wrap) in Chicago · ECSF Game 7 Pistons-Cavs Sunday in Detroit · Hawks locked into No. 8 (NOP), No. 23 (CLE/SAS), No. 57 (BOS) · 38 days to Draft Night Jun 23) ─
...
export const PLAYERS = [
  ...
  },
  {
    ...
    recentNotes: "Combine Day 6 (Sat May 16) — Series ended with the rotation slot under question after a tough R1 showing. Hollinger explicitly names Kispert (with Risacher) as the likeliest summer trade chip; cap notes show $14.6M next season then a $17.4M cap hit in 27-28. Salary-matching utility in any Jaylen Brown framework is real — the No. 8 pick plus Kispert plus Hield's $9.4M would clear the $57M Brown number per Hoops Rumors / Boston.com (May 10-11). Regular season line of 9.6/2.4/1.3 on 40.2% from three in 40 games (8 starts) was the post-trade Hawks portion.",
  ...
  },
  {
    ...
    recentNotes: "Combine Day 6 (Sat May 16) — UFA whose renewal price came down after Round 1. Six-game R1 line: ~2.8 PPG on a series-long shooting slump. Regular season was a steady veteran backup role (7.4/1.8/2.9) over 58 games but the playoff sample raises questions on terms. Hoops Rumors offseason brief tags him as a role-player filler Saleh can shop on minimums or replace via the MLE; UFA market opens June 30, 6 PM ET — 46 days out.",
  ...
  },
  {
    ...
    recentNotes: "Combine Day 6 (Sat May 16) — Missed the entire first round of the playoffs after the Apr 1 right high-ankle sprain (Heavy/CBS, Apr 24). UFA per Bleacher Report cap notes. Offseason story is whether ATL re-signs the third center or pivots to the lottery picks (May 10) or to Hartenstein-tier FA money for help up front; the Hartenstein chase (per Soaring Down South 'top free-agency frontcourt target', May 11) directly competes with re-signing Landale.",
    playoffStats: null,
    playoffSeries: null,
    minutesTrend: null,
...
export const NEXT_GAME = {
  ...
  broadcast: "ABC / ESPN",
  seriesContext: "COMBINE DAY 6 (Sat May 16, Wintrust Arena) — penultimate day, athletic testing wrap + team interviews + medical exams continue through Sunday May 17 close. NEW FRONT-OFFICE FLASHPOINT (breaking Tue May 12-Fri May 15): Philadelphia 76ers FIRED PBO DARYL MOREY; HBSE President of Sports BOB MYERS has taken interim control of basketball ops and is leading the search — sources (Dallas Hoops Journal / Philly Inquirer / NBC Sports Philadelphia / ESPN) name HAWKS GM ONSI SALEH and Andre Iguodala on Myers' radar. Saleh climbed the Warriors front office under Myers (2019-23) before joining ATL in 2024 — the familiarity is the hook. Hawks just lost Bryson Graham to Chicago May 5; a Saleh departure to PHI would be a top-down gut. ECSF GAME 7 LOOMS Sunday May 17 in Detroit after PISTONS WON GAME 6 115-94 last night at Cleveland (Cade Cunningham 21/8/5 3PM; Harden passed Curry for 10th on the all-time playoff scoring list with a Q1 step-back 3). KNICKS COMPLETED A 4-0 SWEEP OF 76ERS (Game 4 May 10: 144-114, franchise-record 25 3PM) and now AWAIT the DET/CLE winner in the ECF starting next week. COMBINE WRAP: top shooting belongs to Alex Karaban (74.8% across all drills, best at combine), Kingston Flemings led the 3-point star drill 19/25 + 40.5\" max vert + top-5 in agility/shuttle/sprint. Cameron Boozer measured 6'8.25\"/252.8 lbs/7'1.5\" wingspan/35\" vert. Aday Mara 7'3\" socks/9'9\" reach (2nd-longest in combine history). Cameron Carr 38\" standing/42.5\" max vert. NEW: HAWKS MET WITH AJ DYBANTSA (BYU, consensus No. 1) at the combine despite picking 8th (SI onsi / Deseret News / CBS Sports). CAMERON JOHNSON trade thread still warm but no movement (Heavy / NuggLove / FanSided). BURRIES (Arizona, 16.1 PPG) remains Hollinger's No. 8 mock; Mikel Brown Jr. and Kingston Flemings the other realistic ATL boards. Pre-draft workouts running: Bidunga, Onyenso, Suder, Uzan. KEY OFFSEASON DATES: Hield $9.4M full-guarantee trigger June 25 · Kuminga $24.3M team-option call by June 29 · McCollum UFA market opens June 30 6 PM ET · Free agency moratorium July 6.",
};
...
export const NEWS_DIGEST = {
  generatedAt: "2026-05-16T13:30:00Z",
  summary:
    "OFFSEASON — Saturday May 16, Combine Day 6 in Chicago. NEW THIS WEEK'S HEADLINE FRONT-OFFICE STORY: Philadelphia 76ers fired PBO Daryl Morey on TUESDAY MAY 12 (ESPN / NBA.com / NBC Sports Philadelphia / FOX 29 Philly) — HBSE President of Sports BOB MYERS has taken interim control of basketball ops and Friday-Saturday reporting (Dallas Hoops Journal / Philly Inquirer) names HAWKS GM ONSI SALEH on Myers' candidate radar alongside Andre Iguodala. Saleh climbed the Warriors front office under Myers from 2019-23 before joining ATL in 2024; the prior working relationship is the cited hook. With Bryson Graham already gone to Chicago (May 5), Saleh joining Philly would be a top-down gut to a Hawks FO that's still searching for a President of Basketball Operations. ECSF GAME 7 SUNDAY MAY 17 in Detroit: the Pistons rolled the Cavaliers 115-94 last night at Cleveland behind Cade Cunningham (21/8/5 3PM) — James Harden passed Stephen Curry for 10th on the all-time playoff scoring list with a Q1 step-back 3. KNICKS COMPLETED A 4-0 SWEEP OF 76ERS last Sunday May 10 (144-114 close-out, franchise-record 25 3PM) and now await the DET/CLE winner — the team that ended Atlanta's season is back in the ECF for a second straight year. COMBINE WRAP: top shooting belongs to ALEX KARABAN (74.8% across all drills, combine-best); Kingston Flemings led the 3-point star drill (19/25), max vert 40.5\", top-5 in agility/shuttle/sprint; Cameron Boozer measured 6'8.25\"/252.8 lbs/7'1.5\" wingspan/35\" vert; ADAY MARA 7'3\" socks/9'9\" reach (2nd-longest in combine history); CAMERON CARR 30 on 6 threes plus 38\" standing/42.5\" max vert. NEW: HAWKS MET WITH AJ DYBANTSA (BYU, consensus No. 1) at the combine despite picking 8th — intel pass per SI onsi / Deseret News / CBS Sports. CAMERON JOHNSON trade thread still warm but NO TRADE EXECUTED — Heavy / NuggLove / FanSided continue to label Johnson Denver's most-likely trade candidate (Watson re-sign math), Hawks the cleanest lane. BRAYDEN BURRIES (Arizona, 16.1 PPG) remains Hollinger's No. 8 mock; Mikel Brown Jr. (Pro Day shooting clinic at combine) and Kingston Flemings the other realistic ATL boards. FRONT-OFFICE SPINE: operate OVER the cap with non-tax MLE (~$15.1M), BAE (~$5.1M), four trade exceptions, Hield's $9.4M expiring; retain McCollum (HoopsHype: 'slightly above MLE,' ~2yr/$35-40M); KUMINGA $24.3M option call by June 29 (Brett Siegel now reports Hawks lean toward OPT-IN as in-season trade asset, contra prior decline-for-extension framing); call Hield's $3M-vs-$9.4M trigger before June 25; shop Risacher or Kispert. Snyder extension talks remain on the calendar.",
  keyTopics: [
    {
      title: "BREAKING (Tue May 12-Sat May 16): Bob Myers Eyeing Onsi Saleh For Vacant 76ers PBO Role — Hawks GM On Philly's Shortlist",
      detail:
        "TUESDAY MAY 12: Philadelphia 76ers FIRED PBO Daryl Morey after Boston Celtics historic 3-1 R1 collapse exit (ESPN 'Sources: Morey out as 76ers president of basketball operations' / NBA.com / NBC Sports Philadelphia / FOX 29 Philly / Crossing Broad / Philly Inquirer, May 12-13). HBSE President of Sports BOB MYERS — the four-time-champion Warriors architect named to oversee Sixers basketball ops last October — has taken INTERIM control of basketball operations and is leading the PBO search. FRIDAY-SATURDAY (May 15-16): Dallas Hoops Journal and Philly Inquirer report that HAWKS GM ONSI SALEH and four-time NBA champion ANDRE IGUODALA are both on Myers' radar for the role. The Saleh-Myers familiarity: Saleh climbed the Golden State Warriors front office under Myers from 2019-2023 before joining Atlanta as assistant GM in 2024 and getting promoted to GM in April 2025. Shams Charania adds the eventual PBO hire will 'partner' with Myers (Crossing Broad, May 14). MECHANICAL ATL RISK: Bryson Graham already left for the Bulls EVP chair May 5; a Saleh exit to Philly would be a top-down gut while Atlanta is STILL searching for its own President of Basketball Operations (vacant since the FO restructure last spring). Atlanta would be replacing both its GM and its top draft evaluator inside a 6-week window between the Combine and Draft Night. NOT YET a done deal — Saleh just finished 2nd in NBA Executive of the Year voting and is mid-build with the team.",
      category: "general",
    },
    {
      title: "Cameron Johnson Still 'Most Likely' Nuggets Trade Candidate — Hawks Lane Holds, NO MOVEMENT YET",
      detail:
        "Three days into the strengthened thread (Heavy 'Cam Johnson Top Trade Candidate Revealed by NBA Insider' / NuggLove / FanSided / Yahoo Sports / SI Nuggets, May 13-16): Brett Siegel (ClutchPoints) and the Denver Post continue to label DENVER's CAMERON JOHNSON the Nuggets' MOST LIKELY trade candidate of the offseason. Mechanics unchanged: Johnson is on a $23.5M expiring contract, and Denver must move salary to re-sign restricted free agent Peyton Watson — Cam Johnson or Christian Braun are the only realistic levers, and Johnson's expiring is the most-mobile dollar on the books. Johnson played 54 games in 25-26 averaging 12.2 PPG and shot poorly in the postseason. Atlanta's reported interest first surfaced May 13 (HoopsHype / Soaring Down South) and remains the cleanest of Saleh's three open wing-upgrade lanes — half-court shotmaking + 3-and-D, the exact profile Hollinger named as Atlanta's biggest R1 gap. Likely structure: ATL's four trade exceptions + a future first, OR salary-matching with Hield's $9.4M expiring and Kispert. NO TRADE EXECUTED as of Sat May 16 morning — talks remain speculative. Clippers, Lakers, Warriors, and Rockets were named as interested when Johnson was in Brooklyn last summer.",
      category: "trades",
    },
    {
      title: "COMBINE DAY 6 (Sat May 16): Shooting + Athletic Testing Locked In — Karaban, Flemings, Mara, Boozer the Headline Names",
      detail:
        "TODAY at Wintrust Arena (Day 6 of 7 of the 2026 AWS NBA Draft Combine, May 11-17): penultimate day — team interviews, shooting drills and athletic-testing wrap continue through Sunday's close (Bleacher Report 'Winners and Losers from the 2026 NBA Combine' / At The Hive 'Winners and Losers' / CBS Sports 'Risers and Fallers' / Yahoo Sports / Babcock Hoops / NBADraft.net, May 14-16). SHOOTING-DRILL TOP LINE: ALEX KARABAN was the combine's best shooter at 74.8% across all drills — 22-of-30 off the dribble, 18-of-25 3-point star, 21-of-25 side-mid-side (combine best), 18-of-25 spot-ups. KINGSTON FLEMINGS led the 3-point star drill 19-of-25, hit 15-of-25 spot-ups, and finished top-5 in max vertical (40.5\"), pro lane agility, shuttle and sprint. ATHLETIC TESTING: CAMERON CARR (38\" standing / 42.5\" max vert / 10.46 lane agility — all 2nd-best in class) plus 30-pt scrimmage on 6 threes; Billy Richmond 41\" vert + 10.23 lane agility + 3.06 ¾-court sprint; Morez Johnson Jr. 39\" max vert + 17-of-25 star-shooting. MEASUREMENTS THAT MATTER FOR ATL: ADAY MARA 7'3\" socks/9'9\" reach (tied 2nd-longest in combine history) — addresses Hawks size shortage; CAMERON BOOZER 6'8.25\"/252.8 lbs/7'1.5\" wingspan/35\" vert (Duke POY, projected top-3); Mikel Brown Jr. 6'3.5\" barefoot/6'7.5\" wingspan + 'Pro Day shooting clinic'. Top-3 (Dybantsa, Peterson, Boozer) sat out scrimmages entirely after Day 1 measurements. Hawks board for No. 8 now graded primarily on interviews + medical — Sunday closes the window.",
      category: "general",
    },
    {
