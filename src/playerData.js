...
export const NEXT_GAME = {
  ...
  broadcast: "—",
  seriesContext: "SATURDAY JUNE 27, the quiet weekend before decision week. NEWEST MOVE: Atlanta PICKED UP MOUHAMED GUEYE'S $2.41M team option for 2026-27 (Michael Scotto / HoopsHype, via SI onsi / Peachtree Hoops / Hoops Rumors), a cheap hold on a switchable depth big instead of risking him in restricted free agency. THE GATES NOW LOOM: Jonathan Kuminga's $24.3M team option must be called by Monday June 29 (2 days out, decline-and-re-sign the reported lean), the FA market opens Tuesday June 30 at 6 PM ET (3 days out), and the moratorium ends July 6. THE HIELD GATE STAYS OPEN: rather than waive Buddy Hield before his $9.66M salary fully guaranteed Thursday Jun 25, Atlanta and Hield agreed to PUSH BACK THE GUARANTEE DEADLINE (Chris Haynes); only $3M is fully guaranteed, so keep-as-expiring, waive-later, or trade-filler all stay live. DRAFT CLASS SETTLED: Flemings (No. 8), Ejiofor (No. 23) and Veesaar (No. 52) were introduced in Atlanta; Summer League runs in Salt Lake City and Las Vegas in July. ATLANTA'S DONE WORK still stands: wing AARON WIGGINS from OKC for two seconds, CJ McCOLLUM re-signed (1yr, ~$21M, 7.5% trade kicker), and Quin Snyder extended Jun 8.",
};
...
export const NEWS_DIGEST = {
  generatedAt: "2026-06-27T12:30:00Z",
  summary:
    "OFFSEASON, Saturday June 27, the quiet weekend before a loud week. Atlanta's countdown is tightening: Jonathan Kuminga's $24.3M team option must be called by Monday June 29 (2 days out), with a decline-and-re-sign the reported lean rather than a straight pickup; the FA market opens Tuesday June 30 at 6 PM ET (3 days out); and the moratorium ends July 6. The newest concrete transaction is small but telling: the Hawks PICKED UP MOUHAMED GUEYE'S $2.41M team option for 2026-27, Michael Scotto reported, locking in a cheap, switchable depth big rather than letting him hit restricted free agency. That came bundled with the Buddy Hield news, where Atlanta and Hield AGREED TO PUSH BACK HIS GUARANTEE DEADLINE rather than waive him before his $9.66M salary locked in. Only $3M of Hield's deal is fully guaranteed, so the Hawks keep every lever (movable expiring now, waive-and-save later), but the immediate roughly $6M and roster-spot save is on hold. The draft is fully in the books, Kingston Flemings (No. 8), Zuby Ejiofor (No. 23) and Henri Veesaar (No. 52) introduced in Atlanta Thursday, and Summer League runs in both Salt Lake City and Las Vegas in July. Atlanta's done work holds: AARON WIGGINS acquired from OKC for two seconds, CJ McCOLLUM re-signed at one year and roughly $21M, and Quin Snyder extended on June 8. POBO Onsi Saleh keeps preaching patience: not one player away, guard the cap room, and find the next Nickeil.",
  keyTopics: [
    {
      title: "FRESH: Decision Week Opens, Hawks Pick Up Mouhamed Gueye's $2.41M Option as the Kuminga (Mon) and FA (Tue) Gates Loom",
      detail:
        "The quiet pre-free-agency weekend has one new transaction and a tightening clock. Atlanta PICKED UP the $2.41M team option on third-year forward MOUHAMED GUEYE for 2026-27, Michael Scotto of HoopsHype reported (SI onsi / Peachtree Hoops / Hoops Rumors, Jun 25), a cheap, low-risk hold on a switchable 6'10 depth big rather than risking him in restricted free agency. With that minor piece settled, the real gates are now days away: Jonathan Kuminga's $24.3M team option must be called by Monday June 29 (2 days out), the free-agency negotiating window opens Tuesday June 30 at 6 PM ET (3 days out), and the moratorium ends July 6. POBO Onsi Saleh has signaled patience over splash: stay roughly $36M under the tax even if Kuminga and Hield are kept, guard the near-$15M Non-Taxpayer Mid-Level, and chase the next Nickeil Alexander-Walker rather than one star.",
      category: "general",
    },
    {
      title: "Hawks and Buddy Hield Push Back His Guarantee Deadline, Keeping Options Open Instead of Waiving Him",
      detail:
        "The decision-day deadline moved rather than triggered. Instead of waiving Buddy Hield before his salary fully guaranteed Thursday June 25, Atlanta and Hield AGREED TO PUSH BACK THE GUARANTEE DATE so both sides have more time to flush out options, Chris Haynes reported (Hoops Rumors / Bleacher Report / ClutchPoints / Yardbarker, Jun 25). Of his $9.66M salary for 2026-27, $3M is fully guaranteed regardless. Hield could still be useful to Atlanta as a reliable bench shooter or as a salary-matching expiring in a larger trade, the reason both sides bought more time rather than cutting bait. He barely played after arriving in the Kristaps Porzingis deal, and the Hawks suddenly have a crowded backcourt after the Aaron Wiggins trade and the Flemings pick, so the calculus is whether his contract is worth more as a trade chip than as cap relief. The immediate roughly $6M and roster-spot save is on hold, but every lever (waive later, trade, or keep) is still on the table.",
      category: "trades",
    },
    {
      title: "Hawks Introduce 2026 Draft Class, Flemings, Ejiofor and Veesaar Meet the Media in Atlanta",
      detail:
        "Atlanta's three rookies have touched down. KINGSTON FLEMINGS (No. 8), ZUBY EJIOFOR (No. 23) and HENRI VEESAAR (No. 52) were introduced at their first Hawks press conference Thursday June 25, GM Onsi Saleh alongside them, with all three describing a whirlwind 48 hours since draft night (AJC / SI / 247Sports, Jun 25). Flemings, the 6'4 Houston point guard taken eighth, projects as the guard of the future and an eventual successor to CJ McCollum. Ejiofor, the St. John's energy big and Kareem Abdul-Jabbar Award winner as the nation's top center, adds the interior physicality the Knicks exposed. Veesaar, the 7-foot UNC stretch-five Atlanta traded up from No. 57 to No. 52 to land, brings shooting size behind Onyeka Okongwu. The mood was eagerness across the board: a young class ready, in Flemings' words, to work.",
      category: "general",
    },
    {
...
export const ISSUE = {
  date: "2026-06-27",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 14,                                       // Issue number (offseason cadence)
  dateline: "ATLANTA · JUNE 27, 2026",              // Pre-formatted for display
