...
export const NEXT_GAME = {
  ...
  broadcast: "ABC / ESPN",
  seriesContext: "SUNDAY MAY 31 — FRESH: THE WEST HAS A CHAMPION. SAN ANTONIO won Game 7 of the Western Conference Finals 111-103 over Oklahoma City on SAT MAY 30 at Paycom Center, OKC, dethroning the defending-champion Thunder and reaching the NBA Finals for the first time since 2014 (NBA.com / ESPN / CBS Sports / NBC Sports / KSAT, May 30-31) — WEMBANYAMA 22-7, Champagnie 20 on six threes, Castle 16, Fox 15, Harper 12; OKC had forced the decider with a 118-91 Game 6 rout but couldn't solve the Spurs at home. The Spurs open the NBA Finals ON THE ROAD vs the NEW YORK KNICKS on WED JUNE 3 (ABC) — the same Knicks that ended Atlanta's season in six on Apr 30 (historic 140-89 Game 6); Brunson was ECF MVP after New York's 4-0 sweep of Cleveland. ATL CAP ANGLE: OKC's exit reopens the Thunder's math around ISAIAH HARTENSTEIN's ~$28.5M option — Atlanta's top frontcourt target — but reporting still expects OKC to keep its starting center, leaving the Hawks' Hartenstein dream a long shot. HAWKS FRONT OFFICE: ONSI SALEH was promoted from GM to PRESIDENT OF BASKETBALL OPERATIONS on a long-term extension Wed May 27 (ESPN / Washington Post / Yahoo / SI onsi / Hoops Rumors / TSN) — the 2026 Executive-of-the-Year runner-up locks in as Atlanta's lead architect after the Hawks denied Philadelphia permission to interview him for the 76ers' job. The 'massive,' eight-figure QUIN SNYDER extension is still expected to land between now and Draft Night. AWARDS: JALEN JOHNSON All-NBA Third Team (franchise headline), NAW Most Improved, DANIELS All-Def 2nd. CJ McCOLLUM retention is the free-agency priority (HoopsHype confirmed mutual interest May 23; ~2yr/$35-40M consensus, Bobby Marks floating a 3yr/$115.9M ceiling). JAYLEN BROWN (All-NBA 2nd) and CAMERON JOHNSON trade threads remain open; RISACHER and KISPERT the likeliest summer trade chips per Hollinger. DRAFT BOARD: No. 8 pick now spans guards MIKEL BROWN JR., KINGSTON FLEMINGS and SEC POY DARIUS ACUFF JR., plus bigs 7'3 ADAY MARA and rim-protector JAYDEN QUAINTANCE. KEY OFFSEASON DATES: NBA Finals Game 1 June 3 (3 days) · Draft Night June 23 (23 days) · Hield $9.4M full-guarantee trigger June 25 (25 days) · Kuminga $24.3M team-option call by June 29 (29 days) · McCollum UFA market opens June 30 6 PM ET (30 days) · Free agency moratorium July 6.",
};
...
export const NEWS_DIGEST = {
  generatedAt: "2026-05-31T13:30:00Z",
  summary:
    "OFFSEASON — Sunday May 31. THE FRESH NEWS: THE WEST HAS A CHAMPION. San Antonio won Game 7 of the Western Conference Finals 111-103 over Oklahoma City on Saturday May 30, dethroning the defending-champion Thunder and reaching the NBA Finals for the first time since 2014 (NBA.com / ESPN / CBS Sports / NBC Sports / KSAT, May 30-31) — VICTOR WEMBANYAMA finished with 22 points and 7 rebounds, Julian Champagnie hit six threes for 20, and Stephon Castle added 16 as SGA and the Thunder could not solve San Antonio at home. The Spurs now travel to face the NEW YORK KNICKS — the same team that ended Atlanta's season in six — to open the Finals ON THE ROAD on Wednesday June 3. ATL CAP ANGLE: with OKC now eliminated, the Thunder's offseason math around ISAIAH HARTENSTEIN's ~$28.5M team option reopens, but most reporting still expects Oklahoma City to keep its starting center, leaving Atlanta's 'Hartenstein dream' a long shot. HAWKS FRONT OFFICE: the Saleh-to-President-of-Basketball-Operations promotion (Wed May 27, long-term extension) holds as the franchise headline, with a 'massive,' eight-figure QUIN SNYDER extension still expected before Draft Night. AWARDS SWEEP COMPLETE: Jalen Johnson All-NBA Third Team, Nickeil Alexander-Walker Most Improved, Dyson Daniels All-Defensive Second Team. The June cap calendar tightens — Finals Game 1 June 3 (3 days), Draft Night June 23 (23 days), Hield's $9.4M full-guarantee trigger June 25 (25 days), Kuminga's $24.3M team-option call by June 29 (29 days), and the McCollum-led free-agency market opening June 30 6 PM ET (30 days). McCollum retention stays the priority (2yr/$35-40M the consensus range); the trade board still runs through JAYLEN BROWN, Cameron Johnson, Risacher and Kispert. DRAFT: with the No. 8 pick 23 days out, defensive-anchor big JAYDEN QUAINTANCE and SEC Player of the Year guard DARIUS ACUFF JR. sit on Atlanta's board alongside Mikel Brown Jr., Kingston Flemings and 7'3 Aday Mara.",
  keyTopics: [
    {
    ...
    {
      title: "Draft Board Widens: Quaintance and Acuff Jr. Join the No. 8 Conversation With Mikel Brown Jr., Flemings, Mara",
      detail:
        "Atlanta picks No. 8 after the May 10 lottery, and the post-combine board has broadened beyond the pure-guard read (Peachtree Hoops / Bleacher Report / Yahoo Sports / CBS Sports / NBA.com Consensus / The Ringer, May 23-29). Two fresh names have climbed Atlanta's board: JAYDEN QUAINTANCE, a 6'9 / 253 defensive-anchor big with a 7'5+ wingspan billed as an All-Defensive-ceiling rim protector (with real knee-injury risk), addresses the frontcourt and interior defense the Knicks exposed; and DARIUS ACUFF JR., the SEC Player of the Year who averaged 23.5 PPG as a freshman, profiles as a high-usage face-of-offense guard. They join the standing trio — CBS Sports projects Louisville guard MIKEL BROWN JR. to Atlanta, NBA.com's consensus pairs him with 7'3 center ADAY MARA, and The Ringer prefers Houston guard KINGSTON FLEMINGS as the best defender of the group. Atlanta holds Nos. 8, 23 and 57; the draft runs June 23-24 at Barclays Center — 23 days out.",
      category: "general",
    },
    {
...
export const ISSUE = {
  date: "2026-05-31",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
