// ─── Atlanta Hawks Player Data (2025-26 Season · Updated Wednesday May 20, 2026 — OFFSEASON · ECF G1 INSTANT-CLASSIC: KNICKS 115, CAVALIERS 104 (OT) — Brunson 38 pts led a 44-11 Knicks run across the last 7:40 of regulation + OT to erase a 22-point 4Q deficit (one of the greatest comebacks in NBA playoff history); Mitchell 29/career-high 6 stl for CLE; NY leads series 1-0; Game 2 Thursday May 21, 8 PM ET MSG on ESPN · WCF G1 ALSO 2OT: Spurs 122, Thunder 115 in OKC — Wemby 41 pts / 24 reb / 3 blk, Caruso 31 off bench, Jalen Williams 26 · Saleh-to-76ers Day 9: REPORTING HARDENS — Sixers have CONCEDED Saleh is OFF THE BOARD (Liberty Ballers / Dallas Hoops Journal / Yahoo Sports May 19-20) · Hawks pre-draft workouts ongoing (Bidunga, Onyenso, Suder, Uzan for No. 57); No. 8 mock board narrows to Burries / Flemings / Mara / Brown Jr. · Cam Johnson trade thread STILL OPEN (DEN must move salary for Watson re-sign) · 34 days to Draft Night Jun 23) ─
...
export const PLAYERS = [
  ...
  },
  {
    ...
    recentNotes: "WEDNESDAY MAY 20 (post ECF G1: Knicks 115-104 OT comeback over Cavaliers; Game 2 Thursday at MSG) — Series ended with the rotation slot under question after a tough R1 showing. Hollinger explicitly names Kispert (with Risacher) as the likeliest summer trade chip; cap notes show $14.6M next season then a $17.4M cap hit in 27-28. Salary-matching utility in any Jaylen Brown framework is real — the No. 8 pick plus Kispert plus Hield's $9.4M would clear the $57M Brown number per Hoops Rumors / Boston.com (May 10-11). Regular season line of 9.6/2.4/1.3 on 40.2% from three in 40 games (8 starts) was the post-trade Hawks portion.",
  ...
  },
  {
    ...
    recentNotes: "WEDNESDAY MAY 20 (post ECF G1: Knicks 115-104 OT comeback over Cavaliers; Game 2 Thursday at MSG) — Missed the entire first round of the playoffs after the Apr 1 right high-ankle sprain (Heavy/CBS, Apr 24). UFA per Bleacher Report cap notes. Offseason story is whether ATL re-signs the third center or pivots to the lottery picks (May 10) or to Hartenstein-tier FA money for help up front; the Hartenstein chase (per Soaring Down South 'top free-agency frontcourt target', May 11) directly competes with re-signing Landale.",
    playoffStats: null,
    playoffSeries: null,
    minutesTrend: null,
...
export const NEXT_GAME = {
  ...
  broadcast: "ABC / ESPN",
  seriesContext: "WEDNESDAY MAY 20 — LAST NIGHT'S HEADLINE: KNICKS 115, CAVALIERS 104 (OT) at Madison Square Garden in ECF GAME 1 — one of the greatest comebacks in NBA playoff history. The Cavaliers led 93-71 with 7:52 to play; the Knicks closed regulation and overtime on a 44-11 run to flip the game. JALEN BRUNSON 38 pts (15-of-29) led the Knicks; Karl-Anthony Towns 23/9, OG Anunoby 23 (4-of-6 from three), Mikal Bridges 23. CAVS: Donovan Mitchell 29 pts with a CAREER-HIGH 6 STEALS — Cleveland shot 22% over the last 12:40. Knicks lead the series 1-0; GAME 2 THURSDAY MAY 21, 8 PM ET at MSG on ESPN (ESPN / amNewYork / CBS Sports / NBA.com May 19-20). KEY TAKEAWAYS: NY now 6-1 at home in the playoffs; the late-game shotmaking thesis (Brunson playmaking + OG/Bridges spacing + KAT screen + roll) flipped 'two stars in their primes' (Mitchell + Mobley) for a night. ATL angle: Knicks remain the team that buried Atlanta in 6 (Apr 30 historic 140-89 Game 6 now 20 days old). WCF GAME 1 ALSO 2OT: VICTOR WEMBANYAMA dropped 41 pts / 24 reb / 3 blocks (just the second 40-25 game in playoff history) as SAN ANTONIO 122, THUNDER 115 (2OT) in OKC; ALEX CARUSO 31 off the bench, JALEN WILLIAMS 26 for OKC. Spurs lead WCF 1-0 (ESPN / NBC Insider May 19-20). SALEH-TO-76ERS THREAD NOW DAY 9 (Tue May 12-Wed May 20): THE REPORTING HAS HARDENED — Liberty Ballers 'Schlenk, Redden Among Execs Linked To Sixers Job' (May 19) and the broader May 19-20 cycle (Dallas Hoops Journal / Yahoo Sports / Hoops Rumors) now report the Sixers HAVE CONCEDED Saleh will not be available — the Hawks' permission-gate was the wall; HBSE's BOB MYERS continues to run the Sixers search in the interim. New names floated for the Sixers PBO chair: TRAVIS SCHLENK (former Hawks GM!), Bryan Redden, Trajan Langdon (DET), Tim Connelly (MIN). PRE-DRAFT WORKOUTS continue at the Hawks practice facility — Bidunga (Kansas, Big 12 DPOY), Onyenso (Virginia), Suder (Miami OH), Uzan (Houston) for No. 57 looks; more visits expected before Draft Night (34 days out). NO. 8 BOARD has narrowed post-combine: Brayden BURRIES (Arizona, 16.1 PPG) still Hollinger's pick; KINGSTON FLEMINGS the combine athleticism riser; ADAY MARA (7'3\"/9'9\" reach) the rim-protection pick; MIKEL BROWN JR. the post-combine Pro-Day shooting surge; Tre Johnson, Yaxel Lendeborg the other realistic ATL board names. ESPN's Jeremy Woo post-combine mock has Mara to ATL at 8. SI onsi May 20 floats a trade-DOWN scenario (load multiple picks). CAMERON JOHNSON trade thread STILL OPEN — Denver remains forced to clear money for Peyton Watson's RFA re-sign, with Cam Johnson labeled their 'most likely' trade candidate (Heavy / SI Nuggets / Basketnews May 13-20); ATL one of three named suitors with Pacers and Lakers. JAYLEN BROWN trade rumors hold steady simmer (Mannix on 98.5 / Boston.com / Hoops Rumors May 10-20); Marietta, GA native; Hawks structurally fit but Boston's primary target is reportedly Giannis. KEY OFFSEASON DATES: Hield $9.4M full-guarantee trigger June 25 (36 days) · Kuminga $24.3M team-option call by June 29 (40 days) · Draft Night June 23 (34 days) · McCollum UFA market opens June 30 6 PM ET (41 days) · Free agency moratorium July 6.",
};
...
export const NEWS_DIGEST = {
  ...
  summary:
    "OFFSEASON — Wednesday May 20. LAST NIGHT WAS AN INSTANT-CLASSIC ECF GAME 1: the New York KNICKS erased a 22-POINT 4TH-QUARTER DEFICIT and beat the Cleveland Cavaliers 115-104 in overtime at MSG — one of the greatest comebacks in NBA playoff history. Cleveland led 93-71 with 7:52 to play; the Knicks closed regulation and overtime on a 44-11 run. JALEN BRUNSON dropped 38 PTS (15-of-29 shooting) with KAT 23/9, OG Anunoby 23 (4-of-6 from three), and Mikal Bridges 23. The Cavaliers — playing on a 48-hour turnaround from Sunday's Game 7 — shot 22% over the last 12:40. DONOVAN MITCHELL had 29 PTS and a CAREER-HIGH 6 STEALS in the loss (ESPN / amNewYork / CBS Sports / NBA.com / Yahoo Sports May 19-20). Knicks lead the series 1-0; GAME 2 IS THURSDAY MAY 21 AT 8 PM ET AT MSG ON ESPN. WESTERN CONFERENCE FINALS ALSO OPENED LAST NIGHT — and ALSO went to double overtime: SAN ANTONIO SPURS 122, OKC THUNDER 115 (2OT) in OKC. VICTOR WEMBANYAMA dropped 41 PTS, 24 REB, 3 BLK (the second 40-25 game in NBA playoff history); ALEX CARUSO posted 31 off the bench for OKC, JALEN WILLIAMS 26. The Spurs lead the WCF 1-0 (ESPN / NBC Insider / NBA.com May 19-20). For Atlanta the Knicks are the team that buried the Hawks in six (the historic 140-89 Game 6 now 20 days old). SALEH-TO-76ERS THREAD NOW DAY 9 (Tue May 12-Wed May 20): THE REPORTING HAS HARDENED OVERNIGHT — multiple Tuesday-Wednesday reports (Liberty Ballers 'Schlenk, Redden Among Execs Linked To Sixers Job' May 19 / Dallas Hoops Journal / Yahoo Sports / Hoops Rumors May 19-20) now report the SIXERS HAVE CONCEDED Saleh will not be available — the Hawks' permission-gate was the wall, and the Sixers have moved on. New names being floated for the Sixers PBO chair: TRAVIS SCHLENK (former Hawks GM!), Bryan Redden, Trajan Langdon (DET), Tim Connelly (MIN), with HBSE's Bob Myers continuing to run the Sixers search in the interim. Saleh stays in Atlanta with the No. 8 pick in hand and a full offseason runway. PRE-DRAFT WORKOUTS continue at the Hawks practice facility: Flory Bidunga (Kansas, Big 12 DPOY, 13.3/9.0/2.6 blk), Ugonna Onyenso (Virginia, projected top shot-blocker), Peter Suder (Miami OH wing), Milos Uzan (Houston, 3.08 A/TO, led Cougars in minutes) — the first confirmed group, calibrated for No. 57. More visits expected before the June 23 draft. POST-COMBINE NO. 8 BOARD as of Wed May 20: Hollinger still has Brayden BURRIES (Arizona, 16.1 PPG); ESPN's Jeremy Woo's updated mock has 7'3 ADAY MARA sneaking in at 8 (Bleacher Report May 19 backs the rim-protection case — 'Mara may have a better chance to make the team immediately tougher to play against'); KINGSTON FLEMINGS the post-combine athleticism riser; MIKEL BROWN JR. the post-combine Pro-Day shooting surge; Tre Johnson, Yaxel Lendeborg, Darius Acuff Jr. round out realistic ATL boards. SI onsi's post-combine 'trade-DOWN' mock has Atlanta moving back from No. 8 to load multiple picks. CAMERON JOHNSON trade thread STILL OPEN — no trade executed, but Denver is forced to move salary to re-sign restricted free agent Peyton Watson, and Cam Johnson (54 GP / 12.2 PPG / $23.5M expiring) remains the Nuggets' 'most likely' trade candidate per SI Nuggets / Heavy / Basketnews / NuggLove May 18-20; Atlanta one of three named suitors alongside Pacers and Lakers. JAYLEN BROWN trade rumors hold a steady simmer (Mannix on 98.5 / Boston.com / Newsweek / Hoops Rumors May 10-20); Brown grew up in Marietta GA; Hawks structurally a fit; Boston's primary target is reportedly Giannis Antetokounmpo with Brown as the centerpiece. CJ McCOLLUM FREE-AGENCY RETENTION holds as the offseason priority — HoopsHype / TheRX / Bleacher Report / Heavy frame ~2yr/$35-40M (slightly above the mid-level) as the fair range, with McCollum confirming 'productive conversation' with the Hawks front office and mutual interest in a return; Bulls and Nets the cap-room suitor risks. CAP/CONTRACT GATES: Hield $9.4M full-guarantee trigger June 25 (36 days) · Kuminga $24.3M team-option call by June 29 (40 days) · Draft Night June 23 (34 days) · McCollum UFA market opens June 30 6 PM ET (41 days) · Free agency moratorium July 6.",
  keyTopics: [
    {
      title: "LAST NIGHT — ECF GAME 1 INSTANT-CLASSIC: Knicks 115, Cavaliers 104 (OT) — Brunson 38, 22-Pt Comeback for the Ages",
      detail:
        "Tuesday May 19 at Madison Square Garden — ONE OF THE GREATEST COMEBACKS IN NBA PLAYOFF HISTORY. The Cavaliers led 93-71 with 7:52 to play in regulation; the Knicks closed the game on a 44-11 run across regulation and overtime to win 115-104 and steal home-court (ESPN final 'Knicks 115-104 Cavaliers' / amNewYork 'Knicks overturn 22-point 4th-quarter hole' / CBS Sports 'team of destiny' / NBA.com 'Knicks win with miraculous comeback' / Yahoo Sports gametracker, May 19-20). JALEN BRUNSON 38 PTS (15-of-29 FG) led the charge; KARL-ANTHONY TOWNS 23/9, OG ANUNOBY 23 (4-of-6 from three), MIKAL BRIDGES 23 the supporting cast. DONOVAN MITCHELL had 29 PTS and a CAREER-HIGH 6 STEALS in the loss; the Cavaliers shot 22% over the last 12:40. Cleveland — playing on a 48-hour turnaround from Sunday's Game 7 — ran out of legs in the clutch and missed 18 of their last 21 shots. Knicks now 6-1 at home in the playoffs and lead the ECF 1-0; the franchise has not been to the Finals since 1999. GAME 2 THURSDAY MAY 21, 8 PM ET at MSG on ESPN. ATL angle: the Knicks are the team that buried the Hawks in 6 (the historic 140-89 Apr 30 Game 6 now 20 days old) — Daniels' Game 6 ejection is fully in the rearview.",
      category: "games",
    },
    {
      title: "LAST NIGHT — WCF GAME 1 ALSO 2OT: Spurs 122, Thunder 115 — Wembanyama 41/24/3 the Headline",
      detail:
        "Tuesday May 19 at Paycom Center: visiting SAN ANTONIO upset the No. 1 seed Oklahoma City 122-115 in DOUBLE OVERTIME to grab Game 1 of the Western Conference Finals (ESPN 'top moments as Spurs defeat Thunder in Game 1 classic' / NBC Insider / NBA.com WCF central / news9.com, May 19-20). VICTOR WEMBANYAMA put up 41 PTS / 24 REB / 3 BLK — just the second 40-25 game in NBA playoff history. ALEX CARUSO posted 31 points off the bench for the Thunder, and Jalen Williams added 26; SGA had a heavy usage night that San Antonio's length (Wemby + Castle on-ball + Vassell switches) ultimately blunted. The Spurs lead the WCF 1-0 — first conference finals appearance since the 2014 championship season. The two ECF/WCF Game 1s both going to OT on the same night is a first in NBA Conference Finals history.",
      category: "games",
    },
    {
      title: "Saleh-to-76ers Thread — DAY 9: REPORTING HARDENS — 'Sixers Have Conceded' Saleh Is OFF the Board",
      detail:
        "WEDNESDAY MAY 20 — Day 9 of the storyline (Tue May 12-Wed May 20) and the reporting tone hardened OVERNIGHT. Multiple Tuesday-Wednesday reports (Liberty Ballers 'Schlenk, Redden Among Execs Linked To Sixers Job' May 19 / Dallas Hoops Journal 'Sources: Bob Myers Eyeing Onsi Saleh For Philadelphia 76ers Front Office Role' / Yahoo Sports 'Tracking the 76ers' search' / Hoops Rumors May 19-20) now report the SIXERS HAVE CONCEDED Saleh will not be available — the permission-gate from the Hawks was the wall, and Philadelphia has 'safe to consider his name off the board.' HBSE's Bob Myers continues to run the Sixers search in the interim. NEW NAMES FLOATED for the Sixers PBO chair: TRAVIS SCHLENK (former Hawks GM!), Bryan Redden, Trajan Langdon (DET), Tim Connelly (MIN). Saleh, who finished 2ND in 2026 NBA Executive of the Year voting, stays in Atlanta with the No. 8 pick in hand and a full offseason runway. Hawks still operating without a President of Basketball Operations; Saleh's bench remains scouting director Cody Toppert and assistant GM Landry Fields. ATL still lost its top draft evaluator earlier this month (Bryson Graham to Chicago, May 5) — that hole heading into Draft Night (34 days out) is the real outstanding issue.",
      category: "general",
    },
    {
      title: "TOMORROW (Thu May 21, 8 PM ET on ESPN): ECF Game 2 at MSG — Cavs Must Adjust After Historic Collapse",
      detail:
        "Game 2 of the Eastern Conference Finals tips Thursday May 21 at 8 PM ET at Madison Square Garden on ESPN, with the Knicks looking to extend their 1-0 series lead and the Cavaliers needing to bury the ghosts of the 44-11 run they surrendered in Game 1 (Heavy 'Knicks-Cavaliers Eastern Conference Finals Set' / NBA.com / ESPN playoffs page / fox8.com, May 19-20). KEY ADJUSTMENTS TO WATCH: Cleveland's late-game offense (Mitchell played 47 min in Game 1 and shot 0-of-7 in the 4Q/OT collapse — Harden 11/4/3 not enough); Kenny Atkinson's lineup choices after Mobley was overrun by KAT in stretches; whether Allen plays through the wrist soreness that limited him in Game 7. For NEW YORK: Brunson dropped 38 in Game 1 but spent extended runs of late game with switches off him — Anunoby's 23 may have been the swing factor as Mitchell tried to chase him through screens.",
      category: "games",
    },
    {
      title: "Cameron Johnson STILL the Nuggets' 'Most Likely' Trade Candidate — Hawks Lane Open as of Wed May 20",
      detail:
        "ONE WEEK into the strengthened thread and still NO TRADE EXECUTED as of Wed May 20 (Yardbarker '3 Realistic Cam Johnson Trade Suitors as Nuggets Rumors Swirl' / SI Nuggets 'Nuggets Offseason Preview' / Heavy 'Cam Johnson Top Trade Candidate' / NuggLove / FanSided / Basketnews May 13-20). DENVER's CAMERON JOHNSON remains the Nuggets' MOST LIKELY trade candidate of the offseason. Mechanics unchanged: Johnson is on a $23.5M expiring contract, and Denver must move salary to re-sign restricted free agent Peyton Watson — Cam Johnson or Christian Braun are the only realistic levers, and Johnson's expiring is the most-mobile dollar on the books. Johnson played just 54 games in 25-26 averaging 12.2 PPG (his lowest output since 2020-21) and shot poorly in the postseason; Yahoo Sports framed the MPJ-Cam Johnson trade as 'backfiring in a big way.' Atlanta's reported interest remains the cleanest of Saleh's three open wing-upgrade lanes — half-court shotmaking + 3-and-D, the exact profile Hollinger named as Atlanta's biggest R1 gap. Likely structure: ATL's four trade exceptions + a future first, OR salary-matching with Hield's $9.4M expiring and Kispert. Other named suitors per SI Nuggets 3-suitor piece: Pacers, Lakers, Warriors.",
      category: "trades",
    },
    {
      title: "COMBINE WRAP (Closed Sun May 17): Karaban Best Shooter, Flemings Best Athlete, Mara Best Measurement, Boozer the Pillar",
      detail:
