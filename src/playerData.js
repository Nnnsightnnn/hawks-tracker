...
export const ISSUE = {
  date: "2026-08-13",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 47,                                       // Issue number (offseason cadence)
  dateline: "ATLANTA · AUGUST 13, 2026",             // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 47 · AUGUST 2026 · ATL · USA",
  railLabel: "ISSUE 47 · AUG 13",
  ...
  coverImage: null,
  coverRibbon: "LAKERS PIVOT TO A MULTI-TEAM BUILD TO SHED BOTH VANDERBILT AND KNECHT AROUND ATLANTA · KUMINGA STILL UNSIGNED A MONTH-PLUS INTO FREE AGENCY · SIGN-AND-TRADE STILL THE ONLY PATH THROUGH ATLANTA · HAWKS SIT ~ $11.4M UNDER THE FIRST APRON AND WANT THE PICKS FIRST · GUEYE OUT · 17 CONTRACTS, LIMIT 15 · NEXT GAME OCT 5 VS MEMPHIS",
  coverStatusKicker: "OFFSEASON · DAY 96",          // top-right corner of cover
  coverStatusLine: "LAKERS CHASE A FACILITATOR TO OFFLOAD VANDERBILT AND KNECHT, THEN RAISE THE KUMINGA BID · KUMINGA STILL UNSIGNED, NO SUITOR AT HIS ~ $20M ASK · HAWKS ~ $11.4M UNDER THE FIRST APRON, WANT THE PICKS BEFORE ABSORBING VANDERBILT'S OPTION · PORTLAND-AS-FACILITATOR TALK IS PROPOSAL, NOT DEAL · GUEYE OUT · 17 CONTRACTS, LIMIT 15 · NEXT: PRESEASON, OCT 5", // {DAYS:id} resolves from KEY_DATES
