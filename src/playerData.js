...
export const NEWS_DIGEST = {
  ...
  summary:
    "ONE MORE GAME: ATLANTA'S SUMMER IS NOT OVER AFTER ALL. The Hawks close Las Vegas Summer League tonight against WASHINGTON at the Pavilion, 7 PM ET, a consolation finale for two teams that missed the four-team bracket. Atlanta arrives 5-1 overall (3-1 in Vegas) trying to wash out Thursday's 96-64 rout by Memphis, a game the Grizzlies broke open with a 21-0 opening burst and a 32-2 first quarter while Atlanta rested Kingston Flemings, Asa Newell, Zuby Ejiofor, Jacob Toppin, RayJ Dennis and Keshon Gilbert. Washington comes in 2-2 off back-to-back losses. The trade board moved overnight: the New York Post reported the Hawks are willing to execute the JONATHAN KUMINGA sign-and-trade with the Lakers around Jarred Vanderbilt (about $12.4M) plus LA's 2032 first-round swap, while other reporting insists Atlanta has never considered taking Vanderbilt's salary and is seeking more than the Lakers can offer. Both can be true, and Jake Fischer says the talks have lost momentum. Elsewhere: forward MOUHAMED GUEYE had surgery Tuesday on a fractured left foot and will be re-evaluated in three to four months, the 2026-27 preseason schedule is out (five games, Oct 5 vs Memphis through Oct 16 at Dallas), the roster still sits one over the 15-man limit, and New Orleans keeps insisting it must be blown away on TREY MURPHY III.",
  keyTopics: [
    {
      title: "Game Day: Hawks Close Vegas Tonight Against Washington in a Consolation Finale, 7 PM ET",
      detail:
        "Atlanta's summer has one more night in it. The Hawks meet the Wizards at the Pavilion on Saturday, July 18 at 7:00 PM ET in a consolation game for two teams that missed the four-team bracket (Bullets Forever / Fubo / NBA.com, Jul 17-18). Atlanta comes in 5-1 overall and 3-1 in Las Vegas after Thursday's 96-64 loss to Memphis, its only defeat of the summer. Washington is 2-2 and has dropped two straight, most recently 108-94 to the Clippers on Thursday. The watch list is short and specific: whether Kingston Flemings and Asa Newell return after being rested in the finale, and whether undrafted guard Kobe Johnson closes out a two-way audition that peaked with 30 points on 18 shots against Boston on Monday.",
      category: "games",
    },
    {
...
export const ISSUE = {
  date: "2026-07-18",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 28,                                       // Issue number (offseason cadence)
  dateline: "ATLANTA · JULY 18, 2026",              // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 28 · JULY 2026 · ATL · USA",
  railLabel: "ISSUE 28 · JULY 18",
  ...
  coverImage: null,
  coverRibbon: "ONE MORE NIGHT: HAWKS CLOSE VEGAS AGAINST WASHINGTON TONIGHT · 7 ET AT THE PAVILION · 5-1 SUMMER · KUMINGA TALKS LOSE MOMENTUM",
  coverStatusKicker: "OFFSEASON · DAY 76",          // top-right corner of cover
  coverStatusLine: "5-1 THIS SUMMER · 3-1 IN VEGAS · WIZARDS TONIGHT, 7 PM ET", // {DAYS:id} resolves from KEY_DATES
  backTagline: "Next issue: the Washington finale, Kobe Johnson's two-way case, and whether the Kuminga standoff finally breaks.",
};
