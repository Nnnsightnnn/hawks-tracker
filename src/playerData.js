...
export const NEXT_GAME = {
  ...
  broadcast: "ABC / ESPN",
  seriesContext: "MONDAY JUNE 1 — FRESH: A QUIN SNYDER EXTENSION IS NOW BEING CALLED 'INEVITABLE.' Marc Stein and Jake Fischer (The Stein Line) report a new deal for the Hawks head coach is regarded as inevitable around the league, with talks expected to move quickly now that the season is over and Onsi Saleh — the man negotiating it — is locked in as President of Basketball Operations (Stein Line / SI onsi / Yardbarker / RealGM / Peachtree Hoops, late May). Snyder, who has improved Atlanta's win total in each of his three seasons (culminating in 46 wins and the No. 6 seed), enters the final year of his deal in 2026-27; a 'massive,' eight-figure agreement is expected to land between now and the June 23 draft. FINALS TIP IN 2 DAYS: the San Antonio Spurs (62-20, home-court) host the New York Knicks (53-29) in Game 1 of the NBA Finals on WED JUNE 3, 8:30 PM ET on ABC at Frost Bank Center — a 1999 rematch, and the same Knicks team that ended Atlanta's season in six on Apr 30 (historic 140-89 Game 6). San Antonio reached its first Finals since 2014 by winning Game 7 of the WCF 111-103 at OKC on May 30. DRAFT BOARD: with the No. 8 pick 22 days out, 7'3 Michigan center ADAY MARA is 'gaining steam' — HoopsHype's Michael Scotto says rival execs expect Atlanta to target a point guard or Mara, and Brett Siegel's latest ClutchPoints mock sends Mara to Atlanta; Illinois guard KEATON WAGLER joins Mikel Brown Jr., Kingston Flemings and SEC POY Darius Acuff Jr. in the guard mix, and a trade-back is in play if guards fly off the board at 6 and 7. ATL CAP ANGLE: ISAIAH HARTENSTEIN's ~$28.5M option still likely stays in OKC (longshot for Atlanta). FRONT OFFICE: ONSI SALEH promoted GM→President of Basketball Operations on a long-term extension Wed May 27. AWARDS: JALEN JOHNSON All-NBA Third Team, NAW Most Improved, DANIELS All-Def 2nd. CJ McCOLLUM retention is the free-agency priority (~2yr/$35-40M consensus). JAYLEN BROWN and CAMERON JOHNSON trade threads remain open; RISACHER and KISPERT the likeliest summer trade chips per Hollinger. KEY OFFSEASON DATES: NBA Finals Game 1 June 3 (2 days) · Draft Night June 23 (22 days) · Hield $9.4M full-guarantee trigger June 25 (24 days) · Kuminga $24.3M team-option call by June 29 (28 days) · McCollum UFA market opens June 30 6 PM ET (29 days) · Free agency moratorium July 6.",
};
...
export const NEWS_DIGEST = {
  ...
  summary:
    "OFFSEASON — Monday June 1. THE FRESH NEWS: A QUIN SNYDER EXTENSION IS NOW BEING CALLED 'INEVITABLE.' Marc Stein and Jake Fischer (The Stein Line) report a new contract for the Hawks head coach is regarded as inevitable around the league, with talks expected to move quickly now that the season is over and Onsi Saleh — promoted to President of Basketball Operations on a long-term extension May 27 — is locked in as the executive negotiating it (Stein Line / SI onsi / Yardbarker / RealGM / Peachtree Hoops, late May). Snyder, who has lifted Atlanta's win total in all three of his seasons (46 wins, No. 6 seed this year), enters the final year of his deal in 2026-27; a 'massive,' eight-figure agreement is expected to land between now and the June 23 draft. ON THE COURT: the NBA Finals tip in two days — the San Antonio Spurs (62-20, home-court) host the New York Knicks (53-29) in Game 1 on Wednesday June 3, 8:30 PM ET on ABC at Frost Bank Center, a 1999 rematch and the same Knicks team that eliminated Atlanta in six. DRAFT: with the No. 8 pick 22 days out, 7'3 Michigan center ADAY MARA is gaining steam — HoopsHype's Michael Scotto says rival execs expect Atlanta to target a point guard or Mara, and Brett Siegel's latest ClutchPoints mock sends Mara to Atlanta; Illinois guard Keaton Wagler joins Mikel Brown Jr., Kingston Flemings and SEC POY Darius Acuff Jr. in the guard mix, with a trade-back possible if guards go at 6 and 7. CAP CALENDAR: Finals Game 1 June 3 (2 days), Draft Night June 23 (22 days), Hield's $9.4M full-guarantee trigger June 25 (24 days), Kuminga's $24.3M team-option call by June 29 (28 days), and the McCollum-led free-agency market opening June 30 6 PM ET (29 days). McCollum retention stays the priority (~2yr/$35-40M the consensus range); the trade board still runs through JAYLEN BROWN, Cameron Johnson, Risacher and Kispert. AWARDS SWEEP: Jalen Johnson All-NBA Third Team, Nickeil Alexander-Walker Most Improved, Dyson Daniels All-Defensive Second Team.",
  keyTopics: [
    {
    ...
    {
      title: "Draft Board: Aday Mara 'Gaining Steam' at No. 8 as Scotto Floats PG-or-Mara; Trade-Back in Play",
      detail:
        "With the No. 8 pick 22 days out, the latest read tilts toward 7'3 Michigan center ADAY MARA: HoopsHype's Michael Scotto reports rival execs expect Atlanta to target either a point guard or Mara, and Brett Siegel's newest ClutchPoints mock sends Mara to the Hawks — addressing the size and interior defense the Knicks exposed (HoopsHype / ClutchPoints / SI onsi / Bleacher Report / Peachtree Hoops, May 23-31). The guard lane stays crowded: Louisville's MIKEL BROWN JR., Houston defender KINGSTON FLEMINGS, SEC Player of the Year DARIUS ACUFF JR. (23.5 PPG as a freshman) and newly-surfaced Illinois guard KEATON WAGLER are all in the mix, while defensive-anchor big JAYDEN QUAINTANCE (6'9 / 253, 7'5+ wingspan, knee-injury risk) remains on the board. Atlanta could also trade back: the front office is expected to field calls on the pick if guards fly off the board at 6 and 7. The Hawks hold Nos. 8, 23 and 57; the draft runs June 23-24 at Barclays Center.",
      category: "general",
    },
    {
...
export const ISSUE = {
  date: "2026-06-01",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 8,                                        // Issue number (offseason cadence)
  dateline: "ATLANTA · MAY 31, 2026",               // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 08 · MAY 2026 · ATL · USA",
  railLabel: "ISSUE 08 · MAY 31",
  coverStarId: 1,                                   // PLAYERS[id] for the cover portrait
  coverRibbon: "EXCLUSIVE · COVER STAR · JALEN JOHNSON",
  coverStatusKicker: "OFFSEASON · DAY 31",          // top-right corner of cover
