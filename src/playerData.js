...
export const NEXT_GAME = {
  ...
  broadcast: "ABC / ESPN",
  seriesContext: "SATURDAY JUNE 20, 3 DAYS TO THE DRAFT. THE LIVE THREAD IS THE GIANNIS MARKET AND ATLANTA'S PLACE IN IT, and Saturday's read has Milwaukee closing on a framework while it shops for a third team: multiple reports say the Bucks are 'comfortable' with MIAMI's package built around Tyler Herro, Kel'el Ware and Jaime Jaquez Jr. plus draft capital, but want a THIRD TEAM to absorb salary, and Marc Stein reports DETROIT has emerged as the likeliest facilitator to take on Herro (ClutchPoints / CBS Sports / SI onsi / The Stein Line, Jun 18-20). Miami stays the clear frontrunner and Giannis's reported preference, with Boston the only other team in the race, and a decision is still expected on or before the June 23 draft. Atlanta's stake holds: if Boston wins the race it would likely move JAYLEN BROWN (plus picks and a role player or two such as Hauser or Pritchard); one insider says a Brown deal is 'nearing clarity' with the Hawks floated as a possible third team, and Marc Stein lists the Hawks, Rockets and Trail Blazers as Brown suitors. The hurdle is Brown's three years and roughly $183M, and POBO Onsi Saleh holds this roster is 'not one player away.' CAP CALENDAR: the Hawks 'hope to re-sign CJ McCollum' near $20M per year, and Atlanta is weighing Jonathan Kuminga's $24.3M option, with Hawks and Kuminga reportedly both open to a longer multi-year deal at a lower first-year number. THE BACKDROP: the New York Knicks are NBA champions, the team that ended Atlanta's season, closing San Antonio 94-90 in Game 5 to take the Finals 4-1, JALEN BRUNSON 45 and Finals MVP. DRAFT BOARD: mocks split between Louisville PG MIKEL BROWN JR. and Houston PG KINGSTON FLEMINGS at No. 8, with 7'3 ADAY MARA the size-need answer if Atlanta trades down; league sources say the Hawks will happily field offers for No. 23. KEY OFFSEASON DATES: Draft Night June 23 (3 days) · Hield $9.66M full-guarantee trigger June 25 (5 days) · Kuminga $24.3M team-option call by June 29 (9 days) · McCollum UFA market opens June 30 6 PM ET (10 days) · Free agency moratorium July 6.",
};
...
export const NEWS_DIGEST = {
  generatedAt: "2026-06-20T13:30:00Z",
  summary:
    "OFFSEASON, Saturday June 20, three days to the draft. THE LIVE THREAD is still the Giannis Antetokounmpo market, and Saturday's read has Milwaukee closing on a framework while it shops for a third team. Multiple reports say the Bucks are 'comfortable' with Miami's package centered on Tyler Herro, young big Kel'el Ware and wing Jaime Jaquez Jr. plus draft capital, but want a third team to absorb salary, and Marc Stein reports DETROIT has emerged as the likeliest facilitator to take on Herro. Miami remains the clear frontrunner and Giannis's reported preferred destination, with Boston the only other team in the race; resolution is still expected on or before the June 23 draft, the unofficial deadline co-owner Jimmy Haslam set. The Hawks' stake is the Boston lane: a Celtics package for Giannis would likely be built around JAYLEN BROWN, and one insider says a Brown deal is 'nearing clarity' with Atlanta floated as a possible third team. Eric Pincus's latest three-team concept routes Brown to Atlanta and Giannis to Boston, and Marc Stein still lists the Hawks, Rockets and Trail Blazers as Brown's suitors. The hurdles are unchanged: Brown, who turns 30 in October, is owed three years and roughly $183M, the math forces Atlanta to package picks plus filler, and POBO ONSI SALEH keeps insisting this roster is 'not one player away.' CAP CALENDAR: the Hawks 'hope to re-sign CJ McCollum,' projecting him near $20M per year (HoopsHype), and reporting points to mutual interest with Jonathan Kuminga on a longer multi-year deal at a lower first-year number rather than a straight pickup of his $24.3M option. ON THE BOARD: mocks split between Louisville PG MIKEL BROWN JR. and Houston PG KINGSTON FLEMINGS at No. 8, with 7'3 ADAY MARA the size-need answer if Atlanta trades down, and the Kings at No. 7 reportedly view Darius Acuff Jr. as their floor; the front office will field offers for No. 23. THE BACKDROP: the New York Knicks are NBA champions (Brunson 45, Finals MVP, closed San Antonio 4-1), the same team that bounced the Hawks in Round 1. KEY DATES: Hield June 25 (5 days), Kuminga June 29 (9 days), McCollum-led free agency June 30 6 PM ET (10 days).",
  keyTopics: [
    {
...
export const ISSUE = {
  date: "2026-06-20",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  ...
  coverStatusKicker: "OFFSEASON · DAY 51",          // top-right corner of cover
