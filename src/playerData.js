...
export const NEXT_GAME = {
  ...
  broadcast: "—",
  seriesContext: "SUNDAY JUNE 28, decision week is live and today is the first gate. TODAY IS BUDDY HIELD'S DEADLINE: after Atlanta and Hield mutually pushed his guarantee date back from Jun 25, the new date is TODAY, Jun 28 (Brad Rowland / Hoops Rumors), so the Hawks must decide by end of day whether to lock in his $9.66M salary or waive him down to the $3M already guaranteed. TOMORROW IS KUMINGA: his $24.3M team option must be called by Monday Jun 29 (1 day out), with a decline-and-re-sign the reported lean (ClutchPoints / HoopsHype) over a straight pickup. THEN THE MARKET: free agency opens Tuesday Jun 30 at 6 PM ET (2 days out); moratorium ends July 6. CENTER BOARD SHIFTS: Isaiah Hartenstein is OFF the board, re-signing with OKC (3yr, ~$75M), so Atlanta's frontcourt hunt now centers on a trade, with Milwaukee's MYLES TURNER the name to watch (Fischer / Stein) though the Bucks aren't actively shopping him. SUMMER LEAGUE SET: Atlanta opens Salt Lake City July 4 vs Utah (also July 6, 7), then opens Las Vegas July 9 on ESPN2; Flemings, Ejiofor and Veesaar headline. DONE WORK holds: AARON WIGGINS from OKC for two seconds, GUEYE'S $2.41M option picked up, CJ McCOLLUM re-signed (1yr, ~$21M), and Quin Snyder extended Jun 8.",
};
...
export const NEWS_DIGEST = {
  ...
  summary:
    "OFFSEASON, Sunday June 28, and decision week is live. Today is the first gate: Buddy Hield's guarantee deadline, pushed back from June 25, lands TODAY (Brad Rowland), so Atlanta must decide by end of day whether to lock in his $9.66M salary or waive him down to the $3M already guaranteed and reclaim a roster spot and most of that money. The clock only tightens from here: Jonathan Kuminga's $24.3M team option must be called by Monday June 29 (1 day out), with a decline-and-re-sign the reported lean over a straight pickup (ClutchPoints, HoopsHype); the free-agency market opens Tuesday June 30 at 6 PM ET (2 days out); and the moratorium ends July 6. The center board moved over the weekend: Isaiah Hartenstein re-signed with Oklahoma City (three years, roughly $75M) and is off Atlanta's menu, leaving the frontcourt hunt to the trade market, where Milwaukee's Myles Turner is now the name to watch even though the Bucks are not actively shopping him. Summer League is set, Atlanta opens Salt Lake City July 4 against Utah and opens Las Vegas July 9 on ESPN2, with Kingston Flemings, Zuby Ejiofor and Henri Veesaar headlining. Atlanta's done work holds: AARON WIGGINS acquired from OKC for two seconds, Gueye's $2.41M option picked up, CJ McCOLLUM re-signed at one year and roughly $21M, and Quin Snyder extended on June 8. POBO Onsi Saleh keeps preaching patience: not one player away, guard the cap room, and find the next Nickeil.",
  keyTopics: [
    {
      title: "FRESH: Today Is Buddy Hield's Guarantee Deadline, Atlanta Must Decide Whether to Keep or Waive Him by End of Day",
      detail:
        "The first gate of decision week is TODAY. After Atlanta and Buddy Hield mutually agreed to push his guarantee date back from June 25, the new deadline is Sunday June 28, Brad Rowland reported (Hoops Rumors / Yahoo Sports / ClutchPoints, Jun 25-26), so the Hawks must decide by end of day whether to lock in his $9.66M salary for 2026-27 or waive him down to the $3M already guaranteed and reclaim a roster spot plus roughly $6M. The case for waiving is a crowded backcourt: Hield barely played after arriving in the Kristaps Porzingis deal, and Atlanta has since added Aaron Wiggins and drafted Kingston Flemings at No. 8. The case for keeping is flexibility, a reliable bench shooter or a movable expiring useful as salary filler in a larger trade, which is exactly why both sides bought more time rather than cutting bait. Whatever Atlanta decides feeds directly into the bigger week ahead.",
      category: "trades",
    },
    {
      title: "TOMORROW: Kuminga's $24.3M Team Option Due Monday, Reporting Leans to a Decline-and-Re-Sign Over a Straight Pickup",
      detail:
        "Atlanta's biggest cap call comes Monday June 29, now 1 day out. ClutchPoints and HoopsHype report mutual interest between the Hawks and Jonathan Kuminga in working out a new long-term deal, the path Jake Fischer has favored: decline the $24.3M 2026-27 team option, then re-sign him at a lower first-year number (he is not extension-eligible, so a decline is the mechanism). John Hollinger of The Athletic still predicts a straight decline, valuing the 23-year-old near $9.4M in his BORD$ model, well short of $24.3M, and BlueManHoop frames the CJ McCollum re-signing as a fresh squeeze on the money beneath the decision. Michael Scotto adds that Atlanta has canvassed Kuminga's trade value around the league, but a return next season remains a real possibility. The alternatives are exercising the option as a tradable expiring or letting him walk for nothing. Kuminga averaged 14.9 points, 5.1 rebounds and 2.2 assists across 16 Hawks regular-season games and 13.4 a night in the Knicks series.",
      category: "trades",
    },
    {
