...
export const NEXT_GAME = {
  ...
  broadcast: "ABC / ESPN",
  seriesContext: "THURSDAY JUNE 11: KNICKS 3-1 AFTER THE LARGEST COMEBACK IN FINALS HISTORY; HAWKS' DRAFT GUARD SURVEY ROLLS ON. THE MORNING AFTER AT MSG: New York erased a 29-point halftime deficit to win Game 4 107-106 on OG ANUNOBY's tip-in with 1.2 seconds left Wednesday night, the largest comeback in NBA Finals history (ESPN / CBS Sports). Anunoby finished with a playoff career-high 33 on 7-of-9 from three; Brunson added 31. San Antonio drilled a Finals-record 14 first-half threes and led 76-47 at the break, then managed just 30 second-half points on 8-of-39 shooting (20.5%). ATL angle: the Brunson-led Knicks that eliminated Atlanta in six on Apr 30 are now ONE WIN from the title. Game 5 is Saturday June 13 in San Antonio (8:30 PM ET, ABC). DRAFT INTEL HOLDS (ClutchPoints / Yahoo Jun 9; Peachtree Hoops mock roundup; Locked On Hawks draft pod Jun 11): Atlanta 'loves' Illinois PG KEATON WAGLER and Louisville PG MIKEL BROWN JR. at No. 8 and is also high on 7'3 ADAY MARA; B/R's Wasserman now projects Acuff, Wagler AND Brown Jr. all gone by 8, leaving Houston's KINGSTON FLEMINGS (who has worked out for the Hawks) or Mara as the realistic board. SNYDER'S multi-year extension (official Mon Jun 8) remains the franchise headline of the week. McCOLLUM retention stays priority one (~$29M room; 2yr/$35-40M the exec-consensus range). KEY OFFSEASON DATES: Finals Game 5 Saturday (SA) · Draft Night June 23 (12 days) · Hield $9.66M full-guarantee trigger June 25 (14 days) · Kuminga $24.3M team-option call by June 29 (18 days, decline-and-extend the expected path per Fischer) · McCollum UFA market opens June 30 6 PM ET (19 days) · Free agency moratorium July 6.",
};
...
export const NEWS_DIGEST = {
  ...
  summary:
    "OFFSEASON, Thursday June 11. THE COMEBACK: the Knicks erased a 29-point halftime deficit Wednesday night to beat San Antonio 107-106 on OG ANUNOBY's tip-in with 1.2 seconds left, the largest comeback in NBA Finals history, and now lead the series 3-1 (ESPN / CBS Sports). Anunoby scored a playoff career-high 33 on 7-of-9 from deep, Brunson added 31, and the Spurs followed a Finals-record 14 first-half threes (76 points) with a 30-point second half on 8-of-39 shooting. The ATL angle sharpens: the same Brunson-led Knicks team that eliminated the Hawks in six on Apr 30 is now one win from the franchise's first title since 1973, with Game 5 Saturday in San Antonio (8:30 PM ET, ABC). ON THE HAWKS BEAT (12 days to the draft): the board intel holds that Atlanta 'loves' Illinois's KEATON WAGLER and Louisville's MIKEL BROWN JR. at No. 8 with 7'3 ADAY MARA the size dark horse (ClutchPoints / Yahoo, Jun 9), but B/R's Jonathan Wasserman now projects Acuff, Wagler and Brown Jr. all off the board by 8, which would leave Houston's KINGSTON FLEMINGS (a confirmed Hawks workout visitor) or Mara as the live options; Locked On Hawks spent Thursday's episode on the guard tier, including riser EBUKA OKORIE. CAP CALENDAR: Hield's $9.66M full-guarantee trigger June 25 (14 days), Kuminga's $24.3M team-option call by June 29 (18 days, decline-and-extend the expected path per Jake Fischer), McCollum-led free agency opens June 30 6 PM ET (19 days); the McCollum re-sign stays priority one. The trade board still runs through JAYLEN BROWN, Risacher and Kispert.",
  keyTopics: [
    {
      title: "Largest Comeback in Finals History: Knicks Erase 29-Point Half, Win Game 4 107-106 on Anunoby's Tip-In, Lead 3-1",
      detail:
        "Instant history at the Garden. Down 76-47 at halftime Wednesday night, the Knicks stormed back to take Game 4 107-106 on OG ANUNOBY's tip-in with 1.2 seconds left, completing the largest comeback in NBA Finals history (ESPN / CBS Sports / FOX Sports, Jun 10-11). Anunoby poured in a playoff career-high 33 on 10-of-15 shooting (7-of-9 from three) and JALEN BRUNSON added 31, while San Antonio followed a Finals-record 14 first-half threes with a 30-point second half on 8-of-39 (20.5%) from the field. New York now leads the series 3-1 with Game 5 Saturday June 13 in San Antonio (8:30 PM ET, ABC). The Atlanta resonance is direct and a little raw: Anunoby hung 29 on the Hawks in the Game 6 elimination, and the Brunson-led team that ended Atlanta's season is now one win from the Knicks' first championship since 1973.",
      category: "games",
    },
    {
      title: "Fresh Board Intel: Hawks 'Love' Wagler and Mikel Brown Jr. at No. 8, With One Giant Catch",
      detail:
        "The clearest read yet on Atlanta's draft room, reported Tuesday June 9 by ClutchPoints and picked up by Yahoo Sports: the Hawks 'love' two point guards at No. 8, Illinois' KEATON WAGLER and Louisville's MIKEL BROWN JR. The catch: sources say the front office is ALSO high on 7'3 Michigan center ADAY MARA, the cleanest answer to the interior-size problem the Knicks series exposed, yet conversations with league personnel keep pointing to Atlanta favoring a guard to secure the backcourt long-term. Brown Jr.'s advanced playmaking, pace control and three-level scoring remain the most popular Atlanta fit in mocks; Wagler is profiled by SI's onsi as having 'the tools to be the franchise guard.' Rival execs still expect either a point guard or Mara at 8, and a trade-down to grab Mara or Morez Johnson Jr. plus extra capital stays in play if guards fly off the board early (HoopsHype / SI onsi / ClutchPoints, Jun 7-9). The newest wrinkle: B/R's Jonathan Wasserman projects Acuff, Wagler AND Brown Jr. all gone by No. 8 in his latest mock, with Houston's Kingston Flemings (a confirmed Hawks workout visitor) still on the board, and slots Mara to Atlanta (Bleacher Report / Peachtree Hoops mock roundup, Jun 10-11). Draft Night is June 23, 12 days out.",
      category: "general",
    },
    {
...
export const ISSUE = {
  date: "2026-06-11",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 11,                                       // Issue number (offseason cadence)
  dateline: "ATLANTA · JUNE 11, 2026",              // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 11 · JUNE 2026 · ATL · USA",
  railLabel: "ISSUE 11 · JUNE 11",
  coverStarId: 1,                                   // PLAYERS[id] for the cover portrait
  coverRibbon: "EXCLUSIVE · COVER STAR · JALEN JOHNSON",
  coverStatusKicker: "OFFSEASON · DAY 41",          // top-right corner of cover
