...
export const NEXT_GAME = {
  ...
  broadcast: "ABC / ESPN",
  seriesContext: "THURSDAY JUNE 4 — THE KNICKS DREW FIRST BLOOD IN THE FINALS. New York beat San Antonio 105-95 in Game 1 of the NBA Finals on Wednesday night at Frost Bank Center, with JALEN BRUNSON scoring 30 — 13 of them in the fourth quarter — as the Knicks erased a 14-point second-half deficit on the Spurs' floor (NBA.com / CBS Sports / Yahoo Sports, Jun 3-4). Victor Wembanyama called his own Game 1 'bad' per CBS Sports' winners-and-losers ledger; Game 2 is FRIDAY JUNE 5, 8:30 PM ET on ABC, again in San Antonio. The ATL angle is unavoidable: this is the same Knicks team that ended Atlanta's season in six on Apr 30 (historic 140-89 Game 6), now one of New York's first Finals wins since 1999. HAWKS FRONT BURNER: A QUIN SNYDER EXTENSION IS STILL CALLED 'INEVITABLE' — Marc Stein and Jake Fischer (The Stein Line) report a new deal is regarded as inevitable around the league, expected 'in the same ballpark' as other proven NBA head coaches, with President of Basketball Operations Onsi Saleh (promoted + extended May 27) negotiating it; a 'massive,' eight-figure agreement is expected before the June 23 draft. DRAFT BOARD: with the No. 8 pick 19 days out, NBA.com's post-Combine consensus mock still lands most often on Louisville PG MIKEL BROWN JR., with 7'3 Michigan center ADAY MARA the dark-horse alternative; HoopsHype's Michael Scotto says rival execs expect Atlanta to target a point guard or Mara, Kevin O'Connor's new mock floats Illinois guard KEATON WAGLER at 8, KINGSTON FLEMINGS and SEC POY DARIUS ACUFF JR. round out the guard lane, and a trade-back is in play if guards fly off the board at 6 and 7. AWARDS: JALEN JOHNSON All-NBA Third Team, NAW Most Improved, DANIELS All-Def 2nd. CJ McCOLLUM retention is the free-agency priority (~2yr/$35-40M consensus, though he 'likely will have other suitors'). JAYLEN BROWN and CAMERON JOHNSON trade threads remain open; RISACHER and KISPERT the likeliest summer trade chips per Hollinger. KEY OFFSEASON DATES: Finals Game 2 Friday June 5 · Draft Night June 23 (19 days) · Hield $9.66M full-guarantee trigger June 25 (21 days) · Kuminga $24.3M team-option call by June 29 (25 days, decline-and-extend the expected path per Fischer) · McCollum UFA market opens June 30 6 PM ET (26 days) · Free agency moratorium July 6.",
};
...
export const NEWS_DIGEST = {
  generatedAt: "2026-06-04T08:16:00Z",
  summary:
    "OFFSEASON — Thursday June 4. THE FRESH NEWS: THE KNICKS DREW FIRST BLOOD IN THE NBA FINALS — New York beat San Antonio 105-95 in Game 1 on Wednesday night at Frost Bank Center, with JALEN BRUNSON scoring 30 (13 in the fourth quarter) as the Knicks erased a 14-point second-half deficit; Victor Wembanyama graded out 'bad' in CBS Sports' winners-and-losers ledger, and Game 2 is Friday June 5, 8:30 PM ET on ABC, again in San Antonio (NBA.com / CBS Sports / Yahoo Sports, Jun 3-4). The ATL angle is direct — this is the same Knicks team that ended Atlanta's season in six on Apr 30, now up 1-0 in its first Finals since 1999. BACK IN ATLANTA, a QUIN SNYDER EXTENSION is still being called 'inevitable': Marc Stein and Jake Fischer report a new contract regarded as inevitable around the league, expected 'in the same ballpark' as other proven NBA head coaches, with new President of Basketball Operations Onsi Saleh negotiating it — a 'massive,' eight-figure agreement expected before the June 23 draft. DRAFT: with the No. 8 pick 19 days out, NBA.com's post-Combine consensus mock still lands most often on Louisville PG MIKEL BROWN JR., with 7'3 Michigan center ADAY MARA the dark-horse alternative, Kevin O'Connor's new mock floating Illinois guard KEATON WAGLER, and a trade-back possible if guards go at 6 and 7. CAP CALENDAR: Hield's $9.66M full-guarantee trigger June 25 (21 days), Kuminga's $24.3M team-option call by June 29 (25 days) — with mutual interest in a decline-and-extend per Jake Fischer — and the McCollum-led free-agency market opening June 30 6 PM ET (26 days). McCollum retention stays the priority (~2yr/$35-40M the consensus range); the trade board still runs through JAYLEN BROWN, Cameron Johnson, Risacher and Kispert.",
  keyTopics: [
    {
      title: "Knicks Strike First in the Finals: Brunson's 30 Sinks the Spurs 105-95 in Game 1",
      detail:
        "The team that ended Atlanta's season is three wins from a title. The NEW YORK KNICKS beat the San Antonio Spurs 105-95 in Game 1 of the NBA Finals on Wednesday night June 3 at Frost Bank Center, stealing home-court advantage behind JALEN BRUNSON's 30 points — 13 of them in a fourth-quarter takeover that erased a 14-point second-half deficit (NBA.com / CBS Sports / Yahoo Sports, Jun 3-4). VICTOR WEMBANYAMA landed on the 'losers' side of CBS Sports' Game 1 ledger with a performance the site graded as flatly 'bad,' and San Antonio — back in the Finals for the first time since 2014 after its Game 7 WCF win over OKC — now has to even the series at home: Game 2 is FRIDAY JUNE 5, 8:30 PM ET on ABC at Frost Bank Center, before the series shifts to Madison Square Garden on Monday June 8. The ATL angle is unavoidable — this is the same Brunson-led Knicks team that eliminated the Hawks in six on Apr 30, including the historic 140-89 Game 6.",
      category: "games",
    },
    {
...
export const ISSUE = {
  date: "2026-06-04",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 8,                                        // Issue number (offseason cadence)
  dateline: "ATLANTA · JUNE 4, 2026",               // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 08 · JUNE 2026 · ATL · USA",
  railLabel: "ISSUE 08 · JUNE 4",
  coverStarId: 1,                                   // PLAYERS[id] for the cover portrait
  coverRibbon: "EXCLUSIVE · COVER STAR · JALEN JOHNSON",
  coverStatusKicker: "OFFSEASON · DAY 34",          // top-right corner of cover
