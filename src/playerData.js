...
export const NEWS_DIGEST = {
  ...
  keyTopics: [
    ...
    {
      title: "Lakers' Kuminga Pursuit Cools as Cleveland Re-Enters: Reports Split on Whether Atlanta Preferred LA",
      detail:
        "The Lakers, the other suitor Atlanta spent July talking to, have watched their pursuit lose momentum since agreeing with defensive wing Matisse Thybulle, a move read around the league as a hedge that lowered their urgency (Yahoo Sports / Heavy / NBC Sports, Jul 20-24). Los Angeles has improved its offer to Kuminga to roughly $10M annually but remains well short of the near-$25M his camp targeted, and the reporting is contradictory: some outlets have Atlanta preferring the Lakers' package over Cleveland's, others have LA and the Hawks simply far apart on draft compensation with the Lakers unwilling to attach significant capital. Sunday's Dort trade is the backdrop, at 17 standard contracts Atlanta no longer wants LA's back-end money, the mechanism by which the Lakers planned to pay Kuminga. Atlanta's own route to retaining him outright still sits near the mid-level, roughly $6M against his $25M ask, after the front office declined his $24.3M option Jun 29 and kept only Non-Bird rights. Milwaukee and the Clippers round out the listed suitors. Two months of Atlanta's summer have produced no resolution on its most valuable expiring asset, but LeBron's decision should force the pace.",
      category: "trades",
    },
    {
