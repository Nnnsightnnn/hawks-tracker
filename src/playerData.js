...
export const ISSUE = {
  date: "2026-08-16",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 48,                                       // Issue number (offseason cadence)
  dateline: "ATLANTA · AUGUST 16, 2026",             // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 48 · AUGUST 2026 · ATL · USA",
  railLabel: "ISSUE 48 · AUG 16",
  ...
  coverImage: null,
  coverRibbon: "KUMINGA STANDOFF HOLDS INTO A SECOND MONTH · SUITOR LIST WIDENS TO SACRAMENTO ALONGSIDE LAKERS, CAVS, CLIPPERS, BUCKS · SIGN-AND-TRADE STILL THE ONLY PATH THROUGH ATLANTA · CAVS HARD-CAPPED, LAKERS STILL STUCK ON VANDERBILT'S SALARY · ONE-PLUS-ONE ATLANTA RETURN STILL ON THE TABLE · GUEYE OUT · 17 CONTRACTS, LIMIT 15 · NEXT GAME OCT 5 VS MEMPHIS",
  coverStatusKicker: "OFFSEASON · DAY 99",          // top-right corner of cover
  coverStatusLine: "QUIET SUNDAY, NO DEAL: KUMINGA STILL UNSIGNED NEARLY SEVEN WEEKS IN, SACRAMENTO NOW CITED AMONG SUITORS · HAWKS WON'T ABSORB VANDERBILT STRAIGHT UP, CAVS HARD-CAPPED AT THE FIRST APRON · ONE-PLUS-ONE ATLANTA RETURN STILL POSSIBLE · CARTER RESTRICTION LIFTS AUG 30 · OKONGWU EXTENSION-ELIGIBLE OCT 1 · 17 CONTRACTS, LIMIT 15 · NEXT: PRESEASON, OCT 5", // {DAYS:id} resolves from KEY_DATES
