// ─── Atlanta Hawks Player Data (2025-26 Season · Updated May 9, 2026 — SEASON OVER · ELIMINATED in R1 · LOTTERY TOMORROW · 9.8% at No. 1, 40.2% top-4 via NOP/MIL swap · Combine opens Sunday) ─
...
export const NEXT_GAME = {
  ...
  broadcast: "ABC",
  seriesContext: "TOMORROW · Sunday May 10, 3 PM ET · ATL holds more-favorable of NOP/MIL via the Pelicans-Bucks swap — 9.8% at No. 1 / 40.2% top-4 combined (Yahoo Sports/Bleacher Report May 8); NOP standalone 6.8% No. 1 · 73-prospect Combine May 10-17 in Chicago overlaps the lottery · Saleh (AJC May 8): 'We're in a good place' · ATL workout group: Bidunga/Onyenso/Suder/Uzan already in · Locked on Hawks ep. 2232 lottery preview airs today (May 9)",
};
...
export const NEWS_DIGEST = {
  generatedAt: "2026-05-09T13:00:00Z",
  summary:
    "OFFSEASON — Saturday May 9, LOTTERY EVE: tomorrow at 3 PM ET on ABC, McCormick Place West. THE LEAD: Atlanta walks into Sunday with the league's clearest combined swap edge — 9.8% at No. 1 and 40.2% TOP-4 via the Pelicans-Bucks swap — second-best non-bottom-3 odds in the field, with Yahoo Sports and Bleacher Report's lottery primers (May 8) framing the Hawks and Wizards as the two teams with the most to gain. Pelicans standalone slot: 7th-best, 6.8% at No. 1; Bucks at 10th-best with just 3.0% top-4. Brad Rowland's Locked on Hawks Episode 2232 (May 9) ran a full lottery preview today, walking through every Hawks scenario from a No. 1-pick AJ Dybantsa dream to the most-likely 8th-overall outcome (35.6%) and the 7-9 range that hits 69.2% combined. The four-prospect pre-draft workout group remains in town — Flory Bidunga (Kansas), Ugonna Onyenso (Virginia), Peter Suder (Miami OH), Milos Uzan (Houston) — all projected second-rounders for ATL's No. 57 slot (SI onsi May 7). 73 players report to Wintrust Arena tomorrow for the Combine running May 10-17 (NBA.com). GM ONSI SALEH's AJC lottery-eve framing from yesterday — 'We're in a good place. Position set up moving forward, and our coaching staff has just been remarkable this year' — sets the patience-and-development tone over a star chase. Three-days-old peer recognition still travels: JALEN JOHNSON tied with Derrick White as the league's MOST UNDERRATED in The Athletic's Anonymous Player Poll (May 6), and Yahoo's media ballot has him on the All-NBA Third Team pending the league's official vote. Saleh runs the lottery short-handed: top scout BRYSON GRAHAM left for the Bulls' EVP chair Monday May 4 (NBA.com / Bulls.com), so Cody Toppert and Landry Fields lead the war-room. Front-office spine: operate OVER the cap with non-tax MLE (~$15.1M), BAE (~$5.1M), four trade exceptions, and Hield's $9.4M expiring; retain McCollum on a 'slightly above the MLE' multi-year deal (~2yr/$35-40M per HoopsHype); decline Kuminga's $24.3M 26-27 option by June 29 to renegotiate longer-term; call Hield's $3M-vs-$9.4M trigger before June 25; shop Risacher or Kispert (R1 floor time was 2:30 across six games for Risacher). Hartenstein is the named free-agency frontcourt target if room can be created; Athletic mock has Boozer to ATL at No. 3. Snyder extension talks remain on the calendar (Saleh: 'unbelievable partner').",
  keyTopics: [
    {
      title: "LOTTERY EVE — Hawks Walk in With 9.8% No. 1 / 40.2% Top-4 via Swap (Tomorrow 3 PM ET on ABC)",
      detail:
        "FRESH (Saturday May 9): The 2026 NBA Draft Lottery is TOMORROW at McCormick Place West, Chicago — Sunday May 10, 3 PM ET on ABC (Yahoo Sports / Bleacher Report / NBC Sports / CBS Sports / SI onsi, May 8-9). Atlanta walks in with the field's most powerful pick-swap: the more-favorable of NOP (7th-best, 6.8% at No. 1 standalone) and MIL (10th-best, 3.0% top-4). Yahoo Sports' May 8 lottery primer pegs Atlanta's COMBINED swap odds at 9.8% chance at No. 1 and 40.2% chance at TOP-4 — second-best non-bottom-3 odds in the field, with the Wizards the only team with more to gain. Most-likely outcome remains Atlanta at No. 8 (35.6%); No. 7-9 hits 69.2% combined. ATL also owns Cleveland's first (projected No. 23-24) and the No. 57 second-rounder. Top-4 board: AJ Dybantsa (BYU), Darryn Peterson (Kansas), Cameron Boozer (Duke), Caleb Wilson (UNC).",
      category: "general",
    },
    {
      title: "Locked on Hawks Episode 2232 (May 9): Brad Rowland's Lottery Preview Goes Long on the Pelicans-Bucks Math",
      detail:
        "Same-day (Saturday May 9): Brad Rowland's Locked on Hawks Episode 2232 dropped today as a full Sunday-lottery preview — walking listeners through every Hawks scenario from a No. 1 AJ Dybantsa landing through the most-likely 8th-overall outcome (35.6%) into the 7-9 range that hits 69.2% combined. Episode also covered the Pelicans-Bucks swap mechanics in detail (the more-favorable rule), the Cleveland first at No. 23-24 from the prior salary-dump trade, and the front-office implications of Bryson Graham's defection to Chicago five days ago. The pod sets the soundtrack for tomorrow's draw alongside Yahoo Sports / Bleacher Report / NBC Sports lottery primers (May 8). Saleh's ATL workout group of Bidunga / Onyenso / Suder / Uzan remains the announced pre-draft slate.",
      category: "general",
    },
    {
      title: "Saleh's Lottery-Eve Framing (AJC May 8): 'We're In A Good Place' — Patience Over Star-Chase",
      detail:
        "One day old (Friday May 8): The AJC's lottery-preview interview with Hawks GM Onsi Saleh — 'We're in a good place. Position set up moving forward, and our coaching staff has just been remarkable this year' (AJC 'We're in a good place: Hawks focused on development ahead of draft lottery', May 8). Atlanta is one of only TWO playoff teams in the lottery (Oklahoma City the other) and the 6th-best odds team via the more-favorable of NOP/MIL. Saleh reiterated the 46-36 / 6-seed result as a foundation, not a ceiling, repeated the 'we're not one player away' frame from his exit interview, and pointed at Atlanta's THREE picks (lottery via NOP/MIL, No. 23 via CLE, No. 57) as the offseason value lever. Hawks bypassed the play-in for the first time in four years.",
      category: "general",
    },
    {
      title: "Combine Week Opens TOMORROW — 73 Prospects to Chicago, ATL's First Workout Group Already In",
      detail:
        "ONE DAY OUT: 73 players were invited to the AWS NBA Draft Combine running Sunday May 10 through Saturday May 17 at Wintrust Arena in Chicago — concurrent with Sunday's lottery (NBA.com / Hoops Rumors May 5-6, HoopsHype workout tracker May 7). Atlanta's reported pre-draft workout group remains in: FLORY BIDUNGA (Kansas), UGONNA ONYENSO (Virginia), PETER SUDER (Miami OH), MILOS UZAN (Houston) — all projected second-rounders for the No. 57 slot (SI onsi 'Hawks To Bring in Four Prospects For Pre-Draft Workouts', May 7). Uzan was one of three Cougars to start all 37 games, led Houston with 1,219 minutes and a 3.08 A/TO ratio. Once the lottery slots Atlanta on Sunday, expect a much-fuller workout slate with combine-tier prospects. The G League combine ran May 8-10 leading in.",
      category: "general",
    },
    {
