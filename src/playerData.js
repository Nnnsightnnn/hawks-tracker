...
export const ISSUE = {
  date: "2026-08-01",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 38,                                       // Issue number (offseason cadence)
  dateline: "ATLANTA · AUGUST 1, 2026",             // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 38 · AUGUST 2026 · ATL · USA",
  railLabel: "ISSUE 38 · AUG 1",
  ...
  coverImage: null,
  coverRibbon: "KOLOKO REPORTEDLY SIGNS WITH NEW ORLEANS, ATLANTA'S CENTER FIX SLIPS AWAY · KUMINGA STANDOFF HOLDS, LAKERS THE LONE MOTIVATED PARTNER · WATSON PATH NARROWS AS DENVER HITS THE SECOND APRON · 17 CONTRACTS, LIMIT 15 · NEXT GAME OCT 5 VS MEMPHIS",
  coverStatusKicker: "OFFSEASON · DAY 89",          // top-right corner of cover
  coverStatusLine: "KOLOKO CAMP DEAL APPEARS OFF AS SCOTTO REPORTS A NEW ORLEANS SIGNING · GUEYE STAYS OUT, CENTER NEED OPEN · KUMINGA-FOR-VANDERBILT STILL STUCK ON THE 2027-28 OPTION · 17 CONTRACTS, LIMIT 15 · NEXT: PRESEASON, OCT 5", // {DAYS:id} resolves from KEY_DATES
