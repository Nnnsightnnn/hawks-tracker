...
export const PLAYERS = [
  ...
  },
  {
    ...
    recentNotes: "WEDNESDAY JUNE 10 — Daniels' offseason boss is now PRESIDENT OF BASKETBALL OPS ONSI SALEH (promoted from GM + extended long-term Wed May 27 per ESPN / Washington Post / Yahoo / SI onsi / Hoops Rumors). NBA ALL-DEFENSIVE SECOND TEAM nod (announced Fri May 22; NBA.com / AJC / Atlanta News First / Roundtable) is his second straight year on an All-Defense team after making FIRST TEAM in 24-25. He drew 9 first-place and 32 second-place votes from the 100-member global media panel (50 points, 10th in overall voting) and tied for the NBA lead in steals per game at 2.0 with OKC's Cason Wallace; Atlanta posted a top-10 defensive rating for the first time in nearly a decade with Daniels as the primary point-of-attack defender. The Second-Team finish — down from First Team a year ago — tracks a hard offensive year: his three-point shooting cratered to 18.8% (22-of-117), and Daniels has spoken candidly about getting into a 'dark place' mentally, planning an LA summer to rebuild the jumper and 'get stronger.' Victor Wembanyama was the unanimous DPOY and lone unanimous All-Defense 1st-teamer; Daniels was not a 2026 DPOY finalist after finishing runner-up in 25. AROUND THE LEAGUE: SPURS CUT THE FINALS TO 2-1 with a 115-111 Game 3 win at MSG Mon Jun 8 (Wembanyama 32-8-6); Game 4 TONIGHT Wed Jun 10, 8:30 ET ABC. Regular-season line of 11.9/6.8/5.9 on 2.0 stl across 80 games (76 starts) is the locked baseline; four-year, $100M rookie extension (signed Oct 2025 per ESPN / NBA.com) kicks in next season; not trade-eligible until July 1, 2026.",
  ...
  },
  {
    ...
    recentNotes: "WEDNESDAY JUNE 10 (offseason — PRESIDENT OF BASKETBALL OPS ONSI SALEH promoted + extended Wed May 27 per ESPN / Washington Post / Yahoo / SI onsi / Hoops Rumors; SPURS TOOK WCF GAME 7 111-103 Sat May 30 (Wembanyama 22-7), ousting OKC to reach the Finals; SPURS CUT THE FINALS TO 2-1 with a 115-111 Game 3 win at MSG Mon Jun 8 (Wembanyama 32-8-6); Game 4 TONIGHT Wed Jun 10, 8:30 ET ABC) — Likeliest summer trade chip alongside Risacher, and Saleh as new POBO owns the call. Hollinger explicitly names Kispert (with Risacher) as the likeliest summer trade chip; cap notes show $14.6M next season then a $17.4M cap hit in 27-28. Salary-matching utility in any Jaylen Brown framework is real — the No. 8 pick plus Kispert plus Hield's $9.4M would clear the $57M Brown number per Hoops Rumors / Boston.com / Larry Brown Sports (May 10-22). Regular season line of 9.6/2.4/1.3 on 40.2% from three in 40 games (8 starts) was the post-trade Hawks portion.",
  ...
  },
  {
    ...
    recentNotes: "WEDNESDAY JUNE 10 (offseason — PRESIDENT OF BASKETBALL OPS ONSI SALEH promoted + extended Wed May 27 per ESPN / Washington Post / Yahoo / SI onsi / Hoops Rumors; SPURS TOOK WCF GAME 7 111-103 Sat May 30 (Wembanyama 22-7), ousting OKC to reach the Finals; SPURS CUT THE FINALS TO 2-1 with a 115-111 Game 3 win at MSG Mon Jun 8 (Wembanyama 32-8-6); Game 4 TONIGHT Wed Jun 10, 8:30 ET ABC) — Missed the entire first round of the playoffs after the Apr 1 right high-ankle sprain (Heavy/CBS, Apr 24). UFA per Bleacher Report cap notes. Offseason story is whether the new POBO re-signs the third center or pivots to the lottery picks (No. 8 secured May 10) or to Hartenstein-tier FA money for help up front; the Hartenstein chase (per Soaring Down South 'top free-agency frontcourt target', May 11) directly competes with re-signing Landale.",
    playoffStats: null,
    playoffSeries: null,
    minutesTrend: null,
...
export const NEXT_GAME = {
  ...
  broadcast: "ABC / ESPN",
  seriesContext: "WEDNESDAY JUNE 10 — FINALS GAME 4 TONIGHT AT MSG; HAWKS 'LOVE' TWO GUARDS AT NO. 8. GAME NIGHT IN NEW YORK: Knicks lead the Finals 2-1 and host Game 4 tonight (8:30 PM ET, ABC) as a slim 1.5-point favorite, total 216.5 (FanDuel / Lineups). VICTOR WEMBANYAMA leads all Finals scorers at 29.0 PPG after Monday's 32-point Game 3 masterclass; Brunson has played through visible knee discomfort since Game 1. ATL angle: same Brunson-led Knicks that eliminated Atlanta in six on Apr 30; a Spurs win tonight ties it 2-2. FRESH DRAFT INTEL (Tue Jun 9, ClutchPoints / Yahoo): Atlanta 'loves' Illinois PG KEATON WAGLER and Louisville PG MIKEL BROWN JR. at No. 8, and is also high on 7'3 ADAY MARA, but league personnel keep pointing to a guard to lock the backcourt long-term. The Kings wrinkle holds: Sacramento (No. 7) views Arkansas SEC-POY DARIUS ACUFF JR. as their 'floor,' so he may be gone before Atlanta picks. SNYDER'S multi-year extension (official Mon Jun 8) remains the Hawks headline of the week, Saleh's first marquee move as POBO after the 46-36, No. 6-seed season. McCOLLUM retention stays priority one (~$29M room; 2yr/$43M framed as a 'steep discount'). KEY OFFSEASON DATES: Finals Game 4 TONIGHT (MSG) · Draft Night June 23 (13 days) · Hield $9.66M full-guarantee trigger June 25 (15 days) · Kuminga $24.3M team-option call by June 29 (19 days, decline-and-extend the expected path per Fischer) · McCollum UFA market opens June 30 6 PM ET (20 days) · Free agency moratorium July 6.",
};
...
export const NEWS_DIGEST = {
  ...
  summary:
    "OFFSEASON — Wednesday June 10. TONIGHT: FINALS GAME 4 AT MADISON SQUARE GARDEN (8:30 PM ET, ABC), Knicks up 2-1 and a slight 1.5-point home favorite with the total at 216.5 (FanDuel / Lineups, Jun 9-10). VICTOR WEMBANYAMA, the Finals' leading scorer at 29.0 PPG, just silenced MSG with a 32-point Game 3 masterclass in San Antonio's 115-111 win Monday; JALEN BRUNSON has been playing through visible discomfort since his Game 1 knee scare. The ATL angle persists: this is the same Brunson-led Knicks team that eliminated the Hawks in six on Apr 30. A Spurs win tonight ties it 2-2 and guarantees a Game 6 in Texas. ON THE HAWKS BEAT (13 days to the draft): fresh board intel says Atlanta 'loves' two point guards at No. 8, Illinois' KEATON WAGLER and Louisville's MIKEL BROWN JR., with the catch that the front office is also high on 7'3 ADAY MARA yet league personnel keep pointing to a guard to lock the backcourt long-term (ClutchPoints / Yahoo Sports, Jun 9). The Kings-at-No. 7 wrinkle holds: Sacramento views Arkansas SEC POY DARIUS ACUFF JR. as their 'floor,' so he may be gone before Atlanta is on the clock. QUIN SNYDER'S multi-year extension (official Monday June 8) stays the franchise headline of the week, Saleh's first marquee move as POBO. CAP CALENDAR: Hield's $9.66M full-guarantee trigger June 25 (15 days), Kuminga's $24.3M team-option call by June 29 (19 days, decline-and-extend the expected path per Jake Fischer), McCollum-led free agency opens June 30 6 PM ET (20 days); the McCollum re-sign stays priority one (2yr/$43M framed as a 'steep discount'). The trade board still runs through JAYLEN BROWN, Risacher and Kispert.",
  keyTopics: [
    {
      title: "TONIGHT: Finals Game 4 at MSG (8:30 ET, ABC) — Spurs Look to Even It Against the Team That Ended Atlanta's Year",
      detail:
        "Game night. The Knicks host Game 4 of the 2026 Finals tonight, Wednesday June 10 at Madison Square Garden (8:30 PM ET, ABC), leading the series 2-1 but installed as just a 1.5-point favorite with the total at 216.5 (FanDuel Research / Lineups / Yardbarker, Jun 9-10). VICTOR WEMBANYAMA is the Finals' leading scorer at 29.0 PPG after Monday's 32-point, 8-rebound Game 3 masterclass snapped New York's 13-game playoff win streak; JALEN BRUNSON has been playing through visible discomfort since a Game 1 knee scare. At Tuesday's media day, Spurs guard Dylan Harper framed it simply: 'We've got a lot of basketball yet to be played' (NBA.com, Jun 9). The Hawks watch with a rooting interest and a scouting one: this is the Brunson-led team that eliminated Atlanta in six on Apr 30, and a Spurs win tonight ties it 2-2 and guarantees the series returns to Texas for Game 6.",
      category: "games",
    },
    {
      title: "Fresh Board Intel: Hawks 'Love' Wagler and Mikel Brown Jr. at No. 8, With One Giant Catch",
      detail:
        "The clearest read yet on Atlanta's draft room, reported Tuesday June 9 by ClutchPoints and picked up by Yahoo Sports: the Hawks 'love' two point guards at No. 8, Illinois' KEATON WAGLER and Louisville's MIKEL BROWN JR. The catch: sources say the front office is ALSO high on 7'3 Michigan center ADAY MARA, the cleanest answer to the interior-size problem the Knicks series exposed, yet conversations with league personnel keep pointing to Atlanta favoring a guard to secure the backcourt long-term. Brown Jr.'s advanced playmaking, pace control and three-level scoring remain the most popular Atlanta fit in mocks; Wagler is profiled by SI's onsi as having 'the tools to be the franchise guard.' Rival execs still expect either a point guard or Mara at 8, and a trade-down to grab Mara or Morez Johnson Jr. plus extra capital stays in play if guards fly off the board early (HoopsHype / SI onsi / ClutchPoints, Jun 7-9). Draft Night is June 23, 13 days out.",
      category: "general",
    },
    {
...
export const ISSUE = {
  date: "2026-06-10",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 10,                                       // Issue number (offseason cadence)
  dateline: "ATLANTA · JUNE 10, 2026",              // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 10 · JUNE 2026 · ATL · USA",
  railLabel: "ISSUE 10 · JUNE 10",
  coverStarId: 1,                                   // PLAYERS[id] for the cover portrait
  coverRibbon: "EXCLUSIVE · COVER STAR · JALEN JOHNSON",
  coverStatusKicker: "OFFSEASON · DAY 40",          // top-right corner of cover
