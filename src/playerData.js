// ─── Atlanta Hawks Player Data (2025-26 Season · Updated Thursday May 14, 2026 — OFFSEASON · COMBINE DAY 4 (final scrimmage day) in Chicago · Hawks locked into No. 8 (NOP), No. 23 (CLE/SAS), No. 57 (BOS) · 40 days to Draft Night Jun 23) ─
...
export const PLAYERS = [
  ...
  },
  {
    ...
    recentNotes: "Combine Day 4 (Thu May 14) — Headline UFA. SI onsi 'Atlanta Is Expected to Bring Back McCollum Next Season' / Soaring Down South / Hoops Rumors / HoopsHype / Bleacher Report (Apr 28-May 12) align: Atlanta plans to bring him back on a multi-year deal, with offers expected 'slightly above the mid-level exception' — most execs pegging 2yr/$35-40M as the fair range. NEW PARALLEL (overnight May 12-13): SI onsi report has Atlanta interested in Austin Reaves UFA market alongside CHI/BKN/UTA — Reaves projects to the $30-40M/yr tier, which would directly cap-collide with the McCollum re-up and likely force one to give. The cleaner path the FO has signaled remains McCollum on the MLE-plus deal with Reaves as a stretch contingency. McCollum publicly confirmed a 'productive conversation' with the front office (Heavy, May 4). Hollinger's Athletic preview flags age (34, turning 35) as the structural risk. UFA market opens June 30, 6 PM ET — 48 days out. Final regular-season line: 18.7 / 3.1 / 4.1 on 45.2/38.1/82.7 across 41 Hawks games post-Jan 8 trade (25 starts), then 19.2 PPG / 49% FG / 31% 3P across the six R1 games.",
  ...
  },
  {
    ...
    recentNotes: "Combine Day 4 (Thu May 14) — Missed the entire first round of the playoffs after the Apr 1 right high-ankle sprain (Heavy/CBS, Apr 24). UFA per Bleacher Report cap notes. Offseason story is whether ATL re-signs the third center or pivots to the lottery picks (May 10) or to Hartenstein-tier FA money for help up front; the Hartenstein chase (per Soaring Down South 'top free-agency frontcourt target', May 11) directly competes with re-signing Landale.",
    playoffStats: null,
    playoffSeries: null,
    minutesTrend: null,
...
export const NEXT_GAME = {
  ...
  broadcast: "ABC / ESPN",
  seriesContext: "COMBINE DAY 4 (Thu May 14, Wintrust Arena) — FINAL 5-on-5 scrimmage day. Wednesday's session produced the standout scorers Atlanta's No. 8 board cares about: Cameron Carr 30 pts/6 threes plus 2nd-best max vert at the combine; Baba Miller 20 pts in scrimmage 1; Ja'Kobi Gillespie 24 first-half points on 5 threes (Bleacher Report 'Wednesday Scrimmage Highlights' / ESPN combine tracker / On3, May 13-14). Top-4 (Dybantsa/Peterson/Boozer/Wilson) all sat out scrimmages after Day 1 measurements; floor belongs to wing/big tier on Atlanta's board (Tre Johnson, Nate Ament, Koa Peat, Yaxel Lendeborg, Mikel Brown Jr., Kingston Flemings, Aday Mara, Dailyn Swain). Brayden Burries entered Hollinger's post-lottery mock at No. 8 to ATL (Roundtable, May 13). NEW TRADE THREAD (May 13): Hawks linked to Denver forward Cameron Johnson with a future-first headline package (HoopsHype rumors / Soaring Down South May 13). Austin Reaves interest from May 12-13 still live — lane requires declining Kuminga's $24.3M option. LOTTERY (Sun May 10): Hawks landed at No. 8 — most-likely outcome (35.6% pre-draw). Final lottery 1-6: WAS, UTA, MEM, CHI, LAC (via IND), BKN. ATL retains No. 23 (via CLE/SAS) and No. 57 (via BOS). Pre-draft workouts running: Bidunga, Onyenso, Suder, Uzan for No. 57 looks. KEY OFFSEASON DATES: Hield $9.4M full-guarantee trigger June 25 · Kuminga $24.3M team-option call by June 29 · McCollum UFA market opens June 30 6 PM ET · Free agency moratorium July 6.",
};
...
export const NEWS_DIGEST = {
  ...
  summary:
    "OFFSEASON — Thursday May 14, Combine Day 4 in Chicago: the FINAL day of 5-on-5 scrimmages at Wintrust Arena and Atlanta's last live look at the wing/big tier on its No. 8 board before pre-draft workouts take over the calendar. Wednesday's scrimmage session produced the standouts that matter most to Atlanta: Cameron Carr put up 30 pts on six threes plus the second-best max vertical at the combine, Baba Miller dropped 20 in scrimmage 1, and Ja'Kobi Gillespie poured in 24 first-half points on five threes (Bleacher Report 'Wednesday Scrimmage Highlights' / ESPN combine tracker / On3, May 13-14). With the projected top-4 — AJ Dybantsa, Darryn Peterson, Cameron Boozer and Caleb Wilson — all opted out of scrimmages after Day 1 measurements, the floor today belongs to Atlanta's actual No. 8 board: Tre Johnson, Nate Ament, Koa Peat, Yaxel Lendeborg, Mikel Brown Jr., Kingston Flemings, Aday Mara and Dailyn Swain. NEW POST-LOTTERY MOCK (May 13): John Hollinger's first post-lottery mock at The Athletic has Brayden Burries (Long Beach State) at No. 8 to ATL (Roundtable, May 13). NEW TRADE THREAD broke Wednesday May 13 — Atlanta linked to Denver forward Cameron Johnson with a future-first headline package (HoopsHype rumors / Soaring Down South / Peachtree Hoops, May 13). The Austin Reaves overnight interest from May 12-13 remains live alongside Chicago, Brooklyn and Utah — but the lane still requires declining Kuminga's $24.3M option to clear room, and league reporting still expects an LAL re-up given Doncic's public preference. Bidunga / Onyenso / Suder / Uzan pre-draft workout group is in for No. 57 looks. FRONT-OFFICE SPINE UNCHANGED: operate OVER the cap with non-tax MLE (~$15.1M), BAE (~$5.1M), four trade exceptions, and Hield's $9.4M expiring; retain McCollum (HoopsHype: 'slightly above MLE,' ~2yr/$35-40M); decline Kuminga's $24.3M 26-27 option by June 29; call Hield's $3M-vs-$9.4M trigger before June 25; shop Risacher or Kispert. CEO Steve Koonin: 'I think Quin is going to be part of our team for a very, very long time' — Snyder extension talks remain on the calendar. Saleh navigates Combine Week short-handed after Bryson Graham departed for the Bulls May 4.",
  keyTopics: [
    {
      title: "COMBINE DAY 4 (Thu May 14): FINAL Scrimmage Day — Carr 30 (6 3s), Miller 20, Gillespie 24 Stand Out Wed",
      detail:
        "TODAY at Wintrust Arena (Day 4 of the 2026 AWS NBA Draft Combine, May 11-17): the SECOND and final day of 5-on-5 scrimmages, the last live tape Atlanta's front office collects before pre-draft workouts take over the calendar. Wednesday's session produced the standouts: Cameron Carr dropped 30 pts on six made threes and posted the second-best max vertical at the combine; Baba Miller led scrimmage 1 with 20 pts; Ja'Kobi Gillespie poured in 24 first-half points on 5 threes (Bleacher Report 'Wednesday Scrimmage Highlights' / ESPN combine tracker / On3 'Top scorers from Day 1 of NBA Combine scrimmages', May 13-14). The projected top-4 — AJ Dybantsa, Darryn Peterson, Cameron Boozer, Caleb Wilson — all sat out scrimmages after Day 1 measurements, leaving the floor to Atlanta's actual No. 8 board: Tre Johnson, Nate Ament, Koa Peat, Yaxel Lendeborg, Mikel Brown Jr., Kingston Flemings, Aday Mara, Dailyn Swain. Last Word's 'Stock Rising' tracker flags Koa Peat. Saleh's 'best player available regardless of fit' frame applies — Thu scrimmage tape closes the live-evaluation window.",
      category: "general",
    },
    {
      title: "NEW: Hawks Linked to Denver's Cameron Johnson — Future-First Headline Package",
      detail:
        "Broke Wednesday May 13: HoopsHype rumor roundup / Soaring Down South / Peachtree Hoops surface fresh chatter that Atlanta has interest in DENVER forward CAMERON JOHNSON, with a trade package headlined by a future first-round pick potentially working as the framework. Johnson — acquired by Denver last offseason — fits the half-court shotmaking and 3-and-D wing profile Hollinger explicitly named as Atlanta's biggest R1 gap against the Knicks. Path requires either a salary-matching expiring-heavy outgoing (Kispert, Hield, plus a young piece) or repurposing one of Atlanta's four trade exceptions. Sits parallel to the Austin Reaves FA interest (May 12-13) and the resurfaced Jaylen Brown chatter (May 10-12) — Saleh has three wing-upgrade lanes open simultaneously and Hollinger's preview said operating OVER the cap is the FO's plan.",
      category: "trades",
    },
    {
      title: "Hollinger's Post-Lottery Mock: Brayden Burries to Hawks at No. 8",
      detail:
        "Late Wednesday May 13: John Hollinger's first post-lottery 2026 NBA mock draft at The Athletic has Atlanta selecting BRAYDEN BURRIES at No. 8 (Roundtable 'Ex-NBA Executive John Hollinger Mocks Brayden Burries to Atlanta Hawks at No. 8', May 13). Burries is a 6'4\" guard prospect who would compete with Risacher and the existing wing rotation. Hollinger's preview frame already had Atlanta operating OVER the cap with Risacher or Kispert as the likeliest summer trade chip — Burries at No. 8 reads as a development bet rather than a plug-and-play starter. Saleh's stated 'best player available regardless of fit' approach gives the FO room to push back on positional logic. CBS Sports' Gary Parrish has Tre Johnson at No. 8; ESPN's Givony has Yaxel Lendeborg as the most ATL-fit name; Bleacher Report's Wasserman puts Kingston Flemings in play. Yahoo Sports' May 14 piece on a 'son of NBA great' going to ATL points back at Boozer's tier of mocks where Atlanta picks up a famous-name prospect.",
      category: "general",
    },
    {
      title: "Hawks Linked to Austin Reaves in Free Agency — SI Onsi Report (May 12-13, still live)",
      detail:
        "Two days old, still active: SI onsi 'Atlanta Hawks Have Interest In Signing Lakers Guard Austin Reaves This Offseason' / Yardbarker / SportsTalkATL / ClutchPoints / Larry Brown Sports name Atlanta among teams with interest in Austin Reaves, alongside Chicago, Brooklyn and Utah. Reaves is an unrestricted free agent off a career-best Lakers season; HoopsHype and rival-exec polls peg his market at $30-40M per year given the thin 2026 FA class. STRUCTURAL CATCH: Atlanta does not have the room without moves — the most-cited path is DECLINING Kuminga's $24.3M team option by June 29, plus moving Hield's $9.4M ($3M guaranteed before June 25) and/or Kispert. Caveat: Luka Doncic has publicly said he wants the Lakers to keep Reaves and most leaguewide reporting expects an LAL re-up. The fit answers a real Hawks need — half-court shotmaking that lived almost entirely with McCollum in R1 against the Knicks.",
      category: "trades",
    },
    {
    ...
    },
    {
      ...
      detail:
        "The Hawks are now thirteen days into offseason while their first-round vanquishers play on. The East semifinals: Knicks-76ers (Philadelphia advanced after a historic 3-1 comeback over Boston in Round 1, sealed in Game 7) and Pistons-Cavaliers (CBS Sports / NBA.com / NBC New York, May 6-8). The 76ers' upset of the No. 2 Celtics is the storyline of Round 2; the Pacers missed the playoffs entirely for the first time since 2023. The team that ended Atlanta's season is now competing for an ECF berth, and CJ McCollum's free agency window opens June 30 — Combine / pre-draft workouts / ECSF results all collide in the same news cycle.",
      category: "games",
    },
    {
