...
export const NEXT_GAME = {
  ...
  broadcast: "ABC / ESPN",
  seriesContext: "TUESDAY JUNE 16, 7 DAYS TO THE DRAFT. THE LIVE THREAD IS THE GIANNIS MARKET AND ATLANTA'S PLACE IN IT: with the Bucks expected to move Giannis Antetokounmpo before the June 23 draft and Boston reportedly willing to part with JAYLEN BROWN to land him, Marc Stein reports a Brown deal is 'nearing clarity' and names the Hawks, Rockets and Trail Blazers as the suitors circling if Brown comes available. Evan Sidery's three-team framework would route Brown (and Sam Hauser) to Atlanta while Boston gets Giannis; the hurdle is Brown's three years and roughly $183M, and POBO Onsi Saleh holds this roster is 'not one player away.' THE BACKDROP: the New York Knicks are NBA champions, the team that ended Atlanta's season closing San Antonio 94-90 in Game 5 Saturday to take the Finals 4-1, New York's first title since 1973, JALEN BRUNSON 45 and Finals MVP (ESPN / NBA.com / FOX Sports). DRAFT BOARD: Brett Siegel has Atlanta 'loving' PGs KEATON WAGLER and MIKEL BROWN JR. at No. 8 with 7'3 ADAY MARA the size dark horse, while a CBS Sports mock sends Houston's KINGSTON FLEMINGS to the Hawks at 8 and pairs Chris Cenac Jr. at No. 23; league sources say Atlanta will happily field offers for No. 23. KEY OFFSEASON DATES: Draft Night June 23 (7 days) · Hield $9.66M full-guarantee trigger June 25 (9 days) · Kuminga $24.3M team-option call by June 29 (13 days, decline-and-extend the expected path per Fischer) · McCollum UFA market opens June 30 6 PM ET (14 days) · Free agency moratorium July 6.",
};
...
export const NEWS_DIGEST = {
  generatedAt: "2026-06-16T13:15:00Z",
  summary:
    "OFFSEASON, Tuesday June 16, seven days to the draft. THE LIVE THREAD is the Giannis Antetokounmpo market, now entering what insiders call the most seismic week of the offseason. Reporting has Miami as the clear frontrunner (Giannis is said to want the Heat, with a package built around Tyler Herro, Kel'el Ware, Jaime Jaquez Jr., the No. 13 pick and two future firsts), but the Bucks are lukewarm on Miami's offer and are actively trying to enlist a third team to sweeten the return (Heavy / NBC Sports / Basketnews, Jun 12-15). Atlanta's stake runs through the other path: if BOSTON wins the Giannis race, JAYLEN BROWN almost certainly moves, and Marc Stein reports a Brown deal is 'nearing clarity' with the Hawks, Rockets and Trail Blazers circling. Atlanta's hook is its asset base (it owns Milwaukee's unprotected 2027 first) plus the hometown angle, since Brown grew up in the Atlanta area; the hurdle is his three years and roughly $183M, and POBO ONSI SALEH still insists this roster is 'not one player away.' THE BACKDROP: the New York Knicks are NBA champions, the team that bounced the Hawks in the first round, closing San Antonio 94-90 in Game 5 Saturday to take the Finals 4-1, New York's first ring since 1973, Jalen Brunson 45 and Finals MVP. ON THE DRAFT BOARD: ClutchPoints' Big Board 4.0 now calls Louisville PG MIKEL BROWN JR. a 'long shot' to fall to No. 8, with the Kings at No. 7 viewing Arkansas guard DARIUS ACUFF JR. as their 'floor,' pushing 7'3 ADAY MARA and Houston's KINGSTON FLEMINGS up Atlanta's board; league sources say the Hawks will happily field offers for No. 23. CAP CALENDAR: Hield's $9.66M full-guarantee trigger June 25 (9 days), Kuminga's $24.3M team-option call by June 29 (13 days, decline-and-extend the expected path per Fischer), McCollum-led free agency opens June 30 6 PM ET (14 days).",
  keyTopics: [
    {
      title: "Jaylen Brown Watch: Giannis Market Hits Its 'Most Seismic Week' With Miami the Frontrunner; Brown the Hawks' Path In",
      detail:
        "Atlanta's hottest trade thread is the closest thing the offseason has to live action, and it sharpened over the weekend. Insiders now frame the next several days as the most seismic week of the offseason, with the Giannis Antetokounmpo market expected to resolve before the June 23 draft. Miami has emerged as the clear frontrunner (Giannis reportedly wants the Heat, whose package centers on Tyler Herro, Kel'el Ware, Jaime Jaquez Jr., the No. 13 pick and two future firsts), but the Bucks are not enamored with Miami's offer and are actively trying to enlist a third team to strengthen the return (Heavy / NBC Sports / Basketnews, Jun 12-15). Atlanta's stake is the other lane: if BOSTON wins the race, JAYLEN BROWN almost certainly moves, and Marc Stein reports a Brown deal is 'nearing clarity' with the Hawks, Rockets and Trail Blazers circling (The Stein Line / Yahoo Sports / SI onsi, Jun 12-15). The Atlanta case is real: SportsTalk ATL notes the Hawks own Milwaukee's unprotected 2027 first plus young filler, and Brown grew up in the Atlanta area, so a homecoming as the No. 1 option fits sentimentally and on the floor. The hurdles are just as real: Brown, who turns 30 in October, is owed three years and roughly $183M ($53-57M next season) after a career-best All-NBA campaign (28.7/6.9/5.1), the salary math forces Atlanta to package picks plus filler (the No. 8 pick, Hield, Kispert all surface in mocks), and POBO Onsi Saleh keeps insisting this roster is 'not one player away.' Nothing is signed, but the Giannis call is expected before the Hawks are on the clock.",
      category: "trades",
    },
    {
      title: "Board Shift: ClutchPoints Big Board 4.0 Now Calls Mikel Brown Jr. a 'Long Shot' to Reach No. 8",
      detail:
        "The newest intel cools Atlanta's most-mocked target. ClutchPoints' Big Board 4.0 (Jun 14-15) reports it is now looking like a 'long shot' that Louisville PG MIKEL BROWN JR. is still on the board at No. 8, and notes the Sacramento Kings one spot ahead at No. 7 view Arkansas guard DARIUS ACUFF JR. as their draft 'floor,' meaning two of the guards Atlanta covets could be gone before the Hawks pick. That pushes the realistic board toward 7'3 Michigan center ADAY MARA, the cleanest answer to the interior-size problem the Knicks series exposed, and Houston lead guard KINGSTON FLEMINGS, a confirmed Hawks workout visitor whom a recent CBS Sports mock sends to Atlanta at 8 (with 6'10 Houston big Chris Cenac Jr. paired at No. 23). HoopsHype's Michael Scotto reports rival execs still expect Atlanta to land either a point guard or Mara, and league sources say the front office is open to moving up or down and will happily field offers for No. 23. The Hawks hold Nos. 8, 23 and 57; the draft runs June 23-24 at Barclays Center, 7 days out.",
      category: "general",
    },
    {
