...
export const PLAYERS = [
  ...
  },
  {
    ...
    recentNotes: "SATURDAY MAY 23 (ECF G3 at Cleveland tonight 8 ET — Knicks lead the East finals 2-0; WCF G3: Thunder 123-108 over San Antonio Friday May 22 — OKC leads 2-1) — Series ended with the rotation slot under question after a tough R1 showing. Hollinger explicitly names Kispert (with Risacher) as the likeliest summer trade chip; cap notes show $14.6M next season then a $17.4M cap hit in 27-28. Salary-matching utility in any Jaylen Brown framework is real — the No. 8 pick plus Kispert plus Hield's $9.4M would clear the $57M Brown number per Hoops Rumors / Boston.com (May 10-11). Regular season line of 9.6/2.4/1.3 on 40.2% from three in 40 games (8 starts) was the post-trade Hawks portion.",
  ...
  },
  {
    ...
    recentNotes: "SATURDAY MAY 23 (ECF G3 at Cleveland tonight 8 ET — Knicks lead the East finals 2-0; WCF G3: Thunder 123-108 over San Antonio Friday May 22 — OKC leads 2-1) — Missed the entire first round of the playoffs after the Apr 1 right high-ankle sprain (Heavy/CBS, Apr 24). UFA per Bleacher Report cap notes. Offseason story is whether ATL re-signs the third center or pivots to the lottery picks (May 10) or to Hartenstein-tier FA money for help up front; the Hartenstein chase (per Soaring Down South 'top free-agency frontcourt target', May 11) directly competes with re-signing Landale.",
    playoffStats: null,
    playoffSeries: null,
    minutesTrend: null,
...
export const NEXT_GAME = {
  ...
  broadcast: "ABC / ESPN",
  seriesContext: "SATURDAY MAY 23 — HAWKS HONOR: guard DYSON DANIELS was named to the NBA ALL-DEFENSIVE SECOND TEAM on Friday May 22 (NBA.com / AJC / Atlanta News First), his second straight year on an All-Defense team after a First-Team nod in 24-25; he tied for the NBA lead in steals at 2.0 per game and helped Atlanta to a top-10 defensive rating for the first time in nearly a decade. AWARDS WEEKEND CONTINUES: the official Kia All-NBA teams are revealed TOMORROW, Sunday May 24 (7 PM ET, NBC/Peacock, ahead of WCF Game 4) — the moment JALEN JOHNSON is widely projected to land his first career All-NBA selection. SGA won his second straight MVP on May 17. AROUND THE LEAGUE: in the West, the OKLAHOMA CITY THUNDER beat the San Antonio Spurs 123-108 on Friday to take a 2-1 Western Conference Finals lead — OKC's bench poured in 76 points, the most by any team in a conference finals or NBA Finals game in the play-by-play era, with JALEN WILLIAMS sidelined by a hamstring injury; WCF Game 4 is Sunday May 24 at San Antonio. In the East, the NEW YORK KNICKS lead the Cleveland Cavaliers 2-0 and play GAME 3 TONIGHT — Saturday May 23, 8 PM ET at Cleveland (ABC) — chasing a franchise-record 10th straight playoff win; the Knicks remain the team that buried Atlanta in six (the historic 140-89 Apr 30 Game 6). HAWKS LEDGER: a 'massive' extension for head coach QUIN SNYDER is reported 'looming,' one that could make him one of the NBA's highest-paid coaches; Atlanta earlier denied Philadelphia permission to interview GM ONSI SALEH, closing the Sixers thread. CJ McCOLLUM retention stays the priority (~2yr/$35-40M, with ESPN's Bobby Marks floating a 3yr/$115.9M ceiling); Philadelphia's QUENTIN GRIMES has surfaced as a 'dream' backcourt target and Isaiah Hartenstein the top frontcourt option. CAMERON JOHNSON and JAYLEN BROWN trade threads remain open. DRAFT BOARD: the post-combine consensus has the Hawks taking a guard (KINGSTON FLEMINGS, MIKEL BROWN JR.) or 7'3 center ADAY MARA at No. 8. KEY OFFSEASON DATES: Draft Night June 23 (31 days) · Hield $9.4M full-guarantee trigger June 25 (33 days) · Kuminga $24.3M team-option call by June 29 (37 days) · McCollum UFA market opens June 30 6 PM ET (38 days) · Free agency moratorium July 6.",
};
...
export const NEWS_DIGEST = {
  ...
  summary:
    "OFFSEASON — Saturday May 23. THE AWARDS CYCLE HAS OPENED FOR ATLANTA: guard DYSON DANIELS was named to the NBA All-Defensive Second Team on Friday May 22, his second straight season on an All-Defense team after a First-Team selection in 2024-25 — Daniels drew 9 first-place votes, finished 10th in overall voting, and tied for the NBA lead in steals at 2.0 per game as Atlanta posted a top-10 defensive rating for the first time in nearly a decade (NBA.com / AJC / Atlanta News First). The bigger honor could land TOMORROW: the official 2025-26 Kia All-NBA teams are revealed Sunday May 24 (7 PM ET, NBC/Peacock), the moment JALEN JOHNSON is widely projected to earn his first career All-NBA selection. AROUND THE LEAGUE, the Oklahoma City Thunder beat the San Antonio Spurs 123-108 on Friday — getting an NBA-record 76 bench points with Jalen Williams out injured — to take a 2-1 Western Conference Finals lead, while the New York Knicks lead Cleveland 2-0 and play Game 3 tonight at Cleveland chasing a franchise-record 10th straight playoff win. ON THE HAWKS' LEDGER, a 'massive' extension for head coach QUIN SNYDER is reported 'looming,' CJ McCOLLUM retention stays the priority (~2yr/$35-40M, with ESPN's Bobby Marks floating a 3yr/$115.9M ceiling), and the cap gates loom — Hield's June 25 full-guarantee trigger, Kuminga's June 29 team-option call, Draft Night June 23 and McCollum's June 30 free-agency opening. The No. 8 pick (KINGSTON FLEMINGS, MIKEL BROWN JR., 7'3 ADAY MARA), interest in QUENTIN GRIMES and Isaiah Hartenstein, and JAYLEN BROWN and CAMERON JOHNSON trade chatter round out the agenda.",
  keyTopics: [
    {
      title: "HAWKS HONOR — Dyson Daniels Named NBA All-Defensive Second Team for the Second Straight Year",
      detail:
    ...
    {
      title: "WCF Game 3: Thunder 123, Spurs 108 — OKC Takes a 2-1 Lead on a Record 76 Bench Points",
      detail:
        "Friday May 22 at San Antonio: the Oklahoma City Thunder beat the Spurs 123-108 to take a 2-1 lead in the Western Conference Finals (ESPN 'Thunder get 76 points off bench in Game 3 win' / NBA.com 'Thunder secure 2-1 series lead' / Yahoo Sports, May 22-23). OKC's bench scored 76 points — the most by any team in a conference finals or NBA Finals game since starters were first tracked in 1971 — with Jaylin Williams and Jared McCain posting playoff career-highs. The Thunder did it without forward JALEN WILLIAMS, who sat out Game 3 with the hamstring injury suffered in Game 2. Game 4 is Sunday May 24 at San Antonio, immediately after the All-NBA reveal.",
      category: "games",
    },
    {
      title: "TONIGHT — ECF Game 3: Knicks (Up 2-0) at Cleveland, Chasing a 10th Straight Playoff Win",
      detail:
        "Game 3 of the Eastern Conference Finals tips tonight, Saturday May 23 at 8 PM ET at Cleveland's Rocket Arena on ABC, with the New York Knicks leading the series 2-0 after Thursday's 109-93 Game 2 win (Yahoo Sports / wkyc / SportsLine / BetMGM, May 22-23). A win would extend New York's franchise-record postseason win streak to 10 games and move the Knicks within one of the NBA Finals; the Cavaliers, 6-1 at home this postseason, are trying to avoid a 3-0 hole. ATL angle: the Knicks remain the team that ended Atlanta's season in six, including the historic 140-89 Apr 30 Game 6.",
      category: "games",
    },
    {
      title: "Kia All-NBA Teams Revealed Tomorrow (Sun May 24) — Jalen Johnson's First All-NBA Nod in Play",
      detail:
    ...
    },
    {
      ...
      detail:
        "Buddy Hield's $9.4M 2026-27 contract becomes fully guaranteed on June 25 — only $3M is currently protected (SI onsi cap tracker / SportsTalk ATL, Apr 28-May 18). Atlanta can let the full number trigger and keep it as a movable expiring, waive him before the date to save the difference, or include him in a pre-trigger trade. Reporting suggests Hield is not expected back given how little he played after the Porzingis-deal arrival — 71 games, 12 starts at 11.8/2.8/2.1 on 39.8% from three, then just 6 mpg in two first-round games. The trigger is 33 days out.",
      category: "trades",
    },
    {
      title: "Cam Johnson Still the Nuggets' 'Most Likely' Trade Candidate — Lakers, Warriors, Pacers the Cut",
      detail:
        "As of Saturday May 23, no trade has been executed (SI Nuggets '3 Realistic Cam Johnson Trade Suitors' / Basketnews / Yardbarker, May 18-22). Denver must shed salary to re-sign restricted free agent Peyton Watson, and CAMERON JOHNSON — a roughly $23M expiring who averaged 12.2 points in 54 games in his first Nuggets season — has been considered the most likely trade candidate 'for months.' SI Nuggets' three-suitor cut names the Los Angeles Lakers, Golden State Warriors and Indiana Pacers; the Warriors, fresh off a two-year extension for coach Steve Kerr, are framed as a live bidder. Atlanta, tied to Johnson by earlier May reporting, is more a roster-profile match — half-court shooting and 3-and-D, Atlanta's biggest R1 gap — than a named bidder.",
      category: "trades",
    },
    {
