...
export const ISSUE = {
  date: "2026-08-08",                              // YYYY-MM-DD — single source of truth
  volume: 26,                                       // VOL XXVI
  number: 44,                                       // Issue number (offseason cadence)
  dateline: "ATLANTA · AUGUST 7, 2026",             // Pre-formatted for display
  mastheadLine: "VOL XXVI · ISSUE NO. 44 · AUGUST 2026 · ATL · USA",
  railLabel: "ISSUE 44 · AUG 7",
  ...
  coverImage: null,
  coverRibbon: "MILWAUKEE JOINS THE KUMINGA CHASE AS THE FIELD WIDENS TO THREE-PLUS TEAMS · KUMINGA STILL UNSIGNED A MONTH-PLUS INTO FREE AGENCY · EVERY PATH STILL RUNS THROUGH ATLANTA IN A SIGN-AND-TRADE · HAWKS WANT THE PICKS BEFORE ABSORBING VANDERBILT'S OPTION · WATSON EDGES TOWARD HIS QUALIFYING OFFER · 17 CONTRACTS, LIMIT 15 · NEXT GAME OCT 5 VS MEMPHIS",
  coverStatusKicker: "OFFSEASON · DAY 95",          // top-right corner of cover
  coverStatusLine: "BUCKS JOIN LAKERS AND CAVALIERS IN THE KUMINGA CHASE · KUMINGA STILL UNSIGNED, NO SUITOR AT HIS $20M ASK · LAKERS BID ~ $45M/3YR, WILLING TO ATTACH PICKS TO VANDERBILT · HAWKS WANT THE PICKS FIRST · WATSON WEIGHS HIS $6.5M QO, HAWKS HOLD BACK THE FIRST · GUEYE OUT · 17 CONTRACTS, LIMIT 15 · NEXT: PRESEASON, OCT 5", // {DAYS:id} resolves from KEY_DATES
